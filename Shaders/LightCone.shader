	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i , bool ase_vface : SV_IsFrontFace) : SV_Target
			{
				...
				float3 lerpResult92 = lerp( ase_worldNormal , -ase_worldNormal , ase_vface);
				...
				float lerpResult178 = lerp( ( _RimPower * ( 1.0 - pow( dotResult184 , 2.0 ) ) ) , _RimPower , ase_vface);
				...
				float3 lerpResult207 = lerp( float3( 1,1,1 ) , pow( ( tex2D( _ShaftNoise, panner196 ).rgb * tex2D( _ShaftNoise, ( panner200 * float2( 1.5,1.5 ) ) ).rgb * _ShaftsStrength ) , temp_cast_1 ) , _ShaftsFade);
				float3 temp_output_69_0 = min( ( 1.0 - max( pow( ( 1.0 - max( ( pow( max( dotResult60 , 0.0001 ) , lerpResult178 ) * _Intensity * ( 1.0 - max( pow( ( 1.0 - max( lerpResult145 , 0.001 ) ) , 3.0 ) , 0.001 ) ) * _Color * ( 1.0 - saturate( ( ( _DistanceFade * 5.0 ) - temp_output_130_0 ) ) ) * ( 1.0 - max( pow( ( 1.0 - max( i.ase_texcoord3.xy.y , 0.001 ) ) , _UVYPow ) , 0.001 ) ) * lerpResult207 ) , float3( 0.001,0.001,0.001 ) ) ) , 3.0 ) , float3( 0.001,0.001,0.001 ) ) ) , float3( 2,2,2 ) );
...
Node;AmplifyShaderEditor.ScreenDepthNode;148;-2432.308,693.449;Inherit;False;1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;194;-1699.663,956.7808;Inherit;False;0;198;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;197;-1541.654,1172.442;Inherit;False;Property;_ShaftsSpeed2;Shafts Speed 2;20;0;Create;True;0;0;0;False;0;False;0;-0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-1545.925,1098.775;Inherit;False;Property;_ShaftsSpeed1;Shafts Speed 1;21;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;215;-1455.177,952.5103;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;213;-1339.873,1172.441;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.WorldNormalVector;59;-2297.033,0.6730676;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DynamicAppendNode;212;-1343.076,1074.22;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;200;-1166.917,1091.302;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;57;-2218.821,209.3142;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.PowerNode;191;-2062.015,343.3339;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;131;-1869.454,702.6882;Inherit;False;Property;_DistanceFade;Distance Fade;5;0;Create;True;0;0;0;False;0;False;20;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;198;-1185.067,771.0137;Inherit;True;Property;_ShaftNoise;Shaft Noise;22;0;Create;True;0;0;0;False;0;False;None;401a1085158217b4d9e8a16432d854a7;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PannerNode;196;-1159.444,966.3894;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;211;-976.8798,1084.896;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;1.5,1.5;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;192;-849.3895,738.6847;Inherit;True;Property;_Rays;Rays;20;0;Create;True;0;0;0;False;0;False;-1;None;401a1085158217b4d9e8a16432d854a7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;199;-839.1558,940.7664;Inherit;True;Property;_Rays1;Rays;20;0;Create;True;0;0;0;False;0;False;-1;None;401a1085158217b4d9e8a16432d854a7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;210;-495.38,1045.394;Inherit;False;Property;_ShaftsStrength;Shafts Strength;24;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;163;-1296.781,-93.83578;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;107;-1538.348,586.3199;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;205;-525.2734,832.936;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;62;-1519.855,137.2024;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.0001;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;208;-212.4589,1050.732;Inherit;False;Property;_ShaftsFade;Shafts Fade;23;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;209;-274.3812,824.395;Inherit;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;165;-1029.031,-94.58578;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;101;-1423.521,417.6496;Inherit;False;Property;_Color;Colour;17;0;Create;False;0;0;0;False;0;False;1,1,1,0;1,0.9,0.9176471,0;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.PowerNode;63;-1316.845,98.37241;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-1174.103,486.3263;Inherit;False;Property;_Intensity;Intensity;15;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;207;-45.90906,747.5259;Inherit;False;3;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;118;-658.1926,133.4563;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.001,0.001,0.001;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;119;-550.1926,133.4563;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;120;-413.1926,137.4563;Inherit;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;3;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;121;-268.1926,135.4563;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.001,0.001,0.001;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;122;-145.4425,136.7063;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMinOpNode;69;-124.53,239.9044;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;2,2,2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCGrayscale;176;2.543579,239.0094;Inherit;False;2;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;24;17.06171,135.9515;Inherit;False;COLOR;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FaceVariableNode;187;-1277.933,349.3838;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;129;-1644.454,814.6882;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;89;249.9,130.7;Float;False;False;-1;2;ASEMaterialInspector;100;27;New Amplify Shader;2428b84746a063643a1a7e4ba658ff7b;True;Second;0;1;Second;2;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;1;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;RenderType=Transparent=RenderType;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;245.1699,18.50999;Float;False;True;-1;2;ASEMaterialInspector;100;27;.GenesisAria/LightCone;2428b84746a063643a1a7e4ba658ff7b;True;Unlit;0;0;Unlit;2;True;True;1;0;True;_SrcBlend;0;True;_DstBlend;0;1;False;;0;False;;True;0;True;_BlendOp;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;1;False;;True;True;True;True;True;True;0;True;_ColorMask;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;True;_ZWriteMode;True;3;True;_ZTestMode;True;False;0;False;;0;False;;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=-3000;True;6;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
...
ASEEND*/
//CHKSM=EB32F3523A3D5A97A2A43C4384D6BEF8016F4907