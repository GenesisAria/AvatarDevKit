	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				#ifdef _VERTEXSTREAM_ON
				float4 staticSwitch496 = appendResult252;
				#else
				float4 staticSwitch496 = float4(0,0,0,1);
				#endif
				float4 transform86 = mul(unity_ObjectToWorld,staticSwitch496);
				float3 localCenterEye1_g6494 = CenterEye1_g6494();
				float temp_output_6_0 = distance( transform86 , float4( localCenterEye1_g6494 , 0.0 ) );
				float temp_output_112_0 = ( 1.0 - min( max( pow( ( pow( temp_output_6_0 , 2.0 ) * ( (0.0 + (temp_output_6_0 - 0.0) * (1.0 - 0.0) / (( _DistanceValue / 10.0 ) - 0.0)) / 10.0 ) ) , _DistanceFalloff ) , 1.0 ) , 10.0 ) );
				float3 temp_output_666_0 = ( _Offsets + v.vertex.xyz );
				float3 temp_output_132_0 = ( temp_output_112_0 * temp_output_666_0 );
				float4 appendResult354 = (float4(temp_output_132_0 , 1.0));
				...
				float3 temp_output_56_0 = ( temp_output_112_0 * ( appendResult73 - temp_output_666_0 ) );
				float4 appendResult353 = (float4(temp_output_56_0 , 1.0));
				float4 transform83 = mul(unity_ObjectToWorld,appendResult353);
				#ifdef _VERTEXSTREAM_ON
				float4 staticSwitch492 = transform83;
				#else
				float4 staticSwitch492 = transform131;
				#endif
				#if defined(_VERTEXMODE_OFFSET)
				float4 staticSwitch664 = float4( ( -ase_worldViewDir * ( ( clampResult597 * clampResult595 * (0.5 + (temp_output_593_0 - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) ) * _DistanceOffset ) ) , 0.0 );
				#elif defined(_VERTEXMODE_SCALE)
				float4 staticSwitch664 = staticSwitch492;
				#else
				float4 staticSwitch664 = float4( ( -ase_worldViewDir * ( ( clampResult597 * clampResult595 * (0.5 + (temp_output_593_0 - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) ) * _DistanceOffset ) ) , 0.0 );
				#endif
				...
				#endif
				vertexValue = staticSwitch664.xyz;
				#if ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.RangedFloatNode;50;-1354.605,-888.1021;Inherit;False;Property;_TexSaturation;Tex Saturation;9;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;47;-1203.746,-579.8428;Inherit;False;Property;_Colour;Colour;8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;504;-1795.158,95.58293;Inherit;False;Property;_VertexStream;Vertex Stream;19;0;Create;True;0;0;0;False;3;Space(10);Header(. Use Particle Vertex Stream .);Header(requires vertex stream centre);False;0;0;1;True;;Toggle;2;Key0;Key1;Reference;492;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;487;-82.9158,-668.2497;Inherit;False;Property;_TexPower;Tex Power;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;620;108.878,-712.8517;Inherit;False;Property;_TexMultiply;Tex Multiply;10;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;618;23.51807,-464.7974;Inherit;False;Property;_DistanceMax;Distance Max;17;0;Create;True;0;0;0;False;0;False;100;100;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;616;127.5181,-523.7974;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;476;-165.8205,-304.1198;Inherit;False;Property;_AlphaPower;Alpha Power;4;0;Create;True;0;0;0;True;1;Space(10);False;1;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-231.3331,-147.7631;Inherit;False;Property;_Cutoff;Alpha Cutoff;5;0;Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;613;183.2857,-390.1974;Inherit;False;Property;_DistanceMultiply;Distance Multiply;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;600;-788.9415,180.9519;Inherit;False;Property;_DistanceOffset;Distance Offset;20;0;Create;True;0;0;0;False;0;False;0;0;-100;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;1129.714,-593.6528;Half;False;Property;_StencilRef;Stencil ID;29;0;Create;False;0;0;0;True;2;Space(5);Header(Stencil);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-1879.702,607.5383;Inherit;False;Property;_DistanceFalloff;Distance Falloff;24;0;Create;True;0;0;0;False;2;;;False;0.5;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;33;1428.86,-593.8448;Inherit;False;Property;_StencilComparison;Stencil Comparison;32;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;1122.534,-424.0863;Half;False;Property;_WriteMask;WriteMask (non-zero);30;0;Create;False;0;0;0;True;0;False;255;255;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;1142.022,-212.5741;Inherit;False;Property;_SrcBlend;Source Blend (SrcAlpha);27;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(.  Advanced  .);False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;291;-3291.624,-1205.919;Inherit;False;Property;_FixMeshAxis;Fix Mesh Axis;22;1;[Enum];Create;True;0;2;Y up;0;Z up;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;32;1448.861,-373.8444;Inherit;False;Property;_StencilZFail;StencilZFail;35;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;39;1453.573,-521.1865;Inherit;False;Property;_StencilOp;StencilOp;33;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;35;1449.861,-448.8444;Inherit;False;Property;_StencilFail;StencilFail;34;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;1404.57,-211.0041;Inherit;False;Property;_DstBlend;Destination Blend (OneMinusSrcAlpha);28;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;673.7523,-686.2844;Float;False;Property;_ZTestMode;ZTestMode (LEqual);3;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;1123.534,-507.6634;Half;False;Property;_ReadMask;ReadMask (non-zero);31;0;Create;False;0;0;0;True;0;False;255;255;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;500;-851.9797,1037.277;Inherit;False;Property;_DistanceScale;Distance Scale;23;0;Create;True;0;0;0;False;1;Space(20);False;0;0;0;True;DISTSCALE_ON;Toggle;2;Key0;Key1;Reference;499;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;498;-204.4714,-444.1469;Inherit;False;Property;_AlphaGrey;Alpha From Greyscale;6;0;Create;False;0;0;0;False;0;False;0;0;0;True;GREYTOALPHA_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;496;-2449.768,535.1649;Inherit;False;Property;_VertexStream;Vertex Stream;19;0;Create;True;0;0;0;False;3;Space(10);Header(. Use Particle Vertex Stream .);Header(requires vertex stream centre);False;0;0;1;True;;Toggle;2;Key0;Key1;Reference;492;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.VertexColorNode;89;-997.404,-503.663;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;614;534.2857,-499.1974;Inherit;False;Property;_UseDistanceMod;Use Distance Mod;16;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;631;-901.1672,-327.1487;Inherit;False;Property;_AgeVertexStream;Age Vertex Stream;12;0;Create;True;0;0;0;False;1;Header(Bright Flicker);False;0;0;0;True;GREYTOALPHA_ON;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;492;-256,656;Inherit;False;Property;_VertexStream;Vertex Stream;19;0;Create;True;0;0;0;False;3;Space(10);Header(. Use Particle Vertex Stream .);Header(requires vertex stream centre zw.x);False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;638;-1627.593,-278.1421;Inherit;False;Property;_FlickerRate;Flicker Rate;13;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;658;-1624.593,-205.1421;Inherit;False;Property;_FlickerMin;Flicker Min;14;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;659;-1622.593,-135.1421;Inherit;False;Property;_FlickerMax;Flicker Max;15;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;26;-1209.323,-807.8506;Inherit;True;Property;_Emission;Emission;7;0;Create;True;0;0;0;False;0;False;-1;None;9ba825c6d1b698f48be5329c238118da;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;663;-1498.409,-786.1444;Inherit;False;0;26;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;664;213.7,16.55227;Inherit;False;Property;_VertexMode;Vertex Mode;21;0;Create;True;0;0;0;False;0;False;0;0;1;True;;KeywordEnum;2;Offset;Scale;Create;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.StaticSwitch;499;-858.4347,693.7186;Inherit;False;Property;_DistanceScale;Distance Scale;23;0;Create;True;0;0;0;False;1;Space(20);False;0;0;0;True;DISTSCALE_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;666;-1482.366,946.809;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;112;-1176.27,701.6779;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;667;-1344.419,755.8471;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;132;-989.059,815.5901;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMinOpNode;670;-1210.277,796.9239;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;665;-1641.449,838.2369;Inherit;False;Property;_Offsets;Offsets;26;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;672;-1638.876,714.9639;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-2364.715,851.7001;Inherit;False;Property;_DistanceValue;Distance Value;25;0;Create;True;0;0;0;False;2;;;False;1;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;671;-2017.876,812.9639;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;675;-1807.876,691.9639;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;129;-2193.826,857.9081;Inherit;False;2;0;FLOAT;10;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;674;-1799.876,790.9639;Inherit;False;2;0;FLOAT;1;False;1;FLOAT;10;False;1;FLOAT;0
...
WireConnection;354;0;132;0
WireConnection;607;0;481;0
WireConnection;607;1;664;0
...
WireConnection;26;1;663;0
WireConnection;664;1;604;0
WireConnection;664;0;492;0
WireConnection;499;0;132;0
WireConnection;666;0;665;0
WireConnection;666;1;64;0
WireConnection;112;0;670;0
WireConnection;667;0;8;0
WireConnection;132;0;112;0
WireConnection;132;1;666;0
WireConnection;670;0;667;0
WireConnection;672;0;675;0
WireConnection;672;1;674;0
WireConnection;671;0;6;0
WireConnection;671;2;129;0
WireConnection;675;0;6;0
WireConnection;129;0;113;0
WireConnection;674;0;671;0
ASEEND*/
//CHKSM=737B852C52F749E92EA7BA461522381E619B156B
