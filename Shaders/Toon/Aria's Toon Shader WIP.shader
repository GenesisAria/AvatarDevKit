...
Shader ".GenesisAria/Arias Toon Shader WIP"
{
	...
	LOD 0
		...
		Pass
		{
			...
			float3 unity_SHArgb3_g192(  )
			{
				return float3(unity_SHAr.w, unity_SHAg.w, unity_SHAb.w) + float3(unity_SHBr.z, unity_SHBg.z, unity_SHBb.z) / 3.0;
			}
			
			float3 CenterEye46_g199(  )
			{
				#if defined(USING_STEREO_MATRICES) || defined(UNITY_SINGLE_PASS_STEREO)
				float3 leftEye = unity_StereoWorldSpaceCameraPos[0];
				float3 rightEye = unity_StereoWorldSpaceCameraPos[1];
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				#endif
				sampler2D texvalue34_g193 = _MainTex;
				float2 temp_output_4_0_g193 = i.ase_texcoord1.xy;
				half2 uvin34_g193 = temp_output_4_0_g193;
				half2 dx34_g193 = ( ddx( temp_output_4_0_g193 ) * float2( 0.25,0.25 ) );
				half2 dy34_g193 = ( ddy( temp_output_4_0_g193 ) * float2( 0.25,0.25 ) );
				half bias34_g193 = 0.0;
				half4 localsupersample2x234_g193 = supersample2x2( texvalue34_g193 , uvin34_g193 , dx34_g193 , dy34_g193 , bias34_g193 );
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_2987_0 = ( _TexSuperSample == 1.0 ? localsupersample2x234_g193 : tex2D( _MainTex, uv_MainTex ) );
				...
				float4 clampResult1914 = clamp( ( ( float4( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) , 0.0 ) + VertLight1406 + float4( ( localunity_SHArgb3_g147 * float3( 1.3,1.3,1.3 ) ) , 0.0 ) ) * _LightMultiplier ) , temp_cast_5 , temp_cast_6 );
				float4 break2085 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( ( max( max( break2085.x , break2085.y ) , max( break2085.y , break2085.z ) ) * break2085.w ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 localunity_SHArgb3_g192 = unity_SHArgb3_g192();
				...
				float4 lerpResult660 = lerp( ( _ShadeColorDynamic == 1.0 ? (float4( 0.88,0.88,0.88,0.88 ) + (( _MultiplyDynamic * saturate( ( ( VertAtten2014 < 0.005 ? float4( ( ase_lightColor.rgb * ase_lightColor.a ) , 0.0 ) : VertLight1406 ) + float4( localunity_SHArgb3_g192 , 0.0 ) ) ) ) - float4( 0,0,0,0 )) * (float4( 1,1,1,1 ) - float4( 0.88,0.88,0.88,0.88 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) : float4( (float3( 0.88,0.88,0.88 ) + ((_ShadeColour).rgb - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0.88,0.88,0.88 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) , 0.0 ) ) , float4( 1,1,1,0 ) , lerpResult669);
				...
				float3 localCenterEye46_g199 = CenterEye46_g199();
				float3 worldToViewDir27_g199 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g199 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g199 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g199 ) , worldToViewDir13_g199 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g198 = CenterEye16_g198();
				float3 normalizeResult19_g198 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g198 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g198 = normalize( cross( normalizeResult19_g198 , _worldUp ) );
				float3 temp_output_21_0_g198 = NormalMatCap3089;
				float dotResult10_g198 = dot( normalizeResult8_g198 , temp_output_21_0_g198 );
				float dotResult2_g198 = dot( _worldUp , normalizeResult19_g198 );
				float3 normalizeResult7_g198 = normalize( ( _worldUp - ( dotResult2_g198 * normalizeResult19_g198 ) ) );
				float dotResult9_g198 = dot( normalizeResult7_g198 , temp_output_21_0_g198 );
				float2 appendResult11_g198 = (float2(dotResult10_g198 , dotResult9_g198));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g198 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float4 lerpResult450 = lerp( float4( temp_output_3260_0 , 0.0 ) , ( float4( temp_output_3260_0 , 0.0 ) * LightColour968 ) , _ShadedEmission);
				...
				float3 localCenterEye1_g194 = CenterEye1_g194();
				float3 temp_output_4_0_g194 = ( localCenterEye1_g194 - WorldPosition );
				float3 normalizeResult5_g194 = normalize( temp_output_4_0_g194 );
				float3 normalizeResult1783 = normalize( ( ( _StereoFixSpec == 1.0 ? normalizeResult5_g194 : ase_worldViewDir ) + FinalLightDir2218 ) );
				...
				float3 localCenterEye46_g195 = CenterEye46_g195();
				float3 worldToViewDir27_g195 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g195 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g195 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye16_g196 = CenterEye16_g196();
				float3 normalizeResult19_g196 = normalize( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye16_g196 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g196 = normalize( cross( normalizeResult19_g196 , _worldUp ) );
				float3 temp_output_21_0_g196 = NormalSpecular965;
				float dotResult10_g196 = dot( normalizeResult8_g196 , temp_output_21_0_g196 );
				float dotResult2_g196 = dot( _worldUp , normalizeResult19_g196 );
				float3 normalizeResult7_g196 = normalize( ( _worldUp - ( dotResult2_g196 * normalizeResult19_g196 ) ) );
				float dotResult9_g196 = dot( normalizeResult7_g196 , temp_output_21_0_g196 );
				float2 appendResult11_g196 = (float2(dotResult10_g196 , dotResult9_g196));
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g195 ) , worldToViewDir13_g195 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g196 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				float3 lerpResult560 = lerp( float3( 0,0,0 ) , ( ( _SpecMatCapMode == 0.0 ? temp_output_2001_0 : ( temp_output_2001_0 * MaintexRGB3074 ) ) + ( _UseReflection == 1.0 ? indirectSpecular3174 : float3( 0,0,0 ) ) ) , ( _SpecMaskOpacity * tex2DNode695.r * tex2DNode695.a ));
				...
				float3 temp_cast_29 = (saturate( ( _Threshold + _Range ) )).xxx;
				sampler2D texvalue34_g202 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g202 = uv_SparklePatternRGB;
				half2 uvin34_g202 = temp_output_4_0_g202;
				half2 dx34_g202 = ( ddx( temp_output_4_0_g202 ) * float2( 0.25,0.25 ) );
				half2 dy34_g202 = ( ddy( temp_output_4_0_g202 ) * float2( 0.25,0.25 ) );
				half bias34_g202 = 0.0;
				half4 localsupersample2x234_g202 = supersample2x2( texvalue34_g202 , uvin34_g202 , dx34_g202 , dy34_g202 , bias34_g202 );
				float temp_output_1710_0 = ( 1.0 - _SparkleTexColour );
				float3 desaturateInitialColor1704 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g202 : tex2D( _SparklePatternRGB, uv_SparklePatternRGB ) ).xyz;
				...
				sampler2D texvalue34_g203 = _SparklePatternRGB;
				float2 break2472 = uv_SparklePatternRGB;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g197 = CenterEye72_g197();
				float4 appendResult76_g197 = (float4(( WorldPosition - localCenterEye72_g197 ) , 0.0));
				float4 temp_output_77_0_g197 = mul( UNITY_MATRIX_V, appendResult76_g197 );
				float2 break83_g197 = ( (temp_output_77_0_g197).xy / (temp_output_77_0_g197).z );
				float2 appendResult86_g197 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g197.x ) , ( break83_g197.y * 2.0 )));
				float2 appendResult101_g197 = (float2(1.0 , 1.0));
				float2 appendResult102_g197 = (float2(0.0 , 0.0));
				...
				float2 temp_output_2355_0 = ( ( appendResult2473 + ( ( _StereoCorrect == 0.0 ? ( ( ( ( -appendResult86_g197 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g197 ) + appendResult102_g197 ) : (ase_screenPosNorm).xy ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 );
				float2 temp_output_4_0_g203 = temp_output_2355_0;
				half2 uvin34_g203 = temp_output_4_0_g203;
				half2 dx34_g203 = ( ddx( temp_output_4_0_g203 ) * float2( 0.25,0.25 ) );
				half2 dy34_g203 = ( ddy( temp_output_4_0_g203 ) * float2( 0.25,0.25 ) );
				half bias34_g203 = 0.0;
				half4 localsupersample2x234_g203 = supersample2x2( texvalue34_g203 , uvin34_g203 , dx34_g203 , dy34_g203 , bias34_g203 );
				float3 desaturateInitialColor1705 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g203 : tex2D( _SparklePatternRGB, temp_output_2355_0 ) ).xyz;
				...
				float3 localCenterEye1_g200 = CenterEye1_g200();
				float3 smoothstepResult901 = smoothstep( temp_cast_28 , temp_cast_29 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g200 ) / 10000.0 ) , 0.5 ) ) ));
				...
				float4 SparkleOut971 = ( _UseSparkleShimmer == 1.0 ? ( ( tex2DNode1743.r * tex2DNode1743.a ) * ( _SparkleColor1 * ( 2.5 * ( 200.0 * temp_output_2804_0 ) ) ) * float4( smoothstepResult901 , 0.0 ) * switchResult2437 ) : temp_cast_35 );
				float Alpha1262 = (temp_output_2987_0).w;
				int localisCamera1_g204 = isCamera1_g204();
				int Cam17_g204 = localisCamera1_g204;
				int temp_output_5_0_g204 = (int)_IsInMirror;
				int temp_output_6_0_g204 = (int)_IsNotMirror;
				...
				clip( ( ( _MirrorSystem == 1.0 ? (float)( (float)Cam17_g204 == 1.0 ? ( (float)temp_output_5_0_g204 == 1.0 ? ( Cam17_g204 + temp_output_5_0_g204 ) : ( Cam17_g204 * temp_output_5_0_g204 ) ) : ( (float)temp_output_6_0_g204 == 0.0 ? ( Cam17_g204 * temp_output_6_0_g204 ) : ( Cam17_g204 + temp_output_6_0_g204 ) ) ) : 1.0 ) * ( _FriendsOnly == 1.0 ? ( _FriendsOnly1 == 1.0 ? ( 1.0 - temp_output_353_0 ) : temp_output_353_0 ) : 1.0 ) ) - _AlphaCutoff);
				float4 appendResult1923 = (float4(( ( _UseMatcap == 1.0 ? PostMatcap1274 : PostRimLight1292 ) + Emission1285 + float4( ( ( float3( 0.05,0.05,0.05 ) + (desaturateVar2291).xyz ) * SpecularOut983 ) , 0.0 ) + SparkleOut971 ).rgb , ( _Alpha * Alpha1262 )));
...
/*ASEBEGIN
Version=18814
-1623;70;1486;818;497.5002;1958.793;3.176055;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;2152;-4770.013,-1027.351;Inherit;False;Property;_LightMode;Lighting Mode;18;1;[Enum];Create;False;0;2;Surface;0;Object2World;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1058;-3948.189,177.9939;Inherit;False;Property;_UseShading;Use Shading;17;1;[ToggleUI];Create;True;0;0;0;False;2;Space(5);Header(.  Shadow  .);False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;23;0;Create;False;0;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightPos;2081;-2268.605,-168.3014;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;793;-1661.482,781.5772;Inherit;False;1728.081;844.5872;;33;1499;642;954;660;1036;669;680;670;665;679;1035;811;654;1064;664;646;684;682;1304;662;1492;1123;641;1504;1505;1506;1507;1605;645;2975;2976;3170;3171;Soft Shading;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.LightColorNode;1484;-2074.677,-65.98829;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.OneMinusNode;2082;-2003.231,-144.983;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3135;-2010.089,143.1332;Inherit;False;GetBakedLight;-1;;147;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,1,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1486;-1809.043,-64.73634;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3169;-1796.747,148.8935;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;1.3,1.3,1.3;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;1254;-3093.266,641.0908;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1408;-1846.627,51.59422;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.LightColorNode;1506;-1655.785,957.9029;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-1602.313,130.0703;Inherit;False;Property;_LightMultiplier;Light Multiplier;12;0;Create;True;0;0;0;False;0;False;1.1;1.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;641;-1616.012,1379.944;Inherit;False;Property;_ShadeScale;Shade Scale;45;0;Create;True;0;0;0;False;0;False;100;185;2;200;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1507;-1508.138,978.252;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1605;-1656.136,813.6085;Inherit;False;2014;VertAtten;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1008;-2925.583,515.3505;Inherit;False;Property;_ShadowColour;Shadow Colour;20;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;0.8588235,0.8588235,0.8588235,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;1505;-1657.785,882.83;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;1915;-1389.537,222.4456;Inherit;False;Property;_MaxLight;Max Light;13;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;1504;-1322.274,905.6057;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0.005;False;2;FLOAT3;0,0,0;False;3;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2867;-1374.826,43.67517;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1916;-1395.023,147.2134;Inherit;False;Property;_MinLight;Min Light;14;0;Create;True;0;0;0;False;0;False;0.9;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3170;-1363.782,1050.302;Inherit;False;GetBakedLight;-1;;192;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;642;-1621.744,1540.574;Inherit;False;Property;_ShadePower;Shade Power;44;0;Create;True;0;0;0;False;0;False;0.5;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-1911.759,-607.1998;Inherit;True;Property;_MainTex;Texture (RGB,A);4;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;de0b5c8ef1017ca499319af4fed7e820;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ClampOpNode;1914;-1199.376,102.5229;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0.8,0.8,0.8,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;3171;-1151.542,911.3829;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2988;-1561.327,-723.9846;Inherit;False;Property;_TexSuperSample;SuperSample (expensive);5;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;1304;-1030.103,911.2861;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;684;-1269.829,832.3073;Float;False;Property;_MultiplyDynamic;MultiplyDynamic;46;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;646;-1552.039,1131.359;Inherit;False;Property;_ShadeColour;Shade Colour;43;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2997;-1583.159,-645.2;Inherit;False;TextureSuperSample;-1;;193;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1064;-866.7738,889.0368;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;680;-688.7099,891.4136;Inherit;False;5;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;1,1,1,1;False;3;FLOAT4;0.88,0.88,0.88,0.88;False;4;FLOAT4;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1035;-745.4713,1071.783;Inherit;False;Property;_ShadeColorDynamic;ShadeColor Dynamic;42;1;[Enum];Create;True;0;2;FixedColour;0;LightColour;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2366.757,408.3535;Inherit;False;Property;_ShadowDarkness;Shadow Darkness;24;0;Create;True;0;0;0;False;0;False;0.22;0.125;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3120;-745.1984,411.3862;Inherit;False;Property;_LightSatLimiter;Light Saturation Limiter;15;0;Create;False;0;0;0;False;0;False;0.5;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2976;-477.4071,848.7371;Inherit;False;Property;_ShadeEnable;Shade Enable;41;1;[ToggleUI];Create;True;0;2;FixedColour;0;LightColour;1;0;False;2;Header(.  Soft Shading  .);;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-591.8463,-218.3334;Float;False;Property;_Saturation;Saturation;8;0;Create;True;0;0;0;False;0;False;1;3;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-570.1216,18.60373;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;25;0;Create;True;0;0;0;False;0;False;0.85;0.65;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;569;-1858.718,-2794;Inherit;False;2937.823;1659.745;;90;3044;3179;3182;3174;3177;3181;2002;3101;3180;3102;983;560;696;3175;824;701;695;3065;3072;3069;3104;3085;3064;3107;3103;2301;3068;2001;3081;3080;3067;3075;690;952;2234;1920;838;691;816;3079;2294;837;817;1921;3057;3056;554;2904;1919;561;545;2905;556;2900;2902;555;551;553;2899;3034;1051;1783;967;2898;1928;2236;2237;546;2224;2219;2853;1909;2225;3183;3184;3186;3189;3190;3192;3193;3211;3215;3216;3217;3218;3219;3220;3226;3227;3251;Specular Shine;1,0.503,0.6431538,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1500;151.5818,672.946;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DesaturateOpNode;1777;246.086,282.8321;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2289;279.2336,671.6793;Inherit;False;LightShaded;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;2853;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;194;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-18.96252,-881.5684;Inherit;False;Property;_Scale1;Rim Normal Power;92;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3034;-1564.883,-2116.931;Inherit;False;Matcap (legacy);-1;;195;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3044;-1572.417,-1950.33;Inherit;False;VR MatCap;-1;;196;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1823.167,-2299.266;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);54;0;Create;False;0;0;0;False;0;False;None;317bf5a5f25deba448de3306b3bc06fc;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;546;-1449.881,-2593.672;Inherit;False;Property;_SpecularSize;Specular Size;48;0;Create;True;0;0;0;False;0;False;1;7;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;369;220.3718,-627.3718;Inherit;False;Property;_Scale;Rim Scale;88;0;Create;False;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;234.6099,-535.8052;Inherit;False;Property;_Power;Rim Power;87;0;Create;False;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;837;-856.2704,-2359.592;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;58;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;197;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-1207.835,-2506.42;Inherit;False;Property;_SpecularStrength;Specular Strength;49;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;691;-853.549,-2189.995;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;56;0;Create;True;0;0;0;False;0;False;1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;84;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2641497,0.2181369,0.205588,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;384;671.9878,-620.4361;Inherit;False;Property;_Amount;Rim Opacity;86;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3035;675.3692,1207.173;Inherit;False;Matcap (legacy);-1;;199;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3042;679.5027,1427.81;Inherit;False;VR MatCap;-1;;198;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;349;2184.999,581.2747;Inherit;True;Property;_FriendsOnlyRT;> FriendsOnly RenderTexture;105;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1771.232,-4986.866;Inherit;False;VR_Center_Eye;-1;;200;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;2181;430.7538,925.1613;Inherit;True;Property;_Matcap;Matcap (RGB,A);94;0;Create;False;0;0;0;False;0;False;None;317bf5a5f25deba448de3306b3bc06fc;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1281;1378.964,-959.7588;Inherit;False;Property;_RimMode;Rim Mode;85;1;[Enum];Create;True;0;3;Blend_Lerp;0;Multiply;1;AddSubtract;2;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3179;-588.4656,-1800.913;Inherit;False;Property;_ProbeSmoothness;Probe Smoothness;65;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;3079;-286.9155,-2520.75;Inherit;False;968;LightColour;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3182;-584.4913,-1728.444;Inherit;False;Property;_ReflectionOpacity;Reflection Opacity;66;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;3177;-586.0796,-1869.91;Inherit;False;965;NormalSpecular;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;2558;-3112.507,-4767.948;Inherit;False;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;1514;1678.067,-888.0831;Inherit;False;Property;_UseRim;Use Rim;83;1;[ToggleUI];Create;True;0;0;0;False;3;Header(.  Rim Fresnel  .);;;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2919;1643.985,1203.188;Inherit;False;Property;_MatCapColor;MatCap Colour;100;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2999;-2173.673,-4671.193;Inherit;True;TextureSuperSample;-1;;202;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
Node;AmplifyShaderEditor.FunctionNode;2998;-2151.237,-4216.599;Inherit;True;TextureSuperSample;-1;;203;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
Node;AmplifyShaderEditor.RangedFloatNode;3181;10.65798,-1860.487;Inherit;False;Property;_UseReflection;Use Reflection Probe;63;1;[ToggleUI];Create;False;0;0;0;False;2;Space(5);Header(. Reflection Probe);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IndirectSpecularLight;3174;-317.4752,-1811.638;Inherit;False;World;3;0;FLOAT3;0,0,1;False;1;FLOAT;0.5;False;2;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;3080;-70.5372,-2522.968;Inherit;False;True;True;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;3067;10.81282,-2747.686;Inherit;False;Property;_SpecMatCapColor1;Specular Colour;50;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;2,2,2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1518;1852.559,1299.273;Float;False;Property;_MatcapSaturation;Matcap Saturation;98;0;Create;True;0;0;0;False;0;False;1;0.5;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;408;1735.079,1074.02;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;97;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1999;2640.491,408.0493;Inherit;False;Property;_FriendsOnly1;Invert Friends Only;106;0;Create;False;0;0;0;False;3;Toggle(_);;;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3142;2278.235,-49.58194;Inherit;False;Property;_IsNotMirror;Not Mirror;109;1;[IntRange];Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2213.303,1399.721;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;96;0;Create;True;0;0;0;False;0;False;5;0.333;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;462;1780.053,-1433.133;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1998;2878.466,362.3426;Inherit;False;Property;_FriendsOnly;Friends Only ON/OFF;104;0;Create;False;0;0;0;False;3;Toggle(_);Space(20);Header(VRC Friends Only);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3140;2280.56,-131.4182;Inherit;False;Property;_IsInMirror;In Mirror;108;1;[IntRange];Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3159;2671.712,-174.14;Inherit;False;Property;_MirrorSystem;Use Mirror System;107;1;[ToggleUI];Create;False;0;0;0;False;2;Space(10);Header(Mirror);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3168;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;204;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.LerpOp;450;1958.945,-1448.715;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2264;1651.116,-603.5377;Inherit;False;968;LightColour;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3219;-1196.632,-1542.015;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.IntNode;1342;3202.625,-1136.015;Inherit;False;Property;_StencilFail;StencilFail;117;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1344;2882.237,-914.3182;Float;False;Property;_ZTestMode;ZTestMode (LEqual);111;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1337;2882.479,-1280.823;Half;False;Property;_StencilRef;Stencil ID;112;0;Create;False;0;0;0;True;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3183;-282.0935,-1884.841;Inherit;False;Property;_ReflectionMode;Reflection Mode;64;1;[Enum];Create;True;0;2;Probe Reflection;0;Screenspace;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;1343;3201.625,-1061.015;Inherit;False;Property;_StencilZFail;StencilZFail;118;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1339;2875.299,-1112.257;Half;False;Property;_WriteMask;WriteMask (non-zero);113;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1431;2886.58,-820.4198;Inherit;False;Property;_SrcBlend;Source Blend (One);119;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(Debug);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1340;3181.625,-1281.015;Inherit;False;Property;_StencilComparison;Stencil Comparison;115;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1432;3151.765,-825.441;Inherit;False;Property;_DstBlend;Destination Blend (Zero);120;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1341;3206.338,-1208.357;Inherit;False;Property;_StencilOp;StencilOp;116;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;3189;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;205;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1345;2886.308,-1002.382;Float;False;Property;_ZWriteMode;ZWrite (write to depth buffer);110;1;[ToggleUI];Create;False;0;0;0;True;2;Space(10);Header(.  Advanced  .);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1338;2876.299,-1194.834;Half;False;Property;_ReadMask;ReadMask (non-zero);114;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E057E36279C8C6FFCC193154A503477270F21CAE
