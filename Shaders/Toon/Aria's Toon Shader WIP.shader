	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				float3 temp_cast_2 = (_MinLight).xxx;
				float3 clampResult3331 = clamp( ( ( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) + (VertLight1406).xyz + ( localunity_SHArgb3_g147 * float3( 1.3,1.3,1.3 ) ) ) * _LightMultiplier ) , temp_cast_2 , float3( 1,1,1 ) );
				float3 break5_g237 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * max( max( break5_g237.x , break5_g237.y ) , max( break5_g237.y , break5_g237.z ) ) ) / clampResult3331 ) );
				float3 break5_g238 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( max( max( break5_g238.x , break5_g238.y ) , max( break5_g238.y , break5_g238.z ) ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 temp_cast_3 = (( ( 1.0 - temp_output_1106_0 ) * _ShadowDarkness )).xxx;
				float3 clampResult30 = clamp( ( RampShade979 - temp_cast_3 ) , float3( 0,0,0 ) , float3( 0.8,0.8,0.8 ) );
				...
				float3 localCenterEye46_g221 = CenterEye46_g221();
				float3 worldToViewDir27_g221 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g221 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g221 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g221 ) , worldToViewDir13_g221 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g222 = CenterEye16_g222();
				float3 normalizeResult19_g222 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g222 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g222 = normalize( cross( normalizeResult19_g222 , _worldUp ) );
				float3 temp_output_21_0_g222 = NormalMatCap3089;
				float dotResult10_g222 = dot( normalizeResult8_g222 , temp_output_21_0_g222 );
				float dotResult2_g222 = dot( _worldUp , normalizeResult19_g222 );
				float3 normalizeResult7_g222 = normalize( ( _worldUp - ( dotResult2_g222 * normalizeResult19_g222 ) ) );
				float dotResult9_g222 = dot( normalizeResult7_g222 , temp_output_21_0_g222 );
				float2 appendResult11_g222 = (float2(dotResult10_g222 , dotResult9_g222));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g222 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 clampResult331 = clamp( ( lerpResult450 * (_EmissionColor).rgb * _EmissionIntensity ) , float3( 0,0,0 ) , temp_cast_10 );
				...
				float3 localCenterEye1_g217 = CenterEye1_g217();
				float3 temp_output_4_0_g217 = ( localCenterEye1_g217 - WorldPosition );
				float3 normalizeResult5_g217 = normalize( temp_output_4_0_g217 );
				float3 normalizeResult1783 = normalize( ( ( _StereoFixSpec == 1.0 ? normalizeResult5_g217 : ase_worldViewDir ) + FinalLightDir2218 ) );
				...
				float3 localCenterEye46_g219 = CenterEye46_g219();
				float3 worldToViewDir27_g219 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g219 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g219 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye16_g218 = CenterEye16_g218();
				float3 normalizeResult19_g218 = normalize( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye16_g218 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g218 = normalize( cross( normalizeResult19_g218 , _worldUp ) );
				float3 temp_output_21_0_g218 = NormalSpecular965;
				float dotResult10_g218 = dot( normalizeResult8_g218 , temp_output_21_0_g218 );
				float dotResult2_g218 = dot( _worldUp , normalizeResult19_g218 );
				float3 normalizeResult7_g218 = normalize( ( _worldUp - ( dotResult2_g218 * normalizeResult19_g218 ) ) );
				float dotResult9_g218 = dot( normalizeResult7_g218 , temp_output_21_0_g218 );
				float2 appendResult11_g218 = (float2(dotResult10_g218 , dotResult9_g218));
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g219 ) , worldToViewDir13_g219 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g218 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				float3 temp_cast_13 = (_Threshold).xxx;
				float3 temp_cast_14 = (saturate( ( _Threshold + _Range ) )).xxx;
				sampler2D texvalue34_g224 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g224 = uv_SparklePatternRGB;
				half2 uvin34_g224 = temp_output_4_0_g224;
				half2 dx34_g224 = ( ddx( temp_output_4_0_g224 ) * float2( 0.25,0.25 ) );
				half2 dy34_g224 = ( ddy( temp_output_4_0_g224 ) * float2( 0.25,0.25 ) );
				half bias34_g224 = 0.0;
				half4 localsupersample2x234_g224 = supersample2x2( texvalue34_g224 , uvin34_g224 , dx34_g224 , dy34_g224 , bias34_g224 );
				float temp_output_1710_0 = ( 1.0 - _SparkleTexColour );
				float3 desaturateInitialColor1704 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g224 : tex2D( _SparklePatternRGB, uv_SparklePatternRGB ) ).xyz;
				...
				sampler2D texvalue34_g225 = _SparklePatternRGB;
				float2 break2472 = uv_SparklePatternRGB;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g220 = CenterEye72_g220();
				float4 appendResult76_g220 = (float4(( WorldPosition - localCenterEye72_g220 ) , 0.0));
				float4 temp_output_77_0_g220 = mul( UNITY_MATRIX_V, appendResult76_g220 );
				float2 break83_g220 = ( (temp_output_77_0_g220).xy / (temp_output_77_0_g220).z );
				float2 appendResult86_g220 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g220.x ) , ( break83_g220.y * 2.0 )));
				float2 appendResult101_g220 = (float2(1.0 , 1.0));
				float2 appendResult102_g220 = (float2(0.0 , 0.0));
				...
				float2 temp_output_2355_0 = ( ( appendResult2473 + ( ( _StereoCorrect == 0.0 ? ( ( ( ( -appendResult86_g220 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g220 ) + appendResult102_g220 ) : (ase_screenPosNorm).xy ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 );
				float2 temp_output_4_0_g225 = temp_output_2355_0;
				half2 uvin34_g225 = temp_output_4_0_g225;
				half2 dx34_g225 = ( ddx( temp_output_4_0_g225 ) * float2( 0.25,0.25 ) );
				half2 dy34_g225 = ( ddy( temp_output_4_0_g225 ) * float2( 0.25,0.25 ) );
				half bias34_g225 = 0.0;
				half4 localsupersample2x234_g225 = supersample2x2( texvalue34_g225 , uvin34_g225 , dx34_g225 , dy34_g225 , bias34_g225 );
				float3 desaturateInitialColor1705 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g225 : tex2D( _SparklePatternRGB, temp_output_2355_0 ) ).xyz;
				...
				float3 localCenterEye1_g223 = CenterEye1_g223();
				float3 smoothstepResult901 = smoothstep( temp_cast_13 , temp_cast_14 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g223 ) / 10000.0 ) , 0.5 ) ) ));
				...
				float4 SparkleOut971 = ( _UseSparkleShimmer == 1.0 ? ( ( tex2DNode1743.r * tex2DNode1743.a ) * ( _SparkleColor1 * ( 2.5 * ( 200.0 * temp_output_2804_0 ) ) ) * float4( smoothstepResult901 , 0.0 ) * switchResult2437 ) : temp_cast_20 );
				float Alpha1262 = (temp_output_2987_0).w;
				int localisCamera1_g226 = isCamera1_g226();
				int Cam17_g226 = localisCamera1_g226;
				int temp_output_5_0_g226 = (int)_IsInMirror;
				int temp_output_6_0_g226 = (int)_IsNotMirror;
				...
				clip( ( ( _MirrorSystem == 1.0 ? (float)( (float)Cam17_g226 == 1.0 ? ( (float)temp_output_5_0_g226 == 1.0 ? ( Cam17_g226 + temp_output_5_0_g226 ) : ( Cam17_g226 * temp_output_5_0_g226 ) ) : ( (float)temp_output_6_0_g226 == 0.0 ? ( Cam17_g226 * temp_output_6_0_g226 ) : ( Cam17_g226 + temp_output_6_0_g226 ) ) ) : 1.0 ) * ( _FriendsOnly == 1.0 ? ( _FriendsOnly1 == 1.0 ? ( 1.0 - temp_output_353_0 ) : temp_output_353_0 ) : 1.0 ) ) - _AlphaCutoff);
...
/*ASEBEGIN
Version=18814
-1623;49;1486;818;2179.122;2814.111;4.028703;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;603;-5333.756,-1878.917;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;38;0;Create;True;0;0;0;False;0;False;0.5;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-5664.85,-1709.059;Inherit;True;Property;_Normal;Normal (N);35;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;3855b3126264f1b4bad2dc341abcbb3f;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;3263;-3725.823,752.9653;Float;False;Property;_LightMaskLevel;Mask Level;27;0;Create;False;0;0;0;False;0;False;1;1.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;23;0;Create;False;0;0;0;False;0;False;1;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3325;-1481.564,36.7731;Inherit;False;Float3 Max;-1;;237;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-1911.759,-607.1998;Inherit;True;Property;_MainTex;Texture (RGB,A);4;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;e3a2159bb5238584c8ee9ace5502e4a7;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2366.757,408.3535;Inherit;False;Property;_ShadowDarkness;Shadow Darkness;24;0;Create;True;0;0;0;False;0;False;0.22;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3326;-717.7537,324.6924;Inherit;False;Float3 Max;-1;;238;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2910;-444.7452,-308.1699;Inherit;False;Property;_Hue;Hue;7;0;Create;True;0;0;0;False;0;False;0;0.995;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-570.1216,18.60373;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;25;0;Create;True;0;0;0;False;0;False;0.85;1;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-591.8463,-218.3334;Float;False;Property;_Saturation;Saturation;8;0;Create;True;0;0;0;False;0;False;1;1;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2853;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;217;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;3044;-1572.417,-1950.33;Inherit;False;VR MatCap;-1;;218;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3034;-1564.883,-2116.931;Inherit;False;Matcap (legacy);-1;;219;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1823.167,-2299.266;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);54;0;Create;False;0;0;0;False;0;False;None;252c4088d408e2b4aa3f0fd60f94e38b;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;546;-1449.881,-2593.672;Inherit;False;Property;_SpecularSize;Specular Size;48;0;Create;True;0;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-1207.835,-2506.42;Inherit;False;Property;_SpecularStrength;Specular Strength;49;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;837;-856.2704,-2359.592;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;58;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0.5,0.5,0.5,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;220;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector3Node;902;-2380.579,-3733.505;Float;False;Property;_SparkleFresnel1;Fresnel Bias, Scale, Power;82;0;Create;False;0;0;0;False;0;False;0,10,0.1;0,10.03,0.02;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;885;-3466.895,-4024.817;Float;False;Property;_ScreenContribution;Screen Contribution;74;0;Create;True;0;0;0;False;0;False;0.3;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;691;-853.549,-2189.995;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;56;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;84;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560736,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2400;-3076.654,-3686.837;Inherit;False;Property;_MotionType;Motion Type;77;1;[Enum];Create;True;0;2;Linear;0;Circular;1;0;False;1;Space(5);False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3042;679.5027,1427.81;Inherit;False;VR MatCap;-1;;222;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3035;675.3692,1207.173;Inherit;False;Matcap (legacy);-1;;221;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1771.232,-4986.866;Inherit;False;VR_Center_Eye;-1;;223;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;2181;430.7538,925.1613;Inherit;True;Property;_Matcap;Matcap (RGB,A);94;0;Create;False;0;0;0;False;0;False;None;8f02e7ba8527b3749bd170e9445019a2;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;2999;-2173.673,-4671.193;Inherit;True;TextureSuperSample;-1;;224;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.RangedFloatNode;1709;-1627.061,-4494.261;Inherit;False;Property;_SparkleTexColour;SparkleTex Saturation;71;0;Create;False;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3101;79.22963,-2123.226;Inherit;False;Property;_SpecMatCapMode;SpecMatCap Mode;59;1;[Enum];Create;True;0;2;Additive;0;Multiplied;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2998;-2151.237,-4216.599;Inherit;True;TextureSuperSample;-1;;225;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.SamplerNode;3109;1943.706,1470.806;Inherit;True;Property;_MatCapMask;MatCap Mask (R,A);102;0;Create;False;0;0;0;False;1;Space(10);False;-1;None;0f3e5cdcbe145e0408e97d9eae75bacf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;897;-1185.224,-4365.983;Float;False;Property;_Threshold;Threshold;72;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;894;-1184.447,-4287.943;Float;False;Property;_Range;Range;73;0;Create;True;0;0;0;False;0;False;0.3;0.3;0.05;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;824;103.3333,-1395.451;Inherit;False;Property;_SpecMaskOpacity;SpecMatCap Level;61;0;Create;False;0;0;0;False;1;Space(10);False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;875;-645.7482,-4311.635;Float;False;Property;_SparkleColor1;Color;68;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;5.992157,2.258824,2.258824,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2213.303,1399.721;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;96;0;Create;True;0;0;0;False;0;False;5;0.55;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3168;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;226;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.FunctionNode;3189;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;227;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=42EF0815967067F1A3EE36228652C8B5CE7BD157
