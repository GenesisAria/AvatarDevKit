	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				#endif
				sampler2D texvalue34_g147 = _MainTex;
				float2 temp_output_4_0_g147 = i.ase_texcoord1.xy;
				half2 uvin34_g147 = temp_output_4_0_g147;
				half2 dx34_g147 = ( ddx( temp_output_4_0_g147 ) * float2( 0.25,0.25 ) );
				half2 dy34_g147 = ( ddy( temp_output_4_0_g147 ) * float2( 0.25,0.25 ) );
				half bias34_g147 = 0.0;
				half4 localsupersample2x234_g147 = supersample2x2( texvalue34_g147 , uvin34_g147 , dx34_g147 , dy34_g147 , bias34_g147 );
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_2987_0 = ( _TexSuperSample == 1.0 ? localsupersample2x234_g147 : tex2D( _MainTex, uv_MainTex ) );
				...
				float4 clampResult1914 = clamp( ( float4( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) , 0.0 ) + VertLight1406 + float4( desaturateVar2843 , 0.0 ) ) , temp_cast_5 , temp_cast_6 );
				...
				float3 localCenterEye46_g153 = CenterEye46_g153();
				float3 worldToViewDir27_g153 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g153 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g153 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g153 ) , worldToViewDir13_g153 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g154 = CenterEye16_g154();
				float3 normalizeResult19_g154 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g154 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g154 = normalize( cross( normalizeResult19_g154 , _worldUp ) );
				float3 temp_output_21_0_g154 = NormalMatCap3089;
				float dotResult10_g154 = dot( normalizeResult8_g154 , temp_output_21_0_g154 );
				float dotResult2_g154 = dot( _worldUp , normalizeResult19_g154 );
				float3 normalizeResult7_g154 = normalize( ( _worldUp - ( dotResult2_g154 * normalizeResult19_g154 ) ) );
				float dotResult9_g154 = dot( normalizeResult7_g154 , temp_output_21_0_g154 );
				float2 appendResult11_g154 = (float2(dotResult10_g154 , dotResult9_g154));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g154 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float4 clampResult331 = clamp( ( lerpResult450 * float4( (_EmissionColor).rgb , 0.0 ) * _EmissionIntensity ) , float4( 0,0,0,0 ) , temp_cast_23 );
				...
				float3 localCenterEye1_g148 = CenterEye1_g148();
				float3 temp_output_4_0_g148 = ( localCenterEye1_g148 - WorldPosition );
				float3 normalizeResult5_g148 = normalize( temp_output_4_0_g148 );
				float3 normalizeResult1783 = normalize( ( ( _StereoFixSpec == 1.0 ? normalizeResult5_g148 : ase_worldViewDir ) + FinalLightDir2218 ) );
				...
				float3 localCenterEye46_g151 = CenterEye46_g151();
				float3 worldToViewDir27_g151 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g151 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g151 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye16_g150 = CenterEye16_g150();
				float3 normalizeResult19_g150 = normalize( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye16_g150 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g150 = normalize( cross( normalizeResult19_g150 , _worldUp ) );
				float3 temp_output_21_0_g150 = NormalSpecular965;
				float dotResult10_g150 = dot( normalizeResult8_g150 , temp_output_21_0_g150 );
				float dotResult2_g150 = dot( _worldUp , normalizeResult19_g150 );
				float3 normalizeResult7_g150 = normalize( ( _worldUp - ( dotResult2_g150 * normalizeResult19_g150 ) ) );
				float dotResult9_g150 = dot( normalizeResult7_g150 , temp_output_21_0_g150 );
				float2 appendResult11_g150 = (float2(dotResult10_g150 , dotResult9_g150));
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g151 ) , worldToViewDir13_g151 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g150 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				float3 lerpResult560 = lerp( float3( 0,0,0 ) , ( ( _SpecularMode == 0.0 ? temp_output_3064_0 : ( temp_output_3064_0 * ( ( (LightColour968).xyz * MaintexRGB3074 ) + MaintexRGB3074 ) ) ) + ( _UseSpecularMatCap == 1.0 ? ( desaturateVar1920 * _SpecMatcapMultiply * (_SpecMatCapColor).rgb ) : float3(0,0,0) ) ) , ( tex2D( _SpecularMask, uv_SpecularMask ).r * _SpecMaskOpacity ));
				...
				float3 temp_cast_30 = (saturate( ( _Threshold + _Range ) )).xxx;
				sampler2D texvalue34_g159 = _SparklePattern;
				float2 uv_SparklePattern = i.ase_texcoord1.xy * _SparklePattern_ST.xy + _SparklePattern_ST.zw;
				float2 temp_output_4_0_g159 = uv_SparklePattern;
				half2 uvin34_g159 = temp_output_4_0_g159;
				half2 dx34_g159 = ( ddx( temp_output_4_0_g159 ) * float2( 0.25,0.25 ) );
				half2 dy34_g159 = ( ddy( temp_output_4_0_g159 ) * float2( 0.25,0.25 ) );
				half bias34_g159 = 0.0;
				half4 localsupersample2x234_g159 = supersample2x2( texvalue34_g159 , uvin34_g159 , dx34_g159 , dy34_g159 , bias34_g159 );
				float temp_output_1710_0 = ( 1.0 - _SparkleTexColour );
				float3 desaturateInitialColor1704 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g159 : tex2D( _SparklePattern, uv_SparklePattern ) ).xyz;
				...
				sampler2D texvalue34_g158 = _SparklePattern;
				float2 break2472 = uv_SparklePattern;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g152 = CenterEye72_g152();
				float4 appendResult76_g152 = (float4(( WorldPosition - localCenterEye72_g152 ) , 0.0));
				float4 temp_output_77_0_g152 = mul( UNITY_MATRIX_V, appendResult76_g152 );
				float2 break83_g152 = ( (temp_output_77_0_g152).xy / (temp_output_77_0_g152).z );
				float2 appendResult86_g152 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g152.x ) , ( break83_g152.y * 2.0 )));
				float2 appendResult101_g152 = (float2(1.0 , 1.0));
				float2 appendResult102_g152 = (float2(0.0 , 0.0));
				...
				float2 temp_output_2355_0 = ( ( appendResult2473 + ( ( _StereoCorrect == 0.0 ? ( ( ( ( -appendResult86_g152 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g152 ) + appendResult102_g152 ) : (ase_screenPosNorm).xy ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 );
				float2 temp_output_4_0_g158 = temp_output_2355_0;
				half2 uvin34_g158 = temp_output_4_0_g158;
				half2 dx34_g158 = ( ddx( temp_output_4_0_g158 ) * float2( 0.25,0.25 ) );
				half2 dy34_g158 = ( ddy( temp_output_4_0_g158 ) * float2( 0.25,0.25 ) );
				half bias34_g158 = 0.0;
				half4 localsupersample2x234_g158 = supersample2x2( texvalue34_g158 , uvin34_g158 , dx34_g158 , dy34_g158 , bias34_g158 );
				float3 desaturateInitialColor1705 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g158 : tex2D( _SparklePattern, temp_output_2355_0 ) ).xyz;
				...
				float3 localCenterEye1_g155 = CenterEye1_g155();
				float3 smoothstepResult901 = smoothstep( temp_cast_29 , temp_cast_30 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g155 ) / 10000.0 ) , 0.5 ) ) ));
...
/*ASEBEGIN
Version=18814
-1655;62;1552;818;3915.604;4221.81;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;428;-4911.921,-1289.749;Inherit;False;Property;_NormalPower;Normal Power;32;0;Create;True;0;0;0;False;0;False;0;0.15;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;603;-4900.572,-1822.415;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;33;0;Create;True;0;0;0;False;0;False;0.5;0.15;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3059;-4919.727,-2009.336;Inherit;True;Property;_NormalMask;Normal Mask;35;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-5231.666,-1652.557;Inherit;True;Property;_Normal;Normal;30;1;[Normal];Create;True;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;b6a3ebb8f4b838246a2682935ed52019;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;2962;-4883.589,-1591.276;Inherit;False;Property;_NormSuperSample;SuperSample (expensive);31;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-3232.884,-1265.439;Float;False;Property;_StaticLightZ;Static Light Z;25;0;Create;True;0;0;0;False;0;False;0.44;0.44;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;251;-3234.6,-1337.48;Float;False;Property;_StaticLightY;Static Light Y;24;0;Create;True;0;0;0;False;0;False;0.55;0.55;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2152;-4770.013,-1027.351;Inherit;False;Property;_LightMode;Lighting Mode;14;1;[Enum];Create;False;0;2;Surface;0;Object2World;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;249;-3234.506,-1411.764;Float;False;Property;_StaticLightX;Static Light X;23;0;Create;True;0;0;0;False;1;Header(  Fake Light);False;0.68;0.68;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1058;-3948.189,176.1206;Inherit;False;Property;_UseShading;Use Shading;13;0;Create;True;0;0;0;False;3;Space(5);Header(.  Shadow  .);Toggle(_);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1107;-3860.334,389.5299;Inherit;False;Property;_OffsetDot;Offset Dot;18;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;19;0;Create;False;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2211;-3633.483,565.0453;Inherit;True;Property;_LightMask;Light Mask;22;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldSpaceLightPos;2081;-2140.73,-327.7548;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;1775;-2045.164,191.2685;Inherit;False;Property;_BakedLightContrib;Baked Light Contrib;10;0;Create;True;0;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;1488;-2037.545,112.6068;Float;False;return ShadeSH9(half4(x, 1))@;3;False;1;True;x;FLOAT3;0,1,0.5;In;;Float;False;ShadeSH9 (baked light);True;False;0;1;0;FLOAT3;0,1,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;641;-1616.012,1379.944;Inherit;False;Property;_ShadeScale;Shade Scale;40;0;Create;True;0;0;0;False;0;False;100;100;2;200;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1774;-1802.807,111.0721;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;2082;-1871.346,-291.0798;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;1484;-1942.794,-212.0851;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;1008;-2925.583,515.3505;Inherit;False;Property;_ShadowColour;Shadow Colour;16;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;0.7098039,0.7098039,0.7098039,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1486;-1687.924,-208.6801;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;32;-2747.916,855.6759;Inherit;True;Property;_Ramp;Ramp;17;0;Create;False;0;0;0;False;0;False;-1;None;c320938fa0c7f9043aabb704290909a3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DesaturateOpNode;2843;-1815.957,20.9378;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.25;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1408;-1931.139,-65.41027;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;642;-1621.744,1540.574;Inherit;False;Property;_ShadePower;Shade Power;39;0;Create;True;0;0;0;False;0;False;0.5;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1505;-1642.785,912.83;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;1916;-1620.432,25.73791;Inherit;False;Property;_MinLight;Min Light;12;0;Create;True;0;0;0;False;0;False;0.9;0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-1911.759,-607.1998;Inherit;True;Property;_MainTex;Texture;1;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;668614ab93e7c694eae50290d7bb650f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1489;-1604.058,-98.41602;Inherit;False;3;3;0;FLOAT3;1,1,1;False;1;FLOAT4;0,0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1915;-1624.466,94.46868;Inherit;False;Property;_MaxLight;Max Light;11;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1025;-2345.685,748.077;Inherit;False;Property;_GradientorRamp;Gradient or Ramp;15;1;[Enum];Create;True;0;2;Ramp_Texture;0;Linear_Gradient;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-1610.824,200.9072;Inherit;False;Property;_LightMultiplier;Light Multiplier;9;0;Create;True;0;0;0;False;0;False;1.1;1.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;646;-1552.039,1131.359;Inherit;False;Property;_ShadeColour;Shade Colour;38;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;1914;-1421.723,17.30598;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0.8,0.8,0.8,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2988;-1561.327,-723.9846;Inherit;False;Property;_TexSuperSample;SuperSample (expensive);2;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;684;-1269.829,832.3073;Float;False;Property;_MultiplyDynamic;MultiplyDynamic;41;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2997;-1583.159,-645.2;Inherit;False;TextureSuperSample;-1;;147;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.CommentaryNode;569;-1621.408,-2462.519;Inherit;False;2674.146;1264.229;;63;2853;983;560;701;696;2301;695;824;2001;2002;952;690;2234;691;816;1920;838;2294;817;561;1921;837;1919;554;545;556;1928;551;967;555;553;1783;1051;2236;2237;546;2224;2219;2225;1909;2898;2899;2900;2901;2902;2904;2905;3034;3056;3057;3064;3065;3067;3068;3069;3070;3071;3072;3075;3079;3080;3081;3085;Specular Shine;1,0.503,0.6431538,1;0;0
Node;AmplifyShaderEditor.ColorNode;18;-1263.283,-410.7312;Float;False;Property;_Color;> Color;3;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2867;-975.4443,180.6884;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2225;-1558.234,-2432.753;Inherit;False;Property;_StereoFixSpec;Stereo Converge (flatten);47;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2853;-1546.548,-2208.793;Inherit;False;VR_Center_Eye;-1;;148;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
Node;AmplifyShaderEditor.RangedFloatNode;1035;-745.4713,1071.783;Inherit;False;Property;_ShadeColorDynamic;ShadeColor Dynamic;37;1;[Enum];Create;True;0;2;FixedColour;0;LightColour;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2366.757,408.3535;Inherit;False;Property;_ShadowDarkness;Shadow Darkness;20;0;Create;True;0;0;0;False;0;False;0.22;0.125;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;2085;-749.7419,270.5572;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2086;-632.1158,266.9483;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;546;-1212.571,-2262.192;Inherit;False;Property;_SpecularSize;Specular Size;43;0;Create;True;0;0;0;False;0;False;1;6.2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2910;-444.7452,-308.1699;Inherit;False;Property;_Hue;Hue;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2976;-477.4071,848.7371;Inherit;False;Property;_ShadeEnable;Shade Enable;36;0;Create;True;0;2;FixedColour;0;LightColour;1;0;False;2;Toggle(_);Header(.  Soft Shading  .);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2109;-459.3742,298.3149;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2093;-325.738,307.7964;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;585;-570.1216,18.60373;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;21;0;Create;True;0;0;0;False;0;False;0.85;0.65;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;870;-3721.226,-4676.133;Inherit;False;4668.005;2027.595;;99;2478;971;2004;2003;877;957;2437;1745;2811;901;2308;875;2313;2564;2801;1744;900;1743;898;2394;1704;2813;2805;2810;2812;1705;2556;897;894;2396;2440;2371;1710;2473;2355;2558;1709;2506;2395;2458;2480;2476;1746;2379;2505;2864;2544;2359;2372;2865;2360;1713;2806;2686;2472;2398;2377;2857;2356;2400;2841;2840;2942;960;2403;2779;885;1732;2349;2405;2778;2406;902;2357;2863;2833;2866;2348;2404;2834;2862;2361;2804;2839;2503;2426;2424;2425;2949;2950;2952;2953;2954;2955;2956;3093;3094;3095;3096;Sparkles Effect;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-591.8463,-218.3334;Float;False;Property;_Saturation;Saturation;5;0;Create;True;0;0;0;False;0;False;1;1.25;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2098;-315.3564,370.5656;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.25;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3088;-4542.551,-1980.222;Inherit;False;Property;_NormalPowerMatCap;Normal Power MatCap;34;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-970.525,-2174.94;Inherit;False;Property;_SpecularStrength;Specular Strength;44;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;545;-628.1136,-2424.189;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;561;-690.4775,-2173.157;Inherit;False;Property;_SpecularOpacity;Specular Opacity;42;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DesaturateOpNode;1777;-126.6427,261.4221;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-18.96252,-881.5684;Inherit;False;Property;_Scale1;Rim Normal Power;82;0;Create;False;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2361;-3538.954,-3001.891;Inherit;False;Property;_MotionSpeed;Motion Speed;68;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1533;0.8238602,-802.0875;Inherit;False;Property;_RimNormal;Rim Normal;81;1;[Toggle];Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1732;-3629.475,-4429.211;Inherit;True;Property;_SparklePattern;Sparkle Pattern;59;0;Create;True;0;0;0;False;0;False;None;bfb92db59315bec41a09a1ebe9e7d3f3;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;369;220.3718,-627.3718;Inherit;False;Property;_Scale;Rim Scale;78;0;Create;False;0;0;0;False;0;False;0;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2862;-3419.041,-3343.502;Float;False;Property;_WorldPosContribution;WorldPos Contribution;66;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1928;-1598.962,-1763.91;Inherit;False;Property;_StereoFixSpecCap;Stereo Converge (flatten);50;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2404;-3614.123,-3174.139;Inherit;False;Property;_RotateLinear;Rotate Linear;69;0;Create;True;0;0;0;False;0;False;0;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;368;234.6099,-535.8052;Inherit;False;Property;_Power;Rim Power;77;0;Create;False;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3067;248.1226,-2416.205;Inherit;False;Property;_SpecMatCapColor1;Specular Colour;45;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CosOpNode;2357;-2963.152,-2972.404;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;437;682.9595,629.283;Inherit;False;2516.223;776.2;Comment;30;963;1274;405;1278;414;807;406;1516;2180;1279;1517;407;1518;810;408;2165;2166;2176;2175;2181;1930;2207;2208;2209;2210;2873;2919;2920;3042;3035;Matcap > Alpha Supported;0.8221117,0.184,1,1;0;0
...
Node;AmplifyShaderEditor.WireNode;2834;-1173.565,-2945.629;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3096;-3387.153,-3903.528;Inherit;False;Property;_StereoCorrect;Stereo Correct;65;0;Create;True;0;1;Linear;0;0;False;1;Toggle(_);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2299;456.0557,-622.4279;Inherit;False;Property;_Min;Rim Min;79;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3044;-1318.962,-1701.728;Inherit;False;VR MatCap;-1;;150;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3034;-1318.962,-1845.728;Inherit;False;Matcap (legacy);-1;;151;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3431.611,-3829.53;Inherit;False;VR_ScreenSpaceUV;-1;;152;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1577.246,-2028.063;Inherit;True;Property;_SpecularMatcap;Specular Matcap;49;0;Create;False;0;0;0;False;0;False;None;cf4845bd31824ab48a85d069ba8442cf;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;2300;483.0557,-541.4279;Inherit;False;Property;_Max;Rim Max;80;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;885;-3252.743,-3587.437;Float;False;Property;_ScreenContribution;Screen Contribution;64;0;Create;True;0;0;0;False;0;False;0.3;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2905;-884.0963,-2002.447;Inherit;False;Property;_Legacy2;Legacy;54;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;963;734.1488,1157.885;Inherit;False;3089;NormalMatCap;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2209;905.6332,1315.428;Inherit;False;Property;_MatcapSpin;MatcapSpin;89;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;902;-2166.427,-3296.125;Float;False;Property;_SparkleFresnel1;Fresnel Bias, Scale, Power;72;0;Create;False;0;0;0;False;0;False;0,10,0.1;0,10,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;2400;-2862.502,-3249.457;Inherit;False;Property;_MotionType;Motion Type;67;1;[Enum];Create;True;0;2;Linear;0;Circular;1;0;False;1;Space(5);False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2833;-2146.365,-3080.029;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-1;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;74;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560746,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1930;706.2635,1060.928;Inherit;False;Property;_StereoFix;Stereo Converge (flatten);85;0;Create;False;0;0;0;False;1;Toggle(_);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2301;253.8365,-2256.963;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2873;731.7185,942.7683;Inherit;False;3089;NormalMatCap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NegateNode;1746;-3066.613,-4225.207;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3035;984.8725,944.7683;Inherit;False;Matcap (legacy);-1;;153;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;384;671.9878,-620.4361;Inherit;False;Property;_Amount;Rim Opacity;76;0;Create;False;0;0;0;False;0;False;0;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;2208;1107.407,1278.795;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2360;-2825.617,-3339.046;Inherit;False;Property;_MotionIntensity;Motion Intensity;70;0;Create;True;0;0;0;False;0;False;0.01;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3042;989.006,1165.405;Inherit;False;VR MatCap;-1;;154;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1919;-669.5865,-1667.672;Inherit;False;Property;_SpecMatcapSaturation;SpecMatcap Saturation;52;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1557.08,-4549.486;Inherit;False;VR_Center_Eye;-1;;155;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
Node;AmplifyShaderEditor.RangedFloatNode;3072;653.6027,-2322.338;Inherit;False;Property;_SpecularMode;Specular Mode;46;1;[Enum];Create;True;0;2;Additive;0;Multiplied;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RotatorNode;2210;1256.808,946.8693;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;837;-610.3494,-2088.389;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;53;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;2181;740.2571,662.7563;Inherit;True;Property;_Matcap;Matcap (Alpha Supported);84;0;Create;False;0;0;0;False;0;False;None;c88031b5ed7a6ab42bc5102139391462;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RotatorNode;2207;1297.99,1156.432;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1281;1378.964,-959.7588;Inherit;False;Property;_RimMode;Rim Mode;75;1;[Enum];Create;True;0;3;Blend_Lerp;0;Multiply;1;AddSubtract;2;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;691;-607.6281,-1918.792;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;51;0;Create;True;0;0;0;False;0;False;1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2175;1475.917,782.153;Inherit;True;Property;_TextureSample0;Texture Sample 0;90;0;Create;True;0;0;0;False;0;False;2901;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2166;1588.002,691.9649;Inherit;False;Property;_Legacy;Legacy;91;0;Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2998;-1937.085,-3779.219;Inherit;True;TextureSuperSample;-1;;158;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.RangedFloatNode;2002;-107.7466,-2063.491;Inherit;False;Property;_UseSpecularMatCap;Use Specular MatCap;48;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(. Specular Overlay);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2919;1953.488,940.7828;Inherit;False;Property;_MatCapColor;MatCap Colour;90;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1514;1678.067,-888.0831;Inherit;False;Property;_UseRim;Use Rim;73;0;Create;True;0;0;0;False;3;Toggle(_);;Header(.  Rim Fresnel  .);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;3071;970.1685,-2027.141;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Compare;2165;1822.189,727.199;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2954;-1679.011,-4076.228;Inherit;False;Property;_SparkleSuperSample;SuperSample (expensive);60;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1709;-1412.909,-4056.881;Inherit;False;Property;_SparkleTexColour;SparkleTex Saturation;61;0;Create;False;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2999;-1959.521,-4233.813;Inherit;True;TextureSuperSample;-1;;159;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.RangedFloatNode;894;-970.2949,-3850.563;Float;False;Property;_Range;Range;63;0;Create;True;0;0;0;False;0;False;0.3;0.05;0.05;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;2920;2146.152,940.1598;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;328;1232.592,-1529.267;Inherit;True;Property;_Emission;Emission Map;26;0;Create;False;0;0;0;False;2;Space(5);Header(.  Emission  .);False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;897;-971.0718,-3928.603;Float;False;Property;_Threshold;Threshold;62;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;824;201.7712,-1758.229;Inherit;False;Property;_SpecMaskOpacity;SpecMask Opacity;56;0;Create;True;0;0;0;False;0;False;1;0.005;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1518;1945.062,1218.868;Float;False;Property;_MatcapSaturation;Matcap Saturation;88;0;Create;True;0;0;0;False;0;False;1;0;-1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;3070;532.1685,-1944.141;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;810;2002.612,693.456;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;695;130.7581,-1681.483;Inherit;True;Property;_SpecularMask;Specular Mask;55;0;Create;True;0;0;0;False;1;Space(10);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;408;2044.582,811.6145;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;87;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;349;1997,116.3659;Inherit;True;Property;_FriendsOnlyRT;> FriendsOnly RenderTexture;93;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1743;-563.8309,-4342.658;Inherit;True;Property;_SparkleMask1;Sparkle Mask;71;0;Create;False;0;0;0;False;1;Space(5);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;696;448.6492,-1800.662;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1517;2233.464,1214.806;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;407;2284.442,791.7888;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;406;2413.806,1214.316;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;86;0;Create;True;0;0;0;False;0;False;5;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;327;1647.938,-1245.289;Float;False;Property;_EmissionColor;Emission Colour;27;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DesaturateOpNode;1516;2441.824,821.8158;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;2180;1892.055,1127.174;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;875;-431.5964,-3874.255;Float;False;Property;_SparkleColor1;Color;58;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;461;1530.298,-1337.511;Inherit;False;Property;_ShadedEmission;Shaded Emission;29;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;560;705.934,-1939.117;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1279;2248.082,683.1205;Inherit;False;1292;PostRimLight;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;326;1875.891,-1157.456;Float;False;Property;_EmissionIntensity;Emission Intensity;28;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1278;2532.334,664.3506;Inherit;False;1292;PostRimLight;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;414;2637.017,771.8748;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;807;2692.414,1136.919;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2003;147.5947,-3946.621;Inherit;False;Property;_UseSparkles;Use Sparkles;57;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(.  Sparkles  .);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;2993;-1190.808,-494.5154;Inherit;False;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;405;2797.475,714.5323;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1999;2452.493,-56.85925;Inherit;False;Property;_FriendsOnly1;Invert Friends Only;94;0;Create;False;0;0;0;False;3;Toggle(_);;;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1274;2995.524,709.718;Inherit;False;PostMatcap;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1262;-987.7227,-491.4229;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1021;2188.035,-1013.522;Inherit;False;Property;_UseMatcap;Use Matcap;83;0;Create;True;0;0;0;False;3;Toggle(_);Space(10);Header(.  MatCap  .);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1998;2690.467,-102.566;Inherit;False;Property;_FriendsOnly;Friends Only ON/OFF;92;0;Create;False;0;0;0;False;3;Toggle(_);Space(20);Header(VRC Friends Only);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;334;2207.65,-410.3355;Inherit;False;Property;_Alpha;Alpha;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1433;2895.654,-337.9704;Inherit;False;Property;_Cutoff;Alpha Cutoff;8;0;Create;False;0;0;0;True;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;1342;3202.625,-1136.015;Inherit;False;Property;_StencilFail;StencilFail;102;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1431;2886.58,-820.4198;Inherit;False;Property;_SrcBlend;Source Blend (One);104;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(Debug);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1338;2876.299,-1194.834;Half;False;Property;_ReadMask;ReadMask;99;0;Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1337;2882.479,-1280.823;Half;False;Property;_StencilRef;Stencil ID;97;0;Create;False;0;0;0;True;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1339;2875.299,-1112.257;Half;False;Property;_WriteMask;WriteMask;98;0;Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1341;3206.338,-1208.357;Inherit;False;Property;_StencilOp;StencilOp;101;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;1340;3181.625,-1281.015;Inherit;False;Property;_StencilComparison;Stencil Comparison;100;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;1343;3201.625,-1061.015;Inherit;False;Property;_StencilZFail;StencilZFail;103;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1345;2885.308,-1002.382;Float;False;Property;_ZWriteMode;ZWrite (write to depth buffer);95;1;[Toggle];Create;False;0;0;0;True;2;Space(10);Header(.  Advanced  .);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1432;3151.765,-825.441;Inherit;False;Property;_DstBlend;Destination Blend (Zero);105;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1344;2882.237,-914.3182;Float;False;Property;_ZTestMode;ZTestMode (LEqual);96;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1469;2892.559,-694.9409;Inherit;False;Property;_AlphaToCoverage;AlphaToCoverage (override alpha);6;1;[Toggle];Create;False;0;0;0;True;1;Space (5);False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0CBE2100731A8252A0B5113A3FAA9CFF77DF5B95
