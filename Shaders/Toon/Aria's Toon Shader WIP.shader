	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				float3 localCenterEye46_g246 = CenterEye46_g246();
				float3 worldToViewDir27_g246 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g246 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g246 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g246 ) , worldToViewDir13_g246 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g245 = CenterEye16_g245();
				float3 normalizeResult19_g245 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g245 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g245 = normalize( cross( normalizeResult19_g245 , _worldUp ) );
				float3 temp_output_21_0_g245 = NormalMatCap3089;
				float dotResult10_g245 = dot( normalizeResult8_g245 , temp_output_21_0_g245 );
				float dotResult2_g245 = dot( _worldUp , normalizeResult19_g245 );
				float3 normalizeResult7_g245 = normalize( ( _worldUp - ( dotResult2_g245 * normalizeResult19_g245 ) ) );
				float dotResult9_g245 = dot( normalizeResult7_g245 , temp_output_21_0_g245 );
				float2 appendResult11_g245 = (float2(dotResult10_g245 , dotResult9_g245));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g245 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 localCenterEye1_g240 = CenterEye1_g240();
				float3 temp_output_4_0_g240 = ( localCenterEye1_g240 - WorldPosition );
				float3 normalizeResult5_g240 = normalize( temp_output_4_0_g240 );
				...
				float3 normalizeResult1783 = normalize( ( ( _StereoFixSpec == 1.0 ? normalizeResult5_g240 : ase_worldViewDir ) + FinalLightDir2218 ) );
				...
				float3 localCenterEye46_g242 = CenterEye46_g242();
				float3 worldToViewDir27_g242 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g242 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g242 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye16_g243 = CenterEye16_g243();
				float3 normalizeResult19_g243 = normalize( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye16_g243 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g243 = normalize( cross( normalizeResult19_g243 , _worldUp ) );
				float3 temp_output_21_0_g243 = NormalSpecular965;
				float dotResult10_g243 = dot( normalizeResult8_g243 , temp_output_21_0_g243 );
				float dotResult2_g243 = dot( _worldUp , normalizeResult19_g243 );
				float3 normalizeResult7_g243 = normalize( ( _worldUp - ( dotResult2_g243 * normalizeResult19_g243 ) ) );
				float dotResult9_g243 = dot( normalizeResult7_g243 , temp_output_21_0_g243 );
				float2 appendResult11_g243 = (float2(dotResult10_g243 , dotResult9_g243));
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g242 ) , worldToViewDir13_g242 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g243 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				sampler2D texvalue34_g248 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g248 = uv_SparklePatternRGB;
				half2 uvin34_g248 = temp_output_4_0_g248;
				half2 dx34_g248 = ( ddx( temp_output_4_0_g248 ) * float2( 0.25,0.25 ) );
				half2 dy34_g248 = ( ddy( temp_output_4_0_g248 ) * float2( 0.25,0.25 ) );
				half bias34_g248 = 0.0;
				half4 localsupersample2x234_g248 = supersample2x2( texvalue34_g248 , uvin34_g248 , dx34_g248 , dy34_g248 , bias34_g248 );
				float temp_output_1710_0 = ( 1.0 - _SparkleTexColour );
				float3 desaturateInitialColor1704 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g248 : tex2D( _SparklePatternRGB, uv_SparklePatternRGB ) ).xyz;
				...
				sampler2D texvalue34_g249 = _SparklePatternRGB;
				float2 break2472 = uv_SparklePatternRGB;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g244 = CenterEye72_g244();
				float4 appendResult76_g244 = (float4(( WorldPosition - localCenterEye72_g244 ) , 0.0));
				float4 temp_output_77_0_g244 = mul( UNITY_MATRIX_V, appendResult76_g244 );
				float2 break83_g244 = ( (temp_output_77_0_g244).xy / (temp_output_77_0_g244).z );
				float2 appendResult86_g244 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g244.x ) , ( break83_g244.y * 2.0 )));
				float2 appendResult101_g244 = (float2(1.0 , 1.0));
				float2 appendResult102_g244 = (float2(0.0 , 0.0));
				...
				float2 temp_output_2355_0 = ( ( appendResult2473 + ( ( _StereoCorrect == 0.0 ? ( ( ( ( -appendResult86_g244 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g244 ) + appendResult102_g244 ) : (ase_screenPosNorm).xy ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 );
				float2 temp_output_4_0_g249 = temp_output_2355_0;
				half2 uvin34_g249 = temp_output_4_0_g249;
				half2 dx34_g249 = ( ddx( temp_output_4_0_g249 ) * float2( 0.25,0.25 ) );
				half2 dy34_g249 = ( ddy( temp_output_4_0_g249 ) * float2( 0.25,0.25 ) );
				half bias34_g249 = 0.0;
				half4 localsupersample2x234_g249 = supersample2x2( texvalue34_g249 , uvin34_g249 , dx34_g249 , dy34_g249 , bias34_g249 );
				float3 desaturateInitialColor1705 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g249 : tex2D( _SparklePatternRGB, temp_output_2355_0 ) ).xyz;
				...
				float3 localCenterEye1_g247 = CenterEye1_g247();
				float3 smoothstepResult901 = smoothstep( temp_cast_14 , temp_cast_15 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g247 ) / 10000.0 ) , 0.5 ) ) ));
				...
				int localisCamera1_g250 = isCamera1_g250();
				int Cam17_g250 = localisCamera1_g250;
				int temp_output_5_0_g250 = (int)_IsInMirror;
				int temp_output_6_0_g250 = (int)_IsNotMirror;
				float FriendsOnlyToggle3353 = _FriendsOnly;
				clip( ( ( _MirrorSystem == 1.0 ? (float)( (float)Cam17_g250 == 1.0 ? ( (float)temp_output_5_0_g250 == 1.0 ? ( Cam17_g250 + temp_output_5_0_g250 ) : ( Cam17_g250 * temp_output_5_0_g250 ) ) : ( (float)temp_output_6_0_g250 == 0.0 ? ( Cam17_g250 * temp_output_6_0_g250 ) : ( Cam17_g250 + temp_output_6_0_g250 ) ) ) : 1.0 ) * ( FriendsOnlyToggle3353 == 1.0 ? ( FriendsOnlyInvert3333 * 2.0 ) : 1.0 ) ) - _AlphaCutoff);
...
/*ASEBEGIN
Version=18814
-1635;27;1486;818;2858.759;1312.59;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;2853;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;240;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1823.167,-2299.266;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);54;0;Create;False;0;0;0;False;0;False;None;cf4845bd31824ab48a85d069ba8442cf;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;3044;-1572.417,-1950.33;Inherit;False;VR MatCap;-1;;243;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3034;-1564.883,-2116.931;Inherit;False;Matcap (legacy);-1;;242;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1919;-915.5077,-1938.875;Inherit;False;Property;_SpecMatcapSaturation;SpecMatcap Saturation;57;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;244;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;691;-853.549,-2189.995;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;56;0;Create;True;0;0;0;False;0;False;1;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;84;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560739,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3042;679.5027,1427.81;Inherit;False;VR MatCap;-1;;245;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3035;675.3692,1207.173;Inherit;False;Matcap (legacy);-1;;246;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1771.232,-4986.866;Inherit;False;VR_Center_Eye;-1;;247;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;2998;-2151.237,-4216.599;Inherit;True;TextureSuperSample;-1;;249;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;2999;-2173.673,-4671.193;Inherit;True;TextureSuperSample;-1;;248;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3168;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;250;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.FunctionNode;3189;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;251;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=2BF5E5353D223854996AFB7F54101EB31CF4A984
