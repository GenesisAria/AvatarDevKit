...
Shader ".GenesisAria/Arias Toon Shader WIP"
{
	Properties
	{
		...
		_LightSaturationLimiter("Light Saturation Limiter", Float) = 0.5
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				float4 clampResult1914 = clamp( ( float4( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) , 0.0 ) + VertLight1406 + float4( ( localShadeSH9bakedlight1488 * _BakedLightContrib ) , 0.0 ) ) , temp_cast_5 , temp_cast_6 );
				...
				float3 desaturateVar1777 = lerp( desaturateInitialColor1777, desaturateDot1777.xxx, (0.0 + (saturate( ( max( max( break2085.x , break2085.y ) , max( break2085.y , break2085.z ) ) * break2085.w ) ) - 0.0) * (( 1.0 - _LightSaturationLimiter ) - 0.0) / (1.0 - 0.0)) );
				...
				float3 localCenterEye46_g164 = CenterEye46_g164();
				float3 worldToViewDir27_g164 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g164 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g164 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g164 ) , worldToViewDir13_g164 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g165 = CenterEye16_g165();
				float3 normalizeResult19_g165 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g165 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g165 = normalize( cross( normalizeResult19_g165 , _worldUp ) );
				float3 temp_output_21_0_g165 = NormalMatCap3089;
				float dotResult10_g165 = dot( normalizeResult8_g165 , temp_output_21_0_g165 );
				float dotResult2_g165 = dot( _worldUp , normalizeResult19_g165 );
				float3 normalizeResult7_g165 = normalize( ( _worldUp - ( dotResult2_g165 * normalizeResult19_g165 ) ) );
				float dotResult9_g165 = dot( normalizeResult7_g165 , temp_output_21_0_g165 );
				float2 appendResult11_g165 = (float2(dotResult10_g165 , dotResult9_g165));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g165 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 localCenterEye46_g161 = CenterEye46_g161();
				float3 worldToViewDir27_g161 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g161 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g161 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				...
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g161 ) , worldToViewDir13_g161 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g162 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				sampler2D texvalue34_g167 = _SparklePattern;
				float2 uv_SparklePattern = i.ase_texcoord1.xy * _SparklePattern_ST.xy + _SparklePattern_ST.zw;
				float2 temp_output_4_0_g167 = uv_SparklePattern;
				half2 uvin34_g167 = temp_output_4_0_g167;
				half2 dx34_g167 = ( ddx( temp_output_4_0_g167 ) * float2( 0.25,0.25 ) );
				half2 dy34_g167 = ( ddy( temp_output_4_0_g167 ) * float2( 0.25,0.25 ) );
				half bias34_g167 = 0.0;
				half4 localsupersample2x234_g167 = supersample2x2( texvalue34_g167 , uvin34_g167 , dx34_g167 , dy34_g167 , bias34_g167 );
				float temp_output_1710_0 = ( 1.0 - _SparkleTexColour );
				float3 desaturateInitialColor1704 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g167 : tex2D( _SparklePattern, uv_SparklePattern ) ).xyz;
				...
				sampler2D texvalue34_g168 = _SparklePattern;
				float2 break2472 = uv_SparklePattern;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g163 = CenterEye72_g163();
				float4 appendResult76_g163 = (float4(( WorldPosition - localCenterEye72_g163 ) , 0.0));
				float4 temp_output_77_0_g163 = mul( UNITY_MATRIX_V, appendResult76_g163 );
				float2 break83_g163 = ( (temp_output_77_0_g163).xy / (temp_output_77_0_g163).z );
				float2 appendResult86_g163 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g163.x ) , ( break83_g163.y * 2.0 )));
				float2 appendResult101_g163 = (float2(1.0 , 1.0));
				float2 appendResult102_g163 = (float2(0.0 , 0.0));
				...
				float2 temp_output_2355_0 = ( ( appendResult2473 + ( ( _StereoCorrect == 0.0 ? ( ( ( ( -appendResult86_g163 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g163 ) + appendResult102_g163 ) : (ase_screenPosNorm).xy ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 );
				float2 temp_output_4_0_g168 = temp_output_2355_0;
				half2 uvin34_g168 = temp_output_4_0_g168;
				half2 dx34_g168 = ( ddx( temp_output_4_0_g168 ) * float2( 0.25,0.25 ) );
				half2 dy34_g168 = ( ddy( temp_output_4_0_g168 ) * float2( 0.25,0.25 ) );
				half bias34_g168 = 0.0;
				half4 localsupersample2x234_g168 = supersample2x2( texvalue34_g168 , uvin34_g168 , dx34_g168 , dy34_g168 , bias34_g168 );
				float3 desaturateInitialColor1705 = ( _SparkleSuperSample == 1.0 ? localsupersample2x234_g168 : tex2D( _SparklePattern, temp_output_2355_0 ) ).xyz;
				...
				float3 localCenterEye1_g166 = CenterEye1_g166();
				float3 smoothstepResult901 = smoothstep( temp_cast_31 , temp_cast_32 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g166 ) / 10000.0 ) , 0.5 ) ) ));
...
/*ASEBEGIN
Version=18814
-1625;70;1552;818;-2360.752;1472.606;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;603;-4900.572,-1822.415;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;36;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;428;-4911.921,-1289.749;Inherit;False;Property;_NormalPower;Normal Power;35;0;Create;True;0;0;0;False;0;False;0;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3059;-4919.727,-2009.336;Inherit;True;Property;_NormalMask;Normal Mask;38;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-5231.666,-1652.557;Inherit;True;Property;_Normal;Normal;33;1;[Normal];Create;True;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;2962;-4883.589,-1591.276;Inherit;False;Property;_NormSuperSample;SuperSample (expensive);34;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2152;-4770.013,-1027.351;Inherit;False;Property;_LightMode;Lighting Mode;17;1;[Enum];Create;False;0;2;Surface;0;Object2World;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;249;-3234.506,-1411.764;Float;False;Property;_StaticLightX;Static Light X;26;0;Create;True;0;0;0;False;1;Header(  Fake Light);False;0.68;0.68;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;-3234.6,-1337.48;Float;False;Property;_StaticLightY;Static Light Y;27;0;Create;True;0;0;0;False;0;False;0.55;0.55;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-3232.884,-1265.439;Float;False;Property;_StaticLightZ;Static Light Z;28;0;Create;True;0;0;0;False;0;False;0.44;0.44;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1058;-3948.189,176.1206;Inherit;False;Property;_UseShading;Use Shading;16;0;Create;True;0;0;0;False;3;Space(5);Header(.  Shadow  .);Toggle(_);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1107;-3860.334,389.5299;Inherit;False;Property;_OffsetDot;Offset Dot;21;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2211;-3633.483,565.0453;Inherit;True;Property;_LightMask;Light Mask;25;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;1683;-3913.112,-515.0101;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;22;0;Create;False;0;0;0;False;0;False;1;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightPos;2081;-2223.377,-321.1954;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1775;-2070.496,61.59797;Inherit;False;Property;_BakedLightContrib;Baked Light Contrib;12;0;Create;True;0;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;1488;-2060.857,-3.352972;Float;False;return ShadeSH9(half4(x, 1))@;3;False;1;True;x;FLOAT3;0,1,0.5;In;;Float;False;ShadeSH9 (baked light);True;False;0;1;0;FLOAT3;0,1,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;2082;-1953.994,-284.5204;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;1484;-2025.442,-205.5257;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;641;-1616.012,1379.944;Inherit;False;Property;_ShadeScale;Shade Scale;43;0;Create;True;0;0;0;False;0;False;100;100;2;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1774;-1856.823,-4.88767;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;1008;-2925.583,515.3505;Inherit;False;Property;_ShadowColour;Shadow Colour;19;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;0.8207547,0.8207547,0.8207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1486;-1770.572,-202.1207;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1408;-1893.787,-79.85089;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;32;-2747.916,855.6759;Inherit;True;Property;_Ramp;Ramp;20;0;Create;False;0;0;0;False;0;False;-1;None;c320938fa0c7f9043aabb704290909a3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;642;-1621.744,1540.574;Inherit;False;Property;_ShadePower;Shade Power;42;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1489;-1573.885,-94.48039;Inherit;False;3;3;0;FLOAT3;1,1,1;False;1;FLOAT4;0,0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;1915;-1624.466,94.46868;Inherit;False;Property;_MaxLight;Max Light;13;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1123;-1551.346,1451.52;Inherit;False;962;NormalShade;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1916;-1620.432,25.73791;Inherit;False;Property;_MinLight;Min Light;14;0;Create;True;0;0;0;False;0;False;0.9;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-1331.824,211.9072;Inherit;False;Property;_LightMultiplier;Light Multiplier;11;0;Create;True;0;0;0;False;0;False;1.1;1.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;684;-1269.829,832.3073;Float;False;Property;_MultiplyDynamic;MultiplyDynamic;44;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2867;-1118.791,147.8518;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;646;-1552.039,1131.359;Inherit;False;Property;_ShadeColour;Shade Colour;41;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1025;-2345.685,748.077;Inherit;False;Property;_GradientorRamp;Gradient or Ramp;18;1;[Enum];Create;True;0;2;Ramp_Texture;0;Linear_Gradient;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2225;-1558.234,-2432.753;Inherit;False;Property;_StereoFixSpec;Stereo Converge (flatten);50;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2366.757,408.3535;Inherit;False;Property;_ShadowDarkness;Shadow Darkness;23;0;Create;True;0;0;0;False;0;False;0.22;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1035;-745.4713,1071.783;Inherit;False;Property;_ShadeColorDynamic;ShadeColor Dynamic;40;1;[Enum];Create;True;0;2;FixedColour;0;LightColour;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2976;-477.4071,848.7371;Inherit;False;Property;_ShadeEnable;Shade Enable;39;0;Create;True;0;2;FixedColour;0;LightColour;1;0;False;2;Toggle(_);Header(.  Soft Shading  .);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;546;-1212.571,-2262.192;Inherit;False;Property;_SpecularSize;Specular Size;46;0;Create;True;0;0;0;False;0;False;1;6.2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3120;-745.1984,411.3862;Inherit;False;Property;_LightSaturationLimiter;Light Saturation Limiter;15;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-570.1216,18.60373;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;24;0;Create;True;0;0;0;False;0;False;0.85;1;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-970.525,-2174.94;Inherit;False;Property;_SpecularStrength;Specular Strength;47;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3088;-4542.551,-1980.222;Inherit;False;Property;_NormalPowerMatCap;Normal Power MatCap;37;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1928;-1598.962,-1763.91;Inherit;False;Property;_StereoFixSpecCap;Stereo Converge (flatten);53;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;561;-690.4775,-2173.157;Inherit;False;Property;_SpecularOpacity;Specular Opacity;45;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3034;-1318.962,-1845.728;Inherit;False;Matcap (legacy);-1;;161;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-18.96252,-881.5684;Inherit;False;Property;_Scale1;Rim Normal Power;86;0;Create;False;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1577.246,-2028.063;Inherit;True;Property;_SpecularMatcap;Specular Matcap;52;0;Create;False;0;0;0;False;0;False;None;5ffad72f50c3f2c43b291ed9ecaee2e8;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;2361;-3538.954,-3001.891;Inherit;False;Property;_MotionSpeed;Motion Speed;72;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1732;-3629.475,-4429.211;Inherit;True;Property;_SparklePattern;Sparkle Pattern;63;0;Create;True;0;0;0;False;0;False;None;None;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1533;0.8238602,-802.0875;Inherit;False;Property;_RimNormal;Rim Normal;85;1;[Toggle];Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2905;-884.0963,-2002.447;Inherit;False;Property;_Legacy2;Legacy;58;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1919;-669.5865,-1667.672;Inherit;False;Property;_SpecMatcapSaturation;SpecMatcap Saturation;55;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;234.6099,-535.8052;Inherit;False;Property;_Power;Rim Power;81;0;Create;False;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2404;-3614.123,-3174.139;Inherit;False;Property;_RotateLinear;Rotate Linear;73;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2862;-3419.041,-3343.502;Float;False;Property;_WorldPosContribution;WorldPos Contribution;70;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;369;220.3718,-627.3718;Inherit;False;Property;_Scale;Rim Scale;82;0;Create;False;0;0;0;False;0;False;0;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;3091;-3715.273,-1943.732;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;3067;248.1226,-2416.205;Inherit;False;Property;_SpecMatCapColor1;Specular Colour;48;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;837;-610.3494,-2088.389;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;56;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3431.611,-3829.53;Inherit;False;VR_ScreenSpaceUV;-1;;163;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;3096;-3387.153,-3903.528;Inherit;False;Property;_StereoCorrect;Stereo Correct;69;0;Create;True;0;1;Linear;0;0;False;1;Toggle(_);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2299;456.0557,-622.4279;Inherit;False;Property;_Min;Rim Min;83;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2300;483.0557,-541.4279;Inherit;False;Property;_Max;Rim Max;84;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;691;-607.6281,-1918.792;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;54;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2400;-2862.502,-3249.457;Inherit;False;Property;_MotionType;Motion Type;71;1;[Enum];Create;True;0;2;Linear;0;Circular;1;0;False;1;Space(5);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2209;905.6332,1315.428;Inherit;False;Property;_MatcapSpin;MatcapSpin;93;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;78;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560745,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;902;-2166.427,-3296.125;Float;False;Property;_SparkleFresnel1;Fresnel Bias, Scale, Power;76;0;Create;False;0;0;0;False;0;False;0,10,0.1;0,10,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;885;-3252.743,-3587.437;Float;False;Property;_ScreenContribution;Screen Contribution;68;0;Create;True;0;0;0;False;0;False;0.3;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1930;706.2635,1060.928;Inherit;False;Property;_StereoFix;Stereo Converge (flatten);89;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;384;671.9878,-620.4361;Inherit;False;Property;_Amount;Rim Opacity;80;0;Create;False;0;0;0;False;0;False;0;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2360;-2825.617,-3339.046;Inherit;False;Property;_MotionIntensity;Motion Intensity;74;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2002;-107.7466,-2063.491;Inherit;False;Property;_UseSpecularMatCap;Use Specular MatCap;51;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(. Specular Overlay);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3035;984.8725,944.7683;Inherit;False;Matcap (legacy);-1;;164;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3042;989.006,1165.405;Inherit;False;VR MatCap;-1;;165;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2181;740.2571,662.7563;Inherit;True;Property;_Matcap;Matcap (Alpha Supported);88;0;Create;False;0;0;0;False;0;False;None;5ffad72f50c3f2c43b291ed9ecaee2e8;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;3072;653.6027,-2322.338;Inherit;False;Property;_SpecularMode;Specular Mode;49;1;[Enum];Create;True;0;2;Additive;0;Multiplied;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2857;-1557.08,-4549.486;Inherit;False;VR_Center_Eye;-1;;166;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
Node;AmplifyShaderEditor.SamplerNode;695;-164.3803,-1401.789;Inherit;True;Property;_SpecularMask;Specular Mask;59;0;Create;True;0;0;0;False;1;Space(10);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2166;1588.002,691.9649;Inherit;False;Property;_Legacy;Legacy;95;0;Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3101;379.073,-1805.448;Inherit;False;Property;_SpecMatCapMode;SpecMatCap Mode;57;1;[Enum];Create;True;0;2;Additive;0;Multiplied;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1281;1378.964,-959.7588;Inherit;False;Property;_RimMode;Rim Mode;79;1;[Enum];Create;True;0;3;Blend_Lerp;0;Multiply;1;AddSubtract;2;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2999;-1959.521,-4233.813;Inherit;True;TextureSuperSample;-1;;167;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.ColorNode;2919;1953.488,940.7828;Inherit;False;Property;_MatCapColor;MatCap Colour;94;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,0.6650944,0.6650944,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;2998;-1937.085,-3779.219;Inherit;True;TextureSuperSample;-1;;168;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.RangedFloatNode;2954;-1679.011,-4076.228;Inherit;False;Property;_SparkleSuperSample;SuperSample (expensive);64;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1514;1678.067,-888.0831;Inherit;False;Property;_UseRim;Use Rim;77;0;Create;True;0;0;0;False;3;Toggle(_);;Header(.  Rim Fresnel  .);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1709;-1412.909,-4056.881;Inherit;False;Property;_SparkleTexColour;SparkleTex Saturation;65;0;Create;False;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1518;2162.062,1036.868;Float;False;Property;_MatcapSaturation;Matcap Saturation;92;0;Create;True;0;0;0;False;0;False;1;0.5;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;349;1997,116.3659;Inherit;True;Property;_FriendsOnlyRT;> FriendsOnly RenderTexture;98;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;1710;-1141.289,-4054.098;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;894;-970.2949,-3850.563;Float;False;Property;_Range;Range;67;0;Create;True;0;0;0;False;0;False;0.3;0;0.05;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3109;2211.171,1212.401;Inherit;True;Property;_MatCapMask;MatCap Mask;96;0;Create;True;0;0;0;False;1;Space(10);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;328;1232.592,-1529.267;Inherit;True;Property;_Emission;Emission Map;29;0;Create;False;0;0;0;False;2;Space(5);Header(.  Emission  .);False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;824;290.6329,-1484.535;Inherit;False;Property;_SpecMaskOpacity;SpecMatCap Opacity;60;0;Create;False;0;0;0;False;0;False;1;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;408;2044.582,811.6145;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;91;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;897;-971.0718,-3928.603;Float;False;Property;_Threshold;Threshold;66;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DesaturateOpNode;3112;2520.117,1219.811;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;1743;-563.8309,-4342.658;Inherit;True;Property;_SparkleMask1;Sparkle Mask;75;0;Create;False;0;0;0;False;1;Space(5);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;1517;2463.464,1038.806;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;3113;2698.813,1213.234;Inherit;False;True;False;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;2308;-510.6193,-3526.619;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;461;1530.298,-1337.511;Inherit;False;Property;_ShadedEmission;Shaded Emission;32;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;1425;2093.326,-11.88314;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;327;1647.938,-1245.289;Float;False;Property;_EmissionColor;Emission Colour;30;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;875;-431.5964,-3874.255;Float;False;Property;_SparkleColor1;Color;62;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;406;2541.806,1140.316;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;90;0;Create;True;0;0;0;False;0;False;5;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;326;1875.891,-1157.456;Float;False;Property;_EmissionIntensity;Emission Intensity;31;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;807;2858.414,1039.919;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2003;147.5947,-3946.621;Inherit;False;Property;_UseSparkleShimmer;Use Sparkle/Shimmer;61;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(.  Sparkles  .);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1999;2452.493,-56.85925;Inherit;False;Property;_FriendsOnly1;Invert Friends Only;99;0;Create;False;0;0;0;False;3;Toggle(_);;;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1998;2690.467,-102.566;Inherit;False;Property;_FriendsOnly;Friends Only ON/OFF;97;0;Create;False;0;0;0;False;3;Toggle(_);Space(20);Header(VRC Friends Only);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1021;2188.035,-1013.522;Inherit;False;Property;_UseMatcap;Use Matcap;87;0;Create;True;0;0;0;False;3;Toggle(_);Space(10);Header(.  MatCap  .);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1433;2895.654,-337.9704;Inherit;False;Property;_Cutoff;Alpha Cutoff;10;0;Create;False;0;0;0;True;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;1342;3202.625,-1136.015;Inherit;False;Property;_StencilFail;StencilFail;107;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1432;3151.765,-825.441;Inherit;False;Property;_DstBlend;Destination Blend (Zero);110;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1344;2882.237,-914.3182;Float;False;Property;_ZTestMode;ZTestMode (LEqual);101;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1343;3201.625,-1061.015;Inherit;False;Property;_StencilZFail;StencilZFail;108;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1338;2876.299,-1194.834;Half;False;Property;_ReadMask;ReadMask (non-zero);104;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;1341;3206.338,-1208.357;Inherit;False;Property;_StencilOp;StencilOp;106;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;1340;3181.625,-1281.015;Inherit;False;Property;_StencilComparison;Stencil Comparison;105;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1431;2886.58,-820.4198;Inherit;False;Property;_SrcBlend;Source Blend (One);109;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(Debug);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1345;2886.308,-1002.382;Float;False;Property;_ZWriteMode;ZWrite (write to depth buffer);100;1;[ToggleUI];Create;False;0;0;0;True;2;Space(10);Header(.  Advanced  .);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1337;2882.479,-1280.823;Half;False;Property;_StencilRef;Stencil ID;102;0;Create;False;0;0;0;True;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1339;2875.299,-1112.257;Half;False;Property;_WriteMask;WriteMask (non-zero);103;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1924;3771.631,-578.6443;Float;False;True;-1;2;ASEMaterialInspector;100;1;.GenesisAria/Arias Toon Shader WIP;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;1;1;True;1431;0;True;1432;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;True;1469;False;True;0;True;1335;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;True;255;True;1337;255;True;1338;255;True;1339;7;True;1340;1;True;1341;1;True;1342;1;True;1343;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;True;1345;True;3;True;1344;True;False;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;2;Include;;False;;Native;Include;AutoLight.cginc;False;;Custom;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=6354C41786CC7586E86F0C413CB402C75BF4EE2A
