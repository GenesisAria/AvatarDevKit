...
Shader ".GenesisAria/Arias Toon Shader WIP"
{
	Properties
	{
		...
		_ShadowSaturation("Shadow Saturation", Range( -1 , 5)) = 0.85
		...
		_SparklePattern("Sparkle Pattern", 2D) = "white" {}
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				float3 desaturateInitialColor453 = ( float4( (tex2DNode10).rgb , 0.0 ) * float4( (_Color).rgb , 0.0 ) * LightColour968 ).xyz;
				...
				float3 worldToViewDir27_g48 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFix == 1.0 ? localCenterEye46_g48 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g48 ) , worldToViewDir13_g48 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g49 = CenterEye16_g49();
				float3 normalizeResult19_g49 = normalize( ( ( _StereoFix == 1.0 ? localCenterEye16_g49 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g49 = normalize( cross( normalizeResult19_g49 , _worldUp ) );
				float3 temp_output_29_0_g49 = BlendNormals( ase_worldNormal , NormalShadePrecalc1861 );
				float dotResult10_g49 = dot( normalizeResult8_g49 , temp_output_29_0_g49 );
				float dotResult2_g49 = dot( _worldUp , normalizeResult19_g49 );
				float3 normalizeResult7_g49 = normalize( ( _worldUp - ( dotResult2_g49 * normalizeResult19_g49 ) ) );
				float dotResult9_g49 = dot( normalizeResult7_g49 , temp_output_29_0_g49 );
				float2 appendResult11_g49 = (float2(dotResult10_g49 , dotResult9_g49));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g49 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				float4 temp_output_2165_0 = ( _Legacy == 1.0 ? tex2D( _Matcap, rotator2210 ) : tex2D( _Matcap, rotator2207 ) );
				float3 desaturateInitialColor1516 = ( (temp_output_2165_0).rgb * _MatcapIntensity );
				...
				float3 localCenterEye46_g46 = CenterEye46_g46();
				float3 worldToViewDir27_g46 = normalize( mul( UNITY_MATRIX_V, float4( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye46_g46 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 tanNormal1_g46 = NormalShadePrecalc1861;
				float3 worldNormal1_g46 = float3(dot(tanToWorld0,tanNormal1_g46), dot(tanToWorld1,tanNormal1_g46), dot(tanToWorld2,tanNormal1_g46));
				float3 worldToViewDir13_g46 = normalize( mul( UNITY_MATRIX_V, float4( worldNormal1_g46, 0 ) ).xyz );
				float3 localCenterEye16_g33 = CenterEye16_g33();
				float3 normalizeResult19_g33 = normalize( ( ( _StereoFixSpecCap == 1.0 ? localCenterEye16_g33 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g33 = normalize( cross( normalizeResult19_g33 , _worldUp ) );
				float3 NormalSpecularPrecalc1856 = ( lerpResult602 - float3( 0.25,0.25,0 ) );
				float3 temp_output_29_0_g33 = BlendNormals( ase_worldNormal , NormalSpecularPrecalc1856 );
				float dotResult10_g33 = dot( normalizeResult8_g33 , temp_output_29_0_g33 );
				float dotResult2_g33 = dot( _worldUp , normalizeResult19_g33 );
				float3 normalizeResult7_g33 = normalize( ( _worldUp - ( dotResult2_g33 * normalizeResult19_g33 ) ) );
				float dotResult9_g33 = dot( normalizeResult7_g33 , temp_output_29_0_g33 );
				float2 appendResult11_g33 = (float2(dotResult10_g33 , dotResult9_g33));
				float3 desaturateInitialColor1920 = (( _Legacy2 == 1.0 ? tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g46 ) , worldToViewDir13_g46 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) ) : tex2D( _SpecularMatcap, ( ( appendResult11_g33 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) )).rgb;
				...
				float3 localCenterEye16_g51 = CenterEye16_g51();
				float3 normalizeResult19_g51 = normalize( ( ( 0.0 == 1.0 ? localCenterEye16_g51 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g51 = normalize( cross( normalizeResult19_g51 , _worldUp ) );
				float3 temp_output_29_0_g51 = BlendNormals( ase_worldNormal , UnpackNormal( tex2D( _SpecMatCapNorm, i.ase_texcoord1.xy ) ) );
				float dotResult10_g51 = dot( normalizeResult8_g51 , temp_output_29_0_g51 );
				float dotResult2_g51 = dot( _worldUp , normalizeResult19_g51 );
				float3 normalizeResult7_g51 = normalize( ( _worldUp - ( dotResult2_g51 * normalizeResult19_g51 ) ) );
				float dotResult9_g51 = dot( normalizeResult7_g51 , temp_output_29_0_g51 );
				float2 appendResult11_g51 = (float2(dotResult10_g51 , dotResult9_g51));
				float3 lerpResult560 = lerp( float3( 0,0,0 ) , ( saturate( appendResult2234 ) + ( _UseSpecularMatCap == 1.0 ? ( desaturateVar1920 * _SpecMatcapMultiply * (_SpecMatCapColor).rgb ) : float3(0,0,0) ) ) , ( tex2D( _SpecularMask, ( ( appendResult11_g51 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) ) * _SpecMaskOpacity ).rgb);
				...
				float3 localCenterEye72_g47 = CenterEye72_g47();
				float4 appendResult76_g47 = (float4(( WorldPosition - localCenterEye72_g47 ) , 0.0));
				float4 temp_output_77_0_g47 = mul( UNITY_MATRIX_V, appendResult76_g47 );
				float2 break83_g47 = ( (temp_output_77_0_g47).xy / (temp_output_77_0_g47).z );
				float2 appendResult86_g47 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g47.x ) , ( break83_g47.y * 2.0 )));
				float2 appendResult101_g47 = (float2(1.0 , 1.0));
				float2 appendResult102_g47 = (float2(0.0 , 0.0));
				...
				float3 desaturateInitialColor1705 = tex2D( _SparklePattern, ( ( uv_SparklePattern + ( ( ( ( ( -appendResult86_g47 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g47 ) + appendResult102_g47 ) * _ScreenContribution ) ) + float2( 0.25,0.25 ) + ( _MotionIntensity * ( _MotionType == 1.0 ? appendResult2356 : rotator2403 ) ) + appendResult2864 ) ).rgb;
				...
				float3 localCenterEye1_g50 = CenterEye1_g50();
				float3 smoothstepResult901 = smoothstep( temp_cast_31 , temp_cast_32 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g50 ) / 10000.0 ) , 0.5 ) ) ));
				...
				clip( 1.0 - _Cutoff);
				float4 appendResult1923 = (float4(( ( _UseMatcap == 1.0 ? PostMatcap1274 : PostRimLight1292 ) + Emission1285 + float4( ( lerpResult2280 * float3( 10,10,10 ) ) , 0.0 ) + SparkleOut971 ).rgb , ( ( _Alpha * Alpha1262 ) * ( _FriendsOnly == 1.0 ? ( _FriendsOnly1 == 1.0 ? ( 1.0 - temp_output_353_0 ) : temp_output_353_0 ) : 1.0 ) )));
...
/*ASEBEGIN
Version=18713
-1655;60;1552;820;3153.462;4794.862;1.743108;True;False
...
Node;AmplifyShaderEditor.SamplerNode;425;-4436.017,-1594.568;Inherit;True;Property;_Normal;Normal;28;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normals  .);False;425;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;-0.5;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;428;-4429.819,-1386.866;Inherit;False;Property;_NormalPower;Normal Power;29;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-3232.884,-1265.439;Float;False;Property;_StaticLightZ;Static Light Z;23;0;Create;True;0;0;0;False;0;False;0.44;0.44;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;251;-3234.6,-1337.48;Float;False;Property;_StaticLightY;Static Light Y;22;0;Create;True;0;0;0;False;0;False;0.09;0.55;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2152;-3658.939,-1053.726;Inherit;False;Property;_LightMode;Lighting Mode;12;1;[Enum];Create;False;0;2;Surface;0;World2Object;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;249;-3234.506,-1411.764;Float;False;Property;_StaticLightX;Static Light X;21;0;Create;True;0;0;0;False;1;Header(  Fake Light);False;0.68;0.68;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1058;-3891.822,-3.546481;Inherit;False;Property;_UseShading;Use Shading;11;0;Create;True;0;0;0;False;3;Space(5);Header(.  Shadow  .);Toggle(_);False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1775;-1671.31,-25.86761;Inherit;False;Property;_BakedLightContrib;Baked Light Contrib;8;0;Create;True;0;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1107;-3803.967,209.8628;Inherit;False;Property;_OffsetDot;Offset Dot;16;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2211;-3633.483,565.0453;Inherit;True;Property;_LightMask;Light Mask;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;17;0;Create;False;0;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;793;-1491.692,292.0861;Inherit;False;1728.081;844.5872;;30;1499;642;1280;954;660;1036;669;680;670;665;679;1035;811;654;1064;664;646;684;682;1304;662;1492;1123;641;1504;1505;1506;1507;1605;645;Soft Shading;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;641;-1446.222,890.4534;Inherit;False;Property;_ShadeScale;Shade Scale;35;0;Create;True;0;0;0;False;0;False;0;185;2;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1915;-1250.612,-122.6674;Inherit;False;Property;_MaxLight;Max Light;9;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;642;-1451.954,1051.083;Inherit;False;Property;_ShadePower;Shade Power;34;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1916;-1246.578,-191.3982;Inherit;False;Property;_MinLight;Min Light;10;0;Create;True;0;0;0;False;0;False;0.9;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1008;-2922.989,362.3288;Inherit;False;Property;_ShadowColour;Shadow Colour;14;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-1072.83,-97.41284;Inherit;False;Property;_LightMultiplier;Light Multiplier;7;0;Create;True;0;0;0;False;0;False;1.1;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;646;-1382.249,641.8676;Inherit;False;Property;_ShadeColour;Shade Colour;33;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;684;-1100.039,342.8162;Float;False;Property;_MultiplyDynamic;MultiplyDynamic;36;0;Create;True;0;0;0;False;0;False;0.75;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;32;-2745.322,702.6544;Inherit;True;Property;_Ramp;Ramp;15;0;Create;False;0;0;0;False;0;False;-1;None;c320938fa0c7f9043aabb704290909a3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1035;-536.6813,582.2916;Inherit;False;Property;_ShadeColorDynamic;ShadeColor Dynamic;32;1;[Enum];Create;True;0;2;FixedColour;0;LightColour;1;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1025;-2343.091,595.0555;Inherit;False;Property;_GradientorRamp;Gradient or Ramp;13;1;[Enum];Create;True;0;2;Ramp_Texture;0;Linear_Gradient;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2384.912,242.3639;Inherit;False;Property;_ShadowDarkness;Shadow Darkness;18;0;Create;True;0;0;0;False;0;False;0.22;0.125;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1280;-20.40296,413.9091;Inherit;False;Property;_ShadeEnable;Shade Enable;31;0;Create;True;0;0;0;False;2;Space(5);Header(.  Soft Shading  .);False;1;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.WireNode;1545;219.6763,266.5821;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;603;-4420.568,-1697.133;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;30;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2225;-1262.735,-2426.66;Inherit;False;Property;_StereoFixSpec;Stereo Converge (flatten);40;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-760.0398,-536.3671;Inherit;True;Property;_MainTex;Texture;1;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;-1;None;de0b5c8ef1017ca499319af4fed7e820;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;1347;116.7777,-164.5602;Inherit;False;855.2606;338.8594;saturation;9;582;581;584;585;1330;586;325;453;454;;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;1330;148.5296,1.303558;Inherit;False;979;RampShade;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;546;-925.894,-2173.576;Inherit;False;Property;_SpecularSize;Specular Size;38;0;Create;True;0;0;0;False;0;False;1;6.2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;128.3207,-95.31659;Float;False;Property;_Saturation;Saturation;3;0;Create;True;0;0;0;False;0;False;1;3;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;134.0217,85.35168;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;19;0;Create;True;0;0;0;False;0;False;0.85;0.65;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;454;404.1184,-80.5526;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;582;416.7135,9.843842;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-18.96252,-881.5684;Inherit;False;Property;_Scale1;Rim Normal Power;74;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;586;419.6381,92.46089;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-448.4506,-2191.079;Inherit;False;Property;_SpecularStrength;Specular Strength;39;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DesaturateOpNode;453;614.8015,-94.00189;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1533;0.8238602,-802.0875;Inherit;False;Property;_RimNormal;Rim Normal;73;1;[Toggle];Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;584;627.274,7.968109;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;369;220.3718,-627.3718;Inherit;False;Property;_Scale;Rim Scale;70;0;Create;False;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2361;-3179.528,-3141.44;Inherit;False;Property;_MotionSpeed;Motion Speed;60;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;368;234.6099,-535.8052;Inherit;False;Property;_Power;Rim Power;69;0;Create;False;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1928;-1598.962,-1763.91;Inherit;False;Property;_StereoFixSpecCap;Stereo Converge (flatten);43;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DesaturateOpNode;581;807.4855,-56.12535;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2862;-3018.605,-3490.507;Float;False;Property;_WorldPosContribution;WorldPos Contribution;58;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1577.246,-2047.864;Inherit;True;Property;_SpecularMatcap;Specular Matcap;42;0;Create;False;0;0;0;False;0;False;None;317bf5a5f25deba448de3306b3bc06fc;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;2404;-3254.697,-3313.688;Inherit;False;Property;_RotateLinear;Rotate Linear;61;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2884;-1326.962,-1701.728;Inherit;False;VR MatCap;-1;;33;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;27;FLOAT;0;False;21;FLOAT3;0,0,0.5;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TFHCRemapNode;1918;1005.378,-52.68285;Inherit;False;5;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,1,1;False;3;FLOAT3;1E-06,1E-06,1E-06;False;4;FLOAT3;1,1,1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;2300;483.0557,-541.4279;Inherit;False;Property;_Max;Rim Max;72;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2299;456.0557,-622.4279;Inherit;False;Property;_Min;Rim Min;71;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;2348;-3002.967,-3136.882;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2897;-1326.962,-1845.728;Inherit;False;Matcap (legacy);-1;;46;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0.5;False;45;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;437;350.9002,393.3461;Inherit;False;2516.223;776.2;Comment;27;963;1274;405;1278;414;807;406;1516;2180;1279;1517;407;1518;810;408;2165;2166;2176;2175;2181;1930;2207;2208;2209;2210;2873;2896;Matcap > Alpha Supported;0.8221117,0.184,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2209;573.5739,1079.491;Inherit;False;Property;_MatcapSpin;MatcapSpin;81;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1930;387.6413,907.5331;Inherit;False;Property;_StereoFix;Stereo Converge (flatten);77;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2900;-1024.563,-1920.773;Inherit;True;Property;_TextureSample3;Texture Sample 0;90;0;Create;True;0;0;0;False;0;False;2181;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;1276;1199.272,-57.57435;Inherit;False;PostDesaturation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;902;-2075.433,-3383.479;Float;False;Property;_SparkleFresnel1;Fresnel Bias, Scale, Power;64;0;Create;False;0;0;0;False;0;False;0,10,0.1;0,10,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;561;38.61523,-2168.753;Inherit;False;Property;_SpecularOpacity;Specular Opacity;37;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2905;-884.0963,-2002.447;Inherit;False;Property;_Legacy2;Legacy;47;0;Create;False;0;0;0;False;1;Toggle(_);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2902;-1023.872,-1733.273;Inherit;True;Property;_TextureSample5;Texture Sample 0;90;0;Create;True;0;0;0;False;0;False;2181;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;376;613.1367,-965.7909;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;66;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2641509,0.2181381,0.2055891,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;1732;-3226.377,-4165.456;Inherit;True;Property;_SparklePattern;Sparkle Pattern;53;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1919;-669.5865,-1667.672;Inherit;False;Property;_SpecMatcapSaturation;SpecMatcap Saturation;45;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;885;-2852.307,-3734.442;Float;False;Property;_ScreenContribution;Screen Contribution;57;0;Create;True;0;0;0;False;0;False;0.3;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2400;-2525.446,-3389.006;Inherit;False;Property;_MotionType;Motion Type;59;1;[Enum];Create;True;0;2;Linear;0;Circular;1;0;False;1;Space(5);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;384;671.9878,-620.4361;Inherit;False;Property;_Amount;Rim Opacity;68;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2896;674.6592,708.8314;Inherit;False;Matcap (legacy);-1;;48;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0.5;False;45;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2861;-2814.854,-3888.65;Inherit;False;VR_ScreenSpaceUV;-1;;47;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2885;678.7927,929.4678;Inherit;False;VR MatCap;-1;;49;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;27;FLOAT;0;False;21;FLOAT3;0,0,0.5;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1874.452,-4216.076;Inherit;False;VR_Center_Eye;-1;;50;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
Node;AmplifyShaderEditor.TexturePropertyNode;2181;408.1978,426.8195;Inherit;True;Property;_Matcap;Matcap (Alpha Supported);76;0;Create;False;0;0;0;False;0;False;None;317bf5a5f25deba448de3306b3bc06fc;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;2360;-2384.171,-3508.42;Inherit;False;Property;_MotionIntensity;Motion Intensity;62;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;837;-610.3494,-2088.389;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Color;46;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;825;-515.968,-1552.495;Inherit;True;Property;_SpecMatCapNorm;SpecMatCap Norm;50;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NegateNode;1746;-2522.745,-4271.146;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;691;-607.6281,-1918.792;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;44;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;571;1473.48,-201.3328;Inherit;False;1199.604;463.6661;;11;349;627;353;351;1424;1425;1426;1996;1998;1999;2000;VRChat Friends-Only;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1281;1378.964,-959.7588;Inherit;False;Property;_RimMode;Rim Mode;67;1;[Enum];Create;True;0;3;Blend_Lerp;0;Multiply;1;AddSubtract;2;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2166;1255.943,456.028;Inherit;False;Property;_Legacy;Legacy;82;0;Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2002;-26.7466,-2078.491;Inherit;False;Property;_UseSpecularMatCap;Use Specular MatCap;41;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(. Specular Overlay);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;349;1480.667,70.52328;Inherit;True;Property;_FriendsOnlyRT;> FriendsOnly RenderTexture;84;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1709;-1806.364,-3936.772;Inherit;False;Property;_SparkleTexColour;SparkleTex Colour;54;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;2907;458.2247,-2153.296;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;2886;-181.2001,-1503.057;Inherit;False;VR MatCap;-1;;51;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;27;FLOAT;0;False;21;FLOAT3;0,0,0.5;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1514;1678.067,-888.0831;Inherit;False;Property;_UseRim;Use Rim;65;0;Create;True;0;0;0;False;3;Toggle(_);;Header(.  Rim Fresnel  .);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;695;143.7581,-1652.483;Inherit;True;Property;_SpecularMask;Specular Mask;48;0;Create;True;0;0;0;False;1;Space(10);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;408;1712.523,575.6776;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;79;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1424;1767.627,98.14227;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;897;-1070.903,-3898.586;Float;False;Property;_Threshold;Threshold;55;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;328;1232.592,-1529.267;Inherit;True;Property;_Emission;Emission Map;24;0;Create;False;0;0;0;False;2;Space(5);Header(.  Emission  .);False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;894;-1171.299,-3773.917;Float;False;Property;_Range;Range;56;0;Create;True;0;0;0;False;0;False;0.3;0;0.05;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;824;184.5911,-1772.766;Inherit;False;Property;_SpecMaskOpacity;SpecMask Opacity;49;0;Create;True;0;0;0;False;0;False;1;0.005;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1518;1611.703,741.1313;Float;False;Property;_MatcapSaturation;Matcap Saturation;80;0;Create;True;0;0;0;False;0;False;1;0.5;-1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1743;-489.6627,-4231.884;Inherit;True;Property;_SparkleMask1;Sparkle Mask;63;0;Create;False;0;0;0;False;1;Space(5);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;1425;1576.993,-57.72579;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;1517;1900.105,737.0696;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;407;1934.183,546.752;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;461;1530.298,-1337.511;Inherit;False;Property;_ShadedEmission;Shaded Emission;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;875;-340.6028,-3961.608;Float;False;Property;_SparkleColor1;Color;52;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CeilOpNode;351;1750.081,-152.3272;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;327;1647.938,-1245.289;Float;False;Property;_EmissionColor;Emission Color;25;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DesaturateOpNode;1516;2101.965,592.3788;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;406;2080.447,736.579;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;78;0;Create;True;0;0;0;False;0;False;5;0.333;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;2180;1671.797,653.3373;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;326;1875.891,-1157.456;Float;False;Property;_EmissionIntensity;Emission Intensity;26;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;353;1914.844,-1.693298;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;807;2359.055,659.1819;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2003;179.9406,-3947.373;Inherit;False;Property;_UseSparkles;Use Sparkles;51;0;Create;True;0;0;0;False;3;Toggle(_);Space(5);Header(.  Sparkles  .);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1999;1936.16,-102.7019;Inherit;False;Property;_FriendsOnly1;Invert Friends Only;85;0;Create;False;0;0;0;False;3;Toggle(_);;;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;627;2056.798,-22.07321;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1998;2174.134,-148.4086;Inherit;False;Property;_FriendsOnly;Friends Only ON/OFF;83;0;Create;False;0;0;0;False;3;Toggle(_);Space(20);Header(VRC Friends Only);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1426;2186.254,135.799;Inherit;False;Constant;_FriendsOnly_Null;FriendsOnly_Null;77;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1274;2647.865,480.2812;Inherit;False;PostMatcap;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;1265;1983.713,-368.0626;Inherit;False;1262;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;334;1886.929,-443.1099;Inherit;False;Property;_Alpha;Alpha;5;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;2000;2250.16,-43.7019;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;1996;2500.24,-160.7116;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2163;2152.229,-932.084;Inherit;False;1274;PostMatcap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1021;2188.035,-1013.522;Inherit;False;Property;_UseMatcap;Use Matcap;75;0;Create;True;0;0;0;False;3;Toggle(_);Space(10);Header(.  MatCap  .);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;333;2207.591,-420.7786;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;630;2411.137,-413.1909;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1433;2550.471,-337.178;Inherit;False;Property;_Cutoff;Alpha Cutoff;6;0;Create;False;0;0;0;True;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClipNode;1430;2746.508,-391.4006;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1337;2882.479,-1280.823;Half;False;Property;_StencilRef;Stencil ID;88;0;Create;False;0;0;0;True;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1344;2882.237,-914.3182;Float;False;Property;_ZTestMode;ZTestMode (LEqual);87;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;1923;2961.437,-568.0699;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.IntNode;1340;3181.625,-1281.015;Inherit;False;Property;_StencilComparison;Stencil Comparison;91;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;2901;-1088.408,-1536.403;Inherit;True;Property;_TextureSample4;Texture Sample 0;91;0;Create;True;0;0;0;False;0;False;2181;None;None;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.IntNode;1342;3202.625,-1136.015;Inherit;False;Property;_StencilFail;StencilFail;93;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1345;2885.308,-1002.382;Float;False;Property;_ZWriteMode;ZWrite (write to depth buffer);86;1;[Toggle];Create;False;0;0;0;True;2;Space(10);Header(.  Advanced  .);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1339;2875.299,-1112.257;Half;False;Property;_WriteMask;WriteMask;89;0;Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1341;3206.338,-1208.357;Inherit;False;Property;_StencilOp;StencilOp;92;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1432;3151.765,-825.441;Inherit;False;Property;_DstBlend;Destination Blend (Zero);96;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1343;3201.625,-1061.015;Inherit;False;Property;_StencilZFail;StencilZFail;94;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1431;2886.58,-820.4198;Inherit;False;Property;_SrcBlend;Source Blend (One);95;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(Debug);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1469;2892.559,-694.9409;Inherit;False;Property;_AlphaToCoverage;AlphaToCoverage (override alpha);4;1;[Toggle];Create;False;0;0;0;True;1;Space (5);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1338;2876.299,-1194.834;Half;False;Property;_ReadMask;ReadMask;90;0;Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1924;3388.418,-518.4365;Float;False;True;-1;2;ASEMaterialInspector;100;1;.GenesisAria/Arias Toon Shader WIP;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;1;1;True;1431;0;True;1432;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;True;1469;True;0;True;1335;True;True;True;True;True;0;False;-1;False;False;False;True;True;255;True;1337;255;True;1338;255;True;1339;7;True;1340;1;True;1341;1;True;1342;1;True;1343;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;True;1345;True;3;True;1344;True;False;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;2;Include;;False;;Native;Include;AutoLight.cginc;False;;Custom;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;True;;False;0
...
WireConnection;630;0;333;0
WireConnection;630;1;1996;0
...
ASEEND*/
//CHKSM=C32214860C7752B42B735208A87D3FAD39F3D766