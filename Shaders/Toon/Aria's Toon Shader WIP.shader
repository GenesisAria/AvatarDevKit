	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				float4 clampResult1914 = clamp( ( ( float4( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) , 0.0 ) + VertLight1406 + float4( ( localunity_SHArgb3_g147 * float3( 1.3,1.3,1.3 ) ) , 0.0 ) ) * _LightMultiplier ) , temp_cast_4 , temp_cast_5 );
				...
				float4 AllLight3270 = clampResult1914;
				...
				float3 lerpResult3285 = lerp( ( ( _ShadeColorDynamic == 1.0 ? (float3( 0.5,0.5,0.5 ) + ((AllLight3270).xyz - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0.5,0.5,0.5 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) : (float3( 0.5,0.5,0.5 ) + ((_ShadeColour).rgb - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0.5,0.5,0.5 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) ) * float3( 0.1,0.1,0.1 ) ) , float3( 1,1,1 ) , lerpResult669);
				float3 LightShaded2289 = ( clampResult30 * ( _ShadeEnable == 1.0 ? lerpResult3285 : float3(1,1,1) ) );
				...
				float3 temp_cast_17 = (_Threshold).xxx;
				float3 temp_cast_18 = (saturate( ( _Threshold + _Range ) )).xxx;
				...
				float3 smoothstepResult901 = smoothstep( temp_cast_17 , temp_cast_18 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g200 ) / 10000.0 ) , 0.5 ) ) ));
				...
				float4 SparkleOut971 = ( _UseSparkleShimmer == 1.0 ? ( ( tex2DNode1743.r * tex2DNode1743.a ) * ( _SparkleColor1 * ( 2.5 * ( 200.0 * temp_output_2804_0 ) ) ) * float4( smoothstepResult901 , 0.0 ) * switchResult2437 ) : temp_cast_24 );
...
/*ASEBEGIN
Version=18814
-1623;49;1486;818;1034.102;-803.2681;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;642;-1304.77,1562.352;Inherit;False;Property;_SoftPower;Soft Power;45;0;Create;True;0;0;0;False;0;False;0.75;1;0.5;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;3270;-1000.043,71.62032;Inherit;False;AllLight;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;3271;-1465.254,895.5356;Inherit;False;3270;AllLight;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;3273;-1288.745,895.5067;Inherit;False;True;True;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1500;318.6703,649.8381;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2289;446.3221,648.5714;Inherit;False;LightShaded;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=B969165D70B9F0C70D69AEC432DE929502D79DA5
