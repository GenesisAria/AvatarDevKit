	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				sampler2D texvalue34_g336 = _MainTex;
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 temp_output_4_0_g336 = uv_MainTex;
				half2 uvin34_g336 = temp_output_4_0_g336;
				half2 dx34_g336 = ( ddx( temp_output_4_0_g336 ) * float2( 0.25,0.25 ) );
				half2 dy34_g336 = ( ddy( temp_output_4_0_g336 ) * float2( 0.25,0.25 ) );
				half bias34_g336 = 0.0;
				half4 localsupersample2x234_g336 = supersample2x2( texvalue34_g336 , uvin34_g336 , dx34_g336 , dy34_g336 , bias34_g336 );
				float4 ifLocalVar3476 = 0;
				UNITY_BRANCH 
				if( _TexSuperSample == 1.0 )
				ifLocalVar3476 = localsupersample2x234_g336;
				...
				float3 break5_g337 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( max( max( break5_g337.x , break5_g337.y ) , max( break5_g337.y , break5_g337.z ) ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 localCenterEye1_g356 = CenterEye1_g356();
				float3 ifLocalVar50_g355 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar50_g355 = localCenterEye1_g356;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar50_g355 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g355 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g355 - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g355 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g355 ) , worldToViewDir13_g355 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				...
				float3 temp_output_4_0_g338 = ( localCenterEye1_g338 - WorldPosition );
				float3 normalizeResult5_g338 = normalize( temp_output_4_0_g338 );
				float3 ifLocalVar3493 = 0;
				UNITY_BRANCH 
				if( _StereoFixSpec == 1.0 )
				ifLocalVar3493 = normalizeResult5_g338;
				...
				float3 ifLocalVar50_g347 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar50_g347 = localCenterEye1_g348;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar50_g347 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g347 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g347 - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g347 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye1_g350 = CenterEye1_g350();
				float3 ifLocalVar32_g349 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar32_g349 = localCenterEye1_g350;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar32_g349 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g349 = normalize( ( ifLocalVar32_g349 - WorldPosition ) );
				float3 normalizeResult8_g349 = normalize( cross( normalizeResult19_g349 , _worldUp ) );
				float3 temp_output_21_0_g349 = NormalSpecular965;
				float dotResult10_g349 = dot( normalizeResult8_g349 , temp_output_21_0_g349 );
				float dotResult2_g349 = dot( _worldUp , normalizeResult19_g349 );
				float3 normalizeResult7_g349 = normalize( ( _worldUp - ( dotResult2_g349 * normalizeResult19_g349 ) ) );
				float dotResult9_g349 = dot( normalizeResult7_g349 , temp_output_21_0_g349 );
				float2 appendResult11_g349 = (float2(dotResult10_g349 , dotResult9_g349));
				float4 ifLocalVar3491 = 0;
				UNITY_BRANCH 
				if( _Legacy2 == 1.0 )
				ifLocalVar3491 = tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g347 ) , worldToViewDir13_g347 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) );
				else if( _Legacy2 < 1.0 )
				ifLocalVar3491 = tex2D( _SpecularMatcap, ( ( appendResult11_g349 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) );
				...
				float3 localCenterEye1_g340 = CenterEye1_g340();
				float clampResult2503 = clamp( distance( WorldPosition , ( (float)0 == 0.0 ? localCenterEye1_g340 : _WorldSpaceCameraPos ) ) , 0.0 , 100.0 );
				...
				sampler2D texvalue34_g359 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g359 = uv_SparklePatternRGB;
				half2 uvin34_g359 = temp_output_4_0_g359;
				half2 dx34_g359 = ( ddx( temp_output_4_0_g359 ) * float2( 0.25,0.25 ) );
				half2 dy34_g359 = ( ddy( temp_output_4_0_g359 ) * float2( 0.25,0.25 ) );
				half bias34_g359 = 0.0;
				half4 localsupersample2x234_g359 = supersample2x2( texvalue34_g359 , uvin34_g359 , dx34_g359 , dy34_g359 , bias34_g359 );
				float4 ifLocalVar3485 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3485 = localsupersample2x234_g359;
				...
				sampler2D texvalue34_g358 = _SparklePatternRGB;
				...
				float4 appendResult76_g351 = (float4(( WorldPosition - localCenterEye1_g352 ) , 0.0));
				float4 temp_output_77_0_g351 = mul( UNITY_MATRIX_V, appendResult76_g351 );
				float2 break83_g351 = ( (temp_output_77_0_g351).xy / (temp_output_77_0_g351).z );
				float2 appendResult86_g351 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g351.x ) , ( break83_g351.y * 2.0 )));
				float2 appendResult101_g351 = (float2(1.0 , 1.0));
				float2 appendResult102_g351 = (float2(0.0 , 0.0));
				...
				ifLocalVar3487 = ( ( ( ( -appendResult86_g351 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g351 ) + appendResult102_g351 );
				...
				float2 temp_output_4_0_g358 = temp_output_2355_0;
				half2 uvin34_g358 = temp_output_4_0_g358;
				half2 dx34_g358 = ( ddx( temp_output_4_0_g358 ) * float2( 0.25,0.25 ) );
				half2 dy34_g358 = ( ddy( temp_output_4_0_g358 ) * float2( 0.25,0.25 ) );
				half bias34_g358 = 0.0;
				half4 localsupersample2x234_g358 = supersample2x2( texvalue34_g358 , uvin34_g358 , dx34_g358 , dy34_g358 , bias34_g358 );
				float4 ifLocalVar3486 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3486 = localsupersample2x234_g358;
				else if( _SparkleSuperSample < 1.0 )
				...
				float3 localCenterEye1_g357 = CenterEye1_g357();
				float3 smoothstepResult901 = smoothstep( temp_cast_20 , temp_cast_21 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g357 ) / 10000.0 ) , 0.5 ) ) ));
				...
				int localisCamera1_g360 = isCamera1_g360();
				int Cam17_g360 = localisCamera1_g360;
				int temp_output_5_0_g360 = (int)_IsInMirror;
				int temp_output_6_0_g360 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g360 == 1.0 ? ( (float)temp_output_5_0_g360 == 1.0 ? ( Cam17_g360 + temp_output_5_0_g360 ) : ( Cam17_g360 * temp_output_5_0_g360 ) ) : ( (float)temp_output_6_0_g360 == 0.0 ? ( Cam17_g360 * temp_output_6_0_g360 ) : ( Cam17_g360 + temp_output_6_0_g360 ) ) );
				else
				ifLocalVar3478 = 1.0;
...
/*ASEBEGIN
Version=18814
-1635;27;1486;818;695.8017;2122.781;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;603;-5955.564,-1993.389;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;39;0;Create;True;0;0;0;False;0;False;0.5;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-6000.658,-1762.531;Inherit;True;Property;_Normal;Normal (N);35;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;2a39e34498f7c0a43944fde596b628b7;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-2120.431,-501.9006;Inherit;True;Property;_MainTex;Texture (RGB,A);4;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;30fb70667016c654f8ab310f3d11af64;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;3325;-1481.564,36.7731;Inherit;False;Float3 Max;-1;;335;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2997;-1829.031,-519.3008;Inherit;False;TextureSuperSample;-1;;336;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3326;-717.7537,324.6924;Inherit;False;Float3 Max;-1;;337;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-591.8463,-218.3334;Float;False;Property;_Saturation;Saturation;8;0;Create;True;0;0;0;False;0;False;1;1.1;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3512;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;338;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;3514;-2143.525,-3346.59;Inherit;False;View Distance;-1;;339;2a6ef75a50a2bd147a81c448d8de0d4d;1,8,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3521;-1564.883,-2116.931;Inherit;False;Matcap (legacy);-1;;347;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3520;-1572.417,-1950.33;Inherit;False;VR MatCap;-1;;349;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1823.167,-2299.266;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);55;0;Create;False;0;0;0;False;0;False;None;c9be8c2d6e0848241a2de70ed9535df4;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;561;-927.7875,-2504.637;Inherit;False;Property;_SpecularOpacity;Specular Opacity;48;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3516;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;351;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.CommentaryNode;437;373.4562,891.688;Inherit;False;2518.223;840.2;Comment;32;3264;3266;3109;1274;405;414;807;1278;2180;1279;406;1516;1517;407;408;2920;1518;810;2919;2176;2175;2166;2210;2181;2207;2208;2209;963;1930;2873;3268;3528;Matcap > Alpha Supported;0.8221117,0.184,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;837;-856.2704,-2359.592;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;59;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0.2713154,0.6353639,0.8584906,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;376;583.8023,-1006.408;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;85;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560744,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3524;675.3692,1207.173;Inherit;False;Matcap (legacy);-1;;355;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;691;-853.549,-2189.995;Inherit;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;57;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3179;-241.2421,-1748.165;Inherit;False;Property;_ProbeSmoothness;Probe Smoothness;66;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3513;-1771.232,-4986.866;Inherit;False;VR_Center_Eye;-1;;357;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;2999;-2173.673,-4671.193;Inherit;True;TextureSuperSample;-1;;359;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
Node;AmplifyShaderEditor.FunctionNode;2998;-2151.237,-4216.599;Inherit;True;TextureSuperSample;-1;;358;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.ColorNode;2919;1643.985,1203.188;Inherit;False;Property;_MatCapColor;MatCap Colour;101;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;3101;79.22963,-2123.226;Inherit;False;Property;_SpecMatCapMode;SpecMatCap Mode;60;1;[Enum];Create;True;0;2;Additive;0;Multiplied;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;3528;1491.789,996.2252;Inherit;False;True;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1518;1852.559,1299.273;Float;False;Property;_MatcapSaturation;Matcap Saturation;99;0;Create;True;0;0;0;False;0;False;1;0;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;408;1735.079,1074.02;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;98;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;695;41.20361,-1324.644;Inherit;True;Property;_SpecularMask;Specular MatCap Mask (R,A);63;0;Create;False;0;0;0;False;0;False;-1;None;40d47c5206022e74f982906f74cbe548;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;824;116.3333,-1394.451;Inherit;False;Property;_SpecMaskOpacity;SpecMatcap Level;62;0;Create;False;0;0;0;False;1;Space(10);False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2213.303,1399.721;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;97;0;Create;True;0;0;0;False;0;False;5;0.333;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3429;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;360;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.RangedFloatNode;1021;2188.035,-1013.522;Inherit;False;Property;_UseMatcap;Use Matcap;94;1;[ToggleUI];Create;True;0;0;0;False;2;Space(10);Header(.  MatCap  .);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3526;-264.6091,-3048.01;Inherit;False;Blinn-Phong Half Vector VR;-1;;362;a14416ee163e75d4f83c3889a3f25b2f;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3522;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;364;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=EB87C0955C095B1C0A948026D49FF9EBA378B532
