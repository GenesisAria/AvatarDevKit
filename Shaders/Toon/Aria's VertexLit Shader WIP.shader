	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				sampler2D texvalue34_g306 = _MainTexFriends;
				float2 uv_MainTexFriends = i.ase_texcoord1.xy * _MainTexFriends_ST.xy + _MainTexFriends_ST.zw;
				float2 temp_output_4_0_g306 = uv_MainTexFriends;
				half2 uvin34_g306 = temp_output_4_0_g306;
				half2 dx34_g306 = ( ddx( temp_output_4_0_g306 ) * float2( 0.25,0.25 ) );
				half2 dy34_g306 = ( ddy( temp_output_4_0_g306 ) * float2( 0.25,0.25 ) );
				half bias34_g306 = 0.0;
				half4 localsupersample2x234_g306 = supersample2x2( texvalue34_g306 , uvin34_g306 , dx34_g306 , dy34_g306 , bias34_g306 );
				float4 ifLocalVar3475 = 0;
				UNITY_BRANCH 
				if( _FriendsSuperSample == 1.0 )
				ifLocalVar3475 = localsupersample2x234_g306;
				else if( _FriendsSuperSample < 1.0 )
				ifLocalVar3475 = tex2D( _MainTexFriends, uv_MainTexFriends );
				sampler2D texvalue34_g307 = _MainTex;
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 temp_output_4_0_g307 = uv_MainTex;
				half2 uvin34_g307 = temp_output_4_0_g307;
				half2 dx34_g307 = ( ddx( temp_output_4_0_g307 ) * float2( 0.25,0.25 ) );
				half2 dy34_g307 = ( ddy( temp_output_4_0_g307 ) * float2( 0.25,0.25 ) );
				half bias34_g307 = 0.0;
				half4 localsupersample2x234_g307 = supersample2x2( texvalue34_g307 , uvin34_g307 , dx34_g307 , dy34_g307 , bias34_g307 );
				float4 ifLocalVar3476 = 0;
				UNITY_BRANCH 
				if( _TexSuperSample == 1.0 )
				ifLocalVar3476 = localsupersample2x234_g307;
				...
				sampler2D texvalue34_g285 = _Normal;
				float2 uv_Normal = i.ase_texcoord1.xy * _Normal_ST.xy + _Normal_ST.zw;
				float2 temp_output_4_0_g285 = uv_Normal;
				half2 uvin34_g285 = temp_output_4_0_g285;
				half2 dx34_g285 = ( ddx( temp_output_4_0_g285 ) * float2( 0.25,0.25 ) );
				half2 dy34_g285 = ( ddy( temp_output_4_0_g285 ) * float2( 0.25,0.25 ) );
				half bias34_g285 = 0.0;
				half4 localsupersample2x234_g285 = supersample2x2( texvalue34_g285 , uvin34_g285 , dx34_g285 , dy34_g285 , bias34_g285 );
				float3 localCenterEye6_g284 = CenterEye6_g284();
				float ifLocalVar3495 = 0;
				UNITY_BRANCH 
				if( _NorDist == 1.0 )
				ifLocalVar3495 = ( distance( WorldPosition , ( (float)0 == 0.0 ? localCenterEye6_g284 : _WorldSpaceCameraPos ) ) * 2.0 * _NorDist );
				...
				float3 localUnpackNormal47_g285 = UnpackScaleNormal( localsupersample2x234_g285, clampResult3012 );
				...
				ifLocalVar3494 = localUnpackNormal47_g285;
				...
				float3 localCenterEye1_g286 = CenterEye1_g286();
				float3 temp_output_4_0_g286 = ( localCenterEye1_g286 - WorldPosition );
				float3 normalizeResult5_g286 = normalize( temp_output_4_0_g286 );
				float3 lerpResult2635 = lerp( appendResult248 , normalizeResult5_g286 , float3( 0.3333,0.3333,0.3333 ));
				float3 Dir_LightDir2215 = ( ( ase_lightColor.rgb * ase_lightColor.a ) > float3( 0,0,0 ) ? normalizeResult1233 : lerpResult2635 );
				float3 localSHArgbambientDir6_g287 = SHArgbambientDir();
				float dotResult5 = dot( NormalShade962 , ( Dir_LightDir2215 + localSHArgbambientDir6_g287 ) );
				...
				float3 localunity_SHArgb3_g288 = unity_SHArgb3_g288();
				float3 temp_cast_4 = (_MinLight).xxx;
				float3 clampResult3331 = clamp( ( ( ( ase_lightColor.rgb * ase_lightColor.a * ( 1.0 - _WorldSpaceLightPos0.w ) ) + (VertLight1406).xyz + ( localunity_SHArgb3_g288 * float3( 1.3,1.3,1.3 ) ) ) * _LightMultiplier ) , temp_cast_4 , float3( 1,1,1 ) );
				float3 break5_g308 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * max( max( break5_g308.x , break5_g308.y ) , max( break5_g308.y , break5_g308.z ) ) ) / clampResult3331 ) );
				float3 break5_g309 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( max( max( break5_g309.x , break5_g309.y ) , max( break5_g309.y , break5_g309.z ) ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 localCenterEye46_g316 = CenterEye46_g316();
				float3 worldToViewDir27_g316 = normalize( mul( UNITY_MATRIX_V, float4( ( ( (float)(int)_StereoFix == 1.0 ? localCenterEye46_g316 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g316 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g316 ) , worldToViewDir13_g316 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g315 = CenterEye16_g315();
				float3 normalizeResult19_g315 = normalize( ( ( (float)(int)_StereoFix == 1.0 ? localCenterEye16_g315 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g315 = normalize( cross( normalizeResult19_g315 , _worldUp ) );
				float3 temp_output_21_0_g315 = NormalMatCap3089;
				float dotResult10_g315 = dot( normalizeResult8_g315 , temp_output_21_0_g315 );
				float dotResult2_g315 = dot( _worldUp , normalizeResult19_g315 );
				float3 normalizeResult7_g315 = normalize( ( _worldUp - ( dotResult2_g315 * normalizeResult19_g315 ) ) );
				float dotResult9_g315 = dot( normalizeResult7_g315 , temp_output_21_0_g315 );
				float2 appendResult11_g315 = (float2(dotResult10_g315 , dotResult9_g315));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g315 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 clampResult331 = clamp( ( lerpResult450 * (_EmissionColor).rgb * _EmissionIntensity ) , float3( 0,0,0 ) , temp_cast_16 );
				...
				float3 localCenterEye1_g310 = CenterEye1_g310();
				float3 temp_output_4_0_g310 = ( localCenterEye1_g310 - WorldPosition );
				float3 normalizeResult5_g310 = normalize( temp_output_4_0_g310 );
				float3 ifLocalVar3493 = 0;
				UNITY_BRANCH 
				if( _StereoFixSpec == 1.0 )
				ifLocalVar3493 = normalizeResult5_g310;
				...
				UNITY_BRANCH 
				if( _SpecularMode == 1.0 )
				ifLocalVar3482 = temp_output_3064_0;
				else if( _SpecularMode < 1.0 )
				ifLocalVar3482 = ( temp_output_3064_0 * ( ( (LightColour968).xyz * MaintexRGB3074 ) + MaintexRGB3074 ) );
				float3 localCenterEye46_g313 = CenterEye46_g313();
				float3 worldToViewDir27_g313 = normalize( mul( UNITY_MATRIX_V, float4( ( ( (float)(int)_StereoFixSpecCap == 1.0 ? localCenterEye46_g313 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g313 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye16_g312 = CenterEye16_g312();
				float3 normalizeResult19_g312 = normalize( ( ( (float)(int)_StereoFixSpecCap == 1.0 ? localCenterEye16_g312 : _WorldSpaceCameraPos ) - WorldPosition ) );
				float3 normalizeResult8_g312 = normalize( cross( normalizeResult19_g312 , _worldUp ) );
				float3 temp_output_21_0_g312 = NormalSpecular965;
				float dotResult10_g312 = dot( normalizeResult8_g312 , temp_output_21_0_g312 );
				float dotResult2_g312 = dot( _worldUp , normalizeResult19_g312 );
				float3 normalizeResult7_g312 = normalize( ( _worldUp - ( dotResult2_g312 * normalizeResult19_g312 ) ) );
				float dotResult9_g312 = dot( normalizeResult7_g312 , temp_output_21_0_g312 );
				float2 appendResult11_g312 = (float2(dotResult10_g312 , dotResult9_g312));
				float4 ifLocalVar3491 = 0;
				UNITY_BRANCH 
				if( _Legacy2 == 1.0 )
				ifLocalVar3491 = tex2D( _SpecularMatcap, (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g313 ) , worldToViewDir13_g313 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) );
				else if( _Legacy2 < 1.0 )
				ifLocalVar3491 = tex2D( _SpecularMatcap, ( ( appendResult11_g312 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) );
				...
				float3 localCenterEye6_g311 = CenterEye6_g311();
				float clampResult2503 = clamp( distance( WorldPosition , ( (float)0 == 0.0 ? localCenterEye6_g311 : _WorldSpaceCameraPos ) ) , 0.0 , 100.0 );
				float temp_output_2804_0 = ( 1.0 - (0.0 + (clampResult2503 - 0.0) * (0.01 - 0.0) / (1.0 - 0.0)) );
				float3 temp_cast_24 = (_Threshold).xxx;
				float3 temp_cast_25 = (saturate( ( _Threshold + _Range ) )).xxx;
				sampler2D texvalue34_g319 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g319 = uv_SparklePatternRGB;
				half2 uvin34_g319 = temp_output_4_0_g319;
				half2 dx34_g319 = ( ddx( temp_output_4_0_g319 ) * float2( 0.25,0.25 ) );
				half2 dy34_g319 = ( ddy( temp_output_4_0_g319 ) * float2( 0.25,0.25 ) );
				half bias34_g319 = 0.0;
				half4 localsupersample2x234_g319 = supersample2x2( texvalue34_g319 , uvin34_g319 , dx34_g319 , dy34_g319 , bias34_g319 );
				float4 ifLocalVar3485 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3485 = localsupersample2x234_g319;
				...
				sampler2D texvalue34_g318 = _SparklePatternRGB;
				float2 break2472 = uv_SparklePatternRGB;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g314 = CenterEye72_g314();
				float4 appendResult76_g314 = (float4(( WorldPosition - localCenterEye72_g314 ) , 0.0));
				float4 temp_output_77_0_g314 = mul( UNITY_MATRIX_V, appendResult76_g314 );
				float2 break83_g314 = ( (temp_output_77_0_g314).xy / (temp_output_77_0_g314).z );
				float2 appendResult86_g314 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g314.x ) , ( break83_g314.y * 2.0 )));
				float2 appendResult101_g314 = (float2(1.0 , 1.0));
				float2 appendResult102_g314 = (float2(0.0 , 0.0));
				...
				ifLocalVar3487 = ( ( ( ( -appendResult86_g314 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g314 ) + appendResult102_g314 );
				...
				float2 temp_output_4_0_g318 = temp_output_2355_0;
				half2 uvin34_g318 = temp_output_4_0_g318;
				half2 dx34_g318 = ( ddx( temp_output_4_0_g318 ) * float2( 0.25,0.25 ) );
				half2 dy34_g318 = ( ddy( temp_output_4_0_g318 ) * float2( 0.25,0.25 ) );
				half bias34_g318 = 0.0;
				half4 localsupersample2x234_g318 = supersample2x2( texvalue34_g318 , uvin34_g318 , dx34_g318 , dy34_g318 , bias34_g318 );
				float4 ifLocalVar3486 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3486 = localsupersample2x234_g318;
				else if( _SparkleSuperSample < 1.0 )
				...
				float3 localCenterEye1_g317 = CenterEye1_g317();
				float3 smoothstepResult901 = smoothstep( temp_cast_24 , temp_cast_25 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g317 ) / 10000.0 ) , 0.5 ) ) ));
				...
				int localisCamera1_g320 = isCamera1_g320();
				int Cam17_g320 = localisCamera1_g320;
				int temp_output_5_0_g320 = (int)_IsInMirror;
				int temp_output_6_0_g320 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g320 == 1.0 ? ( (float)temp_output_5_0_g320 == 1.0 ? ( Cam17_g320 + temp_output_5_0_g320 ) : ( Cam17_g320 * temp_output_5_0_g320 ) ) : ( (float)temp_output_6_0_g320 == 0.0 ? ( Cam17_g320 * temp_output_6_0_g320 ) : ( Cam17_g320 + temp_output_6_0_g320 ) ) );
				else
				ifLocalVar3478 = 1.0;
...
/*ASEBEGIN
Version=18814
-1635;27;1486;818;2575.305;3126.434;3.329831;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3464;-5078.783,-2525.445;Inherit;False;Property;_NorDist;Normal Distance Modifier;37;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3450;-5096.384,-2452.69;Inherit;False;View Distance;-1;;284;2a6ef75a50a2bd147a81c448d8de0d4d;1,8,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;3495;-4646.642,-2503.326;Inherit;False;True;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;281;-3675.826,-1809.984;Inherit;False;1722.566;633.3398;Uses directional light or uses the static light direction;21;1076;1296;5;2215;3414;1165;2635;1876;1233;2852;248;633;1247;249;252;1246;251;2148;1232;2147;3415;Light Setup;1,0.546,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;428;-5915.11,-1336.748;Inherit;False;Property;_NormalPower;Normal Power;38;0;Create;True;0;0;0;False;0;False;0;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;3460;-5900.023,-2061.458;Inherit;False;3459;NormalDist;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;603;-5955.564,-1993.389;Inherit;False;Property;_NormalPowerSpecular;Normal Power Specular;39;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-6000.658,-1762.531;Inherit;True;Property;_Normal;Normal (N);35;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;2962;-5652.581,-1701.25;Inherit;False;Property;_NormSuperSample;SuperSample (expensive);36;0;Create;False;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3049;-5681.562,-1854.177;Inherit;False;NormalTextureSuperSample;-1;;285;c5e7d95f0a9b898419b29857c25ecde5;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;49;FLOAT;1;False;4;FLOAT3;0;FLOAT;39;FLOAT;40;FLOAT;41
...
Node;AmplifyShaderEditor.FunctionNode;2852;-3332.646,-1277.474;Inherit;False;VR_Center_Eye;-1;;286;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;3415;-2647.893,-1378.048;Inherit;False;GetBakedLight;-1;;287;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.SamplerNode;349;2182.999,609.2747;Inherit;True;Property;_FriendsOnlyRT;> FriendsOnly RenderTexture;106;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3416;-2530.258,120.6594;Inherit;False;GetBakedLight;-1;;288;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-2079.482,101.5965;Inherit;False;Property;_LightMultiplier;Light Multiplier;12;0;Create;True;0;0;0;False;1;Header(. Lighting .);False;1.1;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1916;-1884.798,159.276;Inherit;False;Property;_MinLight;Min Light;14;0;Create;True;0;0;0;False;0;False;0.05;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;3343;-2441.472,-973.886;Inherit;True;Property;_MainTexFriends;FriendsOnly Texture (RGB,A);109;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-2120.431,-501.9006;Inherit;True;Property;_MainTex;Texture (RGB,A);4;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;5a2fb03d6237cc4409584bbc705f8e60;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;3340;-1657.368,-1092.978;Inherit;False;Property;_FriendsOnlyTexture;Friends Only Texture;108;0;Create;True;0;0;0;False;1;Toggle(_);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3325;-1481.564,36.7731;Inherit;False;Float3 Max;-1;;308;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1008;-2925.583,515.3505;Inherit;False;Property;_ShadowColour;Shadow Colour;20;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;0.8584906,0.8584906,0.8584906,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2997;-1829.031,-519.3008;Inherit;False;TextureSuperSample;-1;;307;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
Node;AmplifyShaderEditor.FunctionNode;3467;-2097.337,-776.1661;Inherit;False;TextureSuperSample;-1;;306;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3326;-717.7537,324.6924;Inherit;False;Float3 Max;-1;;309;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode