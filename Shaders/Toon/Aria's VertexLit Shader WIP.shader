	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				sampler2D texvalue34_g335 = _MainTex;
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 temp_output_4_0_g335 = uv_MainTex;
				half2 uvin34_g335 = temp_output_4_0_g335;
				half2 dx34_g335 = ( ddx( temp_output_4_0_g335 ) * float2( 0.25,0.25 ) );
				half2 dy34_g335 = ( ddy( temp_output_4_0_g335 ) * float2( 0.25,0.25 ) );
				half bias34_g335 = 0.0;
				half4 localsupersample2x234_g335 = supersample2x2( texvalue34_g335 , uvin34_g335 , dx34_g335 , dy34_g335 , bias34_g335 );
				float4 ifLocalVar3476 = 0;
				UNITY_BRANCH 
				if( _TexSuperSample == 1.0 )
				ifLocalVar3476 = localsupersample2x234_g335;
				...
				float3 break5_g336 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( max( max( break5_g336.x , break5_g336.y ) , max( break5_g336.y , break5_g336.z ) ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 localCenterEye1_g337 = CenterEye1_g337();
				float3 temp_output_4_0_g337 = ( localCenterEye1_g337 - WorldPosition );
				float3 normalizeResult5_g337 = normalize( temp_output_4_0_g337 );
				float3 ifLocalVar3493 = 0;
				UNITY_BRANCH 
				if( _StereoFixSpec == 1.0 )
				ifLocalVar3493 = normalizeResult5_g337;
				...
				float3 localCenterEye1_g339 = CenterEye1_g339();
				float clampResult2503 = clamp( distance( WorldPosition , ( (float)0 == 0.0 ? localCenterEye1_g339 : _WorldSpaceCameraPos ) ) , 0.0 , 100.0 );
				...
				float4 appendResult76_g349 = (float4(( WorldPosition - localCenterEye1_g350 ) , 0.0));
				float4 temp_output_77_0_g349 = mul( UNITY_MATRIX_V, appendResult76_g349 );
				float2 break83_g349 = ( (temp_output_77_0_g349).xy / (temp_output_77_0_g349).z );
				float2 appendResult86_g349 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g349.x ) , ( break83_g349.y * 2.0 )));
				float2 appendResult101_g349 = (float2(1.0 , 1.0));
				float2 appendResult102_g349 = (float2(0.0 , 0.0));
				...
				ifLocalVar3487 = ( ( ( ( -appendResult86_g349 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g349 ) + appendResult102_g349 );
				...
				int localisCamera1_g359 = isCamera1_g359();
				int Cam17_g359 = localisCamera1_g359;
				int temp_output_5_0_g359 = (int)_IsInMirror;
				int temp_output_6_0_g359 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g359 == 1.0 ? ( (float)temp_output_5_0_g359 == 1.0 ? ( Cam17_g359 + temp_output_5_0_g359 ) : ( Cam17_g359 * temp_output_5_0_g359 ) ) : ( (float)temp_output_6_0_g359 == 0.0 ? ( Cam17_g359 * temp_output_6_0_g359 ) : ( Cam17_g359 + temp_output_6_0_g359 ) ) );
				else
				ifLocalVar3478 = 1.0;
...
/*ASEBEGIN
Version=18814
-1635;27;1486;818;-1241.201;1241.081;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-3554.867,472.5686;Float;False;Property;_ShadowSharpness1;Shadow Sharpness;23;0;Create;False;0;0;0;False;0;False;1;35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-2120.431,-501.9006;Inherit;True;Property;_MainTex;Texture (RGB,A);4;0;Create;False;0;0;0;False;1;Header(.  Main  .);False;None;771812b086030014596ad238665b6e55;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;1008;-2925.583,515.3505;Inherit;False;Property;_ShadowColour;Shadow Colour;20;0;Create;True;0;0;0;False;0;False;0.7098039,0.7098039,0.7098039,1;0.666,0.666,0.666,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2997;-1829.031,-519.3008;Inherit;False;TextureSuperSample;-1;;335;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3326;-717.7537,324.6924;Inherit;False;Float3 Max;-1;;336;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;585;-570.1216,18.60373;Inherit;False;Property;_ShadowSaturation;Shadow Saturation;25;0;Create;True;0;0;0;False;0;False;0.85;0.85;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3512;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;337;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-591.8463,-218.3334;Float;False;Property;_Saturation;Saturation;8;0;Create;True;0;0;0;False;0;False;1;1.5;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3514;-2143.525,-3346.59;Inherit;False;View Distance;-1;;338;2a6ef75a50a2bd147a81c448d8de0d4d;1,8,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-1823.167,-2299.266;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);55;0;Create;False;0;0;0;False;0;False;None;69c3dd7166c80a44ca6e1b888ba76a34;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;3516;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;349;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;376;583.8023,-1006.408;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;85;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560747,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;837;-856.2704,-2359.592;Inherit;False;Property;_SpecMatCapColor;SpecMatCap Colour;59;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0.5849056,0.3361428,0.3062477,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2002;-353.6673,-2335.694;Inherit;False;Property;_UseSpecularMatCap;Use Specular MatCap;54;1;[ToggleUI];Create;True;0;0;0;False;2;Space(5);Header(. Specular Overlay);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2181;433.2477,952.5939;Inherit;True;Property;_Matcap;Matcap (RGB,A);95;0;Create;False;0;0;0;False;0;False;None;f5303b4da8057574c84c7322a19702b7;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;408;1735.079,1074.02;Inherit;False;Property;_MatcapIntensity;Matcap Intensity;98;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;824;116.3333,-1394.451;Inherit;False;Property;_SpecMaskOpacity;SpecMatcap Level;62;0;Create;False;0;0;0;False;1;Space(10);False;1;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2213.303,1399.721;Inherit;False;Property;_MatcapOpacity;Matcap Opacity;97;0;Create;True;0;0;0;False;0;False;5;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3429;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;359;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.FunctionNode;3522;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;360;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=6B105205BFCEE24A063E6B40EAF2402C467C29A3
