	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i , half ase_vface : VFACE) : SV_Target
			{
				...
				sampler2D texvalue34_g290 = _MainTex;
				float2 uv_MainTex = i.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 temp_output_4_0_g290 = uv_MainTex;
				half2 uvin34_g290 = temp_output_4_0_g290;
				half2 dx34_g290 = ( ddx( temp_output_4_0_g290 ) * float2( 0.25,0.25 ) );
				half2 dy34_g290 = ( ddy( temp_output_4_0_g290 ) * float2( 0.25,0.25 ) );
				half bias34_g290 = 0.0;
				half4 localsupersample2x234_g290 = supersample2x2( texvalue34_g290 , uvin34_g290 , dx34_g290 , dy34_g290 , bias34_g290 );
				float4 ifLocalVar3476 = 0;
				UNITY_BRANCH 
				if( _TexSuperSample == 1.0 )
				ifLocalVar3476 = localsupersample2x234_g290;
				...
				float3 break5_g291 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * max( max( break5_g291.x , break5_g291.y ) , max( break5_g291.y , break5_g291.z ) ) ) / clampResult3331 ) );
				float3 break5_g292 = clampResult1914;
				float clampResult3256 = clamp( (0.0 + (saturate( max( max( break5_g292.x , break5_g292.y ) , max( break5_g292.y , break5_g292.z ) ) ) - 0.0) * (( 1.0 - _LightSatLimiter ) - 0.0) / (1.0 - 0.0)) , ( 1.0 - _LightSatTotal ) , 1.0 );
				...
				float3 localCenterEye46_g300 = CenterEye46_g300();
				float3 worldToViewDir27_g300 = normalize( mul( UNITY_MATRIX_V, float4( ( ( (float)(int)_StereoFix == 1.0 ? localCenterEye46_g300 : _WorldSpaceCameraPos ) - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g300 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g300 ) , worldToViewDir13_g300 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye16_g299 = CenterEye16_g299();
				float3 normalizeResult19_g299 = normalize( ( ( (float)(int)_StereoFix == 1.0 ? localCenterEye16_g299 : _WorldSpaceCameraPos ) - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g299 = normalize( cross( normalizeResult19_g299 , _worldUp ) );
				float3 temp_output_21_0_g299 = NormalMatCap3089;
				float dotResult10_g299 = dot( normalizeResult8_g299 , temp_output_21_0_g299 );
				float dotResult2_g299 = dot( _worldUp , normalizeResult19_g299 );
				float3 normalizeResult7_g299 = normalize( ( _worldUp - ( dotResult2_g299 * normalizeResult19_g299 ) ) );
				float dotResult9_g299 = dot( normalizeResult7_g299 , temp_output_21_0_g299 );
				float2 appendResult11_g299 = (float2(dotResult10_g299 , dotResult9_g299));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g299 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 SpecularOut983 = float3( 0,0,0 );
				...
				float3 localCenterEye6_g294 = CenterEye6_g294();
				float clampResult2503 = clamp( distance( WorldPosition , ( (float)0 == 0.0 ? localCenterEye6_g294 : _WorldSpaceCameraPos ) ) , 0.0 , 100.0 );
				...
				sampler2D texvalue34_g303 = _SparklePatternRGB;
				float2 uv_SparklePatternRGB = i.ase_texcoord1.xy * _SparklePatternRGB_ST.xy + _SparklePatternRGB_ST.zw;
				float2 temp_output_4_0_g303 = uv_SparklePatternRGB;
				half2 uvin34_g303 = temp_output_4_0_g303;
				half2 dx34_g303 = ( ddx( temp_output_4_0_g303 ) * float2( 0.25,0.25 ) );
				half2 dy34_g303 = ( ddy( temp_output_4_0_g303 ) * float2( 0.25,0.25 ) );
				half bias34_g303 = 0.0;
				half4 localsupersample2x234_g303 = supersample2x2( texvalue34_g303 , uvin34_g303 , dx34_g303 , dy34_g303 , bias34_g303 );
				float4 ifLocalVar3485 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3485 = localsupersample2x234_g303;
				...
				sampler2D texvalue34_g302 = _SparklePatternRGB;
				float2 break2472 = uv_SparklePatternRGB;
				float2 appendResult2473 = (float2(-break2472.x , break2472.y));
				float3 localCenterEye72_g297 = CenterEye72_g297();
				float4 appendResult76_g297 = (float4(( WorldPosition - localCenterEye72_g297 ) , 0.0));
				float4 temp_output_77_0_g297 = mul( UNITY_MATRIX_V, appendResult76_g297 );
				float2 break83_g297 = ( (temp_output_77_0_g297).xy / (temp_output_77_0_g297).z );
				float2 appendResult86_g297 = (float2(( ( _ScreenParams.z / _ScreenParams.w ) * break83_g297.x ) , ( break83_g297.y * 2.0 )));
				float2 appendResult101_g297 = (float2(1.0 , 1.0));
				float2 appendResult102_g297 = (float2(0.0 , 0.0));
				...
				ifLocalVar3487 = ( ( ( ( -appendResult86_g297 * float2( 1,0.5 ) ) + float2( 0.5,0.5 ) ) * appendResult101_g297 ) + appendResult102_g297 );
				...
				float2 temp_output_4_0_g302 = temp_output_2355_0;
				half2 uvin34_g302 = temp_output_4_0_g302;
				half2 dx34_g302 = ( ddx( temp_output_4_0_g302 ) * float2( 0.25,0.25 ) );
				half2 dy34_g302 = ( ddy( temp_output_4_0_g302 ) * float2( 0.25,0.25 ) );
				half bias34_g302 = 0.0;
				half4 localsupersample2x234_g302 = supersample2x2( texvalue34_g302 , uvin34_g302 , dx34_g302 , dy34_g302 , bias34_g302 );
				float4 ifLocalVar3486 = 0;
				UNITY_BRANCH 
				if( _SparkleSuperSample == 1.0 )
				ifLocalVar3486 = localsupersample2x234_g302;
				else if( _SparkleSuperSample < 1.0 )
				...
				float3 localCenterEye1_g301 = CenterEye1_g301();
				float3 smoothstepResult901 = smoothstep( temp_cast_20 , temp_cast_21 , ( desaturateVar1704 * desaturateVar1705 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g301 ) / 10000.0 ) , 0.5 ) ) ));
				...
				int localisCamera1_g304 = isCamera1_g304();
				int Cam17_g304 = localisCamera1_g304;
				int temp_output_5_0_g304 = (int)_IsInMirror;
				int temp_output_6_0_g304 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g304 == 1.0 ? ( (float)temp_output_5_0_g304 == 1.0 ? ( Cam17_g304 + temp_output_5_0_g304 ) : ( Cam17_g304 * temp_output_5_0_g304 ) ) : ( (float)temp_output_6_0_g304 == 0.0 ? ( Cam17_g304 * temp_output_6_0_g304 ) : ( Cam17_g304 + temp_output_6_0_g304 ) ) );
				else
				ifLocalVar3478 = 1.0;
				...
				ifLocalVar3474 = 1.0;
				float4 temp_cast_34 = (( ifLocalVar3478 * ifLocalVar3474 )).xxxx;
				float4 temp_cast_35 = (_AlphaCutoff).xxxx;
				clip( temp_cast_34 - temp_cast_35);
...
/*ASEBEGIN
Version=18814
-1635;27;1486;818;845.0312;2363.345;1.48003;True;False
...
Node;AmplifyShaderEditor.FunctionNode;3325;-1481.564,36.7731;Inherit;False;Float3 Max;-1;;291;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2997;-1829.031,-519.3008;Inherit;False;TextureSuperSample;-1;;290;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3326;-717.7537,324.6924;Inherit;False;Float3 Max;-1;;292;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3448;-2143.525,-3346.59;Inherit;False;View Distance;-1;;294;2a6ef75a50a2bd147a81c448d8de0d4d;1,8,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2942;-3645.763,-4266.91;Inherit;False;VR_ScreenSpaceUV;-1;;297;83887303006e6e7459722034b3b9f189;0;4;97;FLOAT;1;False;98;FLOAT;1;False;99;FLOAT;0;False;100;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;376;583.8023,-1006.408;Inherit;False;Property;_RimOutlineColour;Rim/Outline Colour;85;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560734,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3445;679.5027,1427.81;Inherit;False;VR MatCap;-1;;299;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3446;675.3692,1207.173;Inherit;False;Matcap (legacy);-1;;300;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2857;-1771.232,-4986.866;Inherit;False;VR_Center_Eye;-1;;301;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;2999;-2173.673,-4671.193;Inherit;True;TextureSuperSample;-1;;303;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;2998;-2151.237,-4216.599;Inherit;True;TextureSuperSample;-1;;302;23a6a6e8fbe28134cac41513630794b1;0;3;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;3429;2559.604,-95.27997;Inherit;False;VRCMirrorToggle;-1;;304;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.ClipNode;1430;3137.46,-463.9726;Inherit;False;3;0;FLOAT;1;False;1;FLOAT4;1,0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3447;-1767.401,-1224.196;Inherit;False;Matcap (legacy);-1;;305;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;3481;2668.9,-2873.86;Inherit;False;True;5;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;3443;-1564.883,-2116.931;Inherit;False;Matcap (legacy);-1;;296;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3444;-1572.417,-1950.33;Inherit;False;VR MatCap;-1;;295;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2853;-1783.858,-2540.273;Inherit;False;VR_Center_Eye;-1;;293;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;0;2;FLOAT3;0;FLOAT3;2
...
ASEEND*/
//CHKSM=F859D258E03B13F6B13286806063A386BA8353E1;Rim/Outline;1,0.141,0.141,1;0;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;1909;-1795.544,-2684.233;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
