...
Shader ".GenesisAria/Arias VertexLit Shader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 SuperSample2x2SS50_g6892( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			half4 SuperSample2x2SS51_g6872( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			float3 HueShifter1_g6896( float3 aColor, float aHue )
			{
				    float angle = radians(aHue);
				    float3 k = float3(0.57735, 0.57735, 0.57735);
				    float cosAngle = cos(angle);
			...
			half4 StereoScreenUV1_g7041( half4 screenuv )
			{
			...
			fixed4 frag (v2f i , out uint cov : SV_Coverage) : SV_Target
			{
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue50_g6892) = _MainTexFriends;
				float2 temp_output_4_0_g6892 = uv_FriendsOnlyRT;
				half2 uvin50_g6892 = temp_output_4_0_g6892;
				half2 dx50_g6892 = ( ddx( temp_output_4_0_g6892 ) * float2( 0.25,0.25 ) );
				half2 dy50_g6892 = ( ddy( temp_output_4_0_g6892 ) * float2( 0.25,0.25 ) );
				half bias50_g6892 = _FriendTexSSBias;
				SamplerState samplerState50_g6892 = sampler_MainTexFriends;
				half4 localSuperSample2x2SS50_g6892 = SuperSample2x2SS50_g6892( texvalue50_g6892 , uvin50_g6892 , dx50_g6892 , dy50_g6892 , bias50_g6892 , samplerState50_g6892 );
				#ifdef FRIENDSS_ON
				float4 staticSwitch4922 = localSuperSample2x2SS50_g6892;
				#else
				...
				float3 aColor1_g6898 = pow( saferPower4850 , temp_cast_4 );
				float aHue1_g6898 = _Hue;
				float3 localHueShifter1_g6898 = HueShifter1_g6898( aColor1_g6898 , aHue1_g6898 );
				float3 desaturateInitialColor2917 = localHueShifter1_g6898;
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue51_g6872) = _DetailNormalN;
				float2 temp_output_4_0_g6872 = staticSwitch5256;
				half2 uvin51_g6872 = temp_output_4_0_g6872;
				half2 dx51_g6872 = ( ddx( temp_output_4_0_g6872 ) * float2( 0.25,0.25 ) );
				half2 dy51_g6872 = ( ddy( temp_output_4_0_g6872 ) * float2( 0.25,0.25 ) );
				half bias51_g6872 = ( _NormSSBias * saturate( NormalDist3459 ) );
				SamplerState samplerState51_g6872 = sampler_DetailNormalN;
				half4 localSuperSample2x2SS51_g6872 = SuperSample2x2SS51_g6872( texvalue51_g6872 , uvin51_g6872 , dx51_g6872 , dy51_g6872 , bias51_g6872 , samplerState51_g6872 );
				float3 localUnpackNormal47_g6872 = UnpackScaleNormal( localSuperSample2x2SS51_g6872, temp_output_5259_0 );
				#ifdef NORMSS_ON
				float3 staticSwitch4930 = localUnpackNormal47_g6872;
				#else
				...
				float3 localCenterEye1_g6874 = CenterEye1_g6874();
				float3 temp_output_4_0_g6874 = ( localCenterEye1_g6874 - WorldPosition );
				float3 normalizeResult5_g6874 = normalize( temp_output_4_0_g6874 );
				float3 lerpResult2635 = lerp( appendResult248 , normalizeResult5_g6874 , float3( 0.3333,0.3333,0.3333 ));
				half3 Dir_LightDir2215 = ( ( grayscale5451 * ase_lightColor.a ) > 0.0 ? normalizeResult1233 : lerpResult2635 );
				half3 localSHArgbambientDir6_g6875 = SHArgbambientDir();
				float3 temp_output_3817_0 = ( Dir_LightDir2215 + localSHArgbambientDir6_g6875 );
				...
				float4 transform5_g6877 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float3 localCenterEye1_g6878 = CenterEye1_g6878();
				float temp_output_4_0_g6877 = distance( transform5_g6877 , float4( ( (float)0 == 0.0 ? localCenterEye1_g6878 : _WorldSpaceCameraPos ) , 0.0 ) );
				float temp_output_3839_0 = temp_output_4_0_g6877;
				...
				float3 saferPower5565 = abs( ( FinalDot4125 + float3( 0,0,0 ) + -( ase_worldViewDir * float3( 0.005,0.005,0.005 ) ) ) );
				float temp_output_5652_0 = ( ( 2.0 - _FWDSSInvPow ) * 0.6 );
				float3 temp_cast_9 = (temp_output_5652_0).xxx;
				float3 saferPower5566 = abs( ( ( 1.0 - FinalDot4125 ) + float3( -1,-1,-1 ) + -( ase_worldViewDir * float3( 0.005,0.005,0.005 ) ) ) );
				...
				float3 localunity_SHArgb3_g6876 = unity_SHArgb3_g6876();
				float3 temp_output_1489_0 = ( ( ase_lightColor.rgb * float3( 1,0.9,0.95 ) * temp_output_2082_0 ) + ( (VertLight1406).xyz * float3( 0.5,0.45,0.5 ) * temp_output_2082_0 ) + ( localunity_SHArgb3_g6876 * float3( 1.25,1.2,1.25 ) ) );
				...
				float3 break5_g6879 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * 2.0 * max( max( break5_g6879.x , break5_g6879.y ) , max( break5_g6879.y , break5_g6879.z ) ) ) / clampResult3331 ) );
				float3 break5_g6884 = clampResult1914;
				float3 break5_g6885 = clampResult1914;
				float clampResult3551 = clamp( ( ( max( max( break5_g6884.x , break5_g6884.y ) , max( break5_g6884.y , break5_g6884.z ) ) - min( min( break5_g6885.x , break5_g6885.y ) , min( break5_g6885.y , break5_g6885.z ) ) ) * ( 1.0 - _LightSaturationLimiter ) ) , ( 1.0 - _LightSatFinal ) , 1.0 );
				...
				float4 transform5_g6925 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float3 localCenterEye1_g6926 = CenterEye1_g6926();
				float temp_output_4_0_g6925 = distance( transform5_g6925 , float4( ( (float)0 == 0.0 ? localCenterEye1_g6926 : _WorldSpaceCameraPos ) , 0.0 ) );
				float dotResult17_g6924 = dot( ase_worldViewDir , ase_worldNormal );
				float temp_output_23_0_g6924 = ( ( 1.0 - ( temp_output_4_0_g6925 * 0.25 ) ) * 8.0 * dotResult17_g6924 );
				float temp_output_19_0_g6924 = saturate( temp_output_23_0_g6924 );
				float temp_output_3773_0 = ( ( temp_output_19_0_g6924 + 0.25 ) * _Amount );
				...
				#endif
				float3 aColor1_g6896 = (tex2DNode328).rgb;
				float aHue1_g6896 = _EmissionHue;
				float3 localHueShifter1_g6896 = HueShifter1_g6896( aColor1_g6896 , aHue1_g6896 );
				float3 temp_output_4845_0 = localHueShifter1_g6896;
				...
				float3 ifLocalVar50_g6931 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar50_g6931 = localCenterEye1_g6932;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar50_g6931 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6931 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6931 - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g6931 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6931 ) , worldToViewDir13_g6931 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye1_g6934 = CenterEye1_g6934();
				float3 ifLocalVar32_g6933 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar32_g6933 = localCenterEye1_g6934;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar32_g6933 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6933 = normalize( ( ifLocalVar32_g6933 - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g6933 = normalize( cross( normalizeResult19_g6933 , _worldUp ) );
				float3 temp_output_21_0_g6933 = NormalMatCap3089;
				float dotResult10_g6933 = dot( normalizeResult8_g6933 , temp_output_21_0_g6933 );
				float dotResult2_g6933 = dot( _worldUp , normalizeResult19_g6933 );
				float3 normalizeResult7_g6933 = normalize( ( _worldUp - ( dotResult2_g6933 * normalizeResult19_g6933 ) ) );
				float dotResult9_g6933 = dot( normalizeResult7_g6933 , temp_output_21_0_g6933 );
				float2 appendResult11_g6933 = (float2(dotResult10_g6933 , dotResult9_g6933));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g6933 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 localCenterEye1_g6923 = CenterEye1_g6923();
				float3 ifLocalVar50_g6922 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar50_g6922 = localCenterEye1_g6923;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar50_g6922 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6922 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6922 - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g6922 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye1_g6921 = CenterEye1_g6921();
				float3 ifLocalVar32_g6920 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar32_g6920 = localCenterEye1_g6921;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar32_g6920 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6920 = normalize( ( ifLocalVar32_g6920 - WorldPosition ) );
				float3 normalizeResult8_g6920 = normalize( cross( normalizeResult19_g6920 , _worldUp ) );
				float3 temp_output_21_0_g6920 = NormalSpecular965;
				float dotResult10_g6920 = dot( normalizeResult8_g6920 , temp_output_21_0_g6920 );
				float dotResult2_g6920 = dot( _worldUp , normalizeResult19_g6920 );
				float3 normalizeResult7_g6920 = normalize( ( _worldUp - ( dotResult2_g6920 * normalizeResult19_g6920 ) ) );
				float dotResult9_g6920 = dot( normalizeResult7_g6920 , temp_output_21_0_g6920 );
				float2 appendResult11_g6920 = (float2(dotResult10_g6920 , dotResult9_g6920));
				float2 ifLocalVar3491 = 0;
				UNITY_BRANCH 
				if( _Legacy2 == 1.0 )
				ifLocalVar3491 = (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6922 ) , worldToViewDir13_g6922 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 )));
				else if( _Legacy2 < 1.0 )
				ifLocalVar3491 = ( ( appendResult11_g6920 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) );
				...
				float3 temp_cast_25 = (max( ( _Threshold + lerpResult209_g7017 ) , 0.0001 )).xxx;
				...
				float3 smoothstepResult93_g7017 = smoothstep( temp_cast_23 , temp_cast_25 , ( lerpResult109_g7017 * lerpResult110_g7017 * ( 1.0 - pow( ( distance( WorldPosition , localCenterEye1_g7020 ) / 10000.0 ) , 0.5 ) ) ));
				...
				float3 clampResult193_g7017 = clamp( ( _SparkleMode == 1.0 ? ( MaintexRGB3074 * temp_output_95_0_g7017 ) : temp_output_95_0_g7017 ) , float3( 1E-05,1E-05,1E-05 ) , temp_cast_31 );
				#ifdef SPARKLE_ON
				...
				float temp_output_61_0_g7040 = ( _ParallaxHeight + 1.0 );
				float3 ase_tanViewDir =  tanToWorld0 * ase_worldViewDir.x + tanToWorld1 * ase_worldViewDir.y  + tanToWorld2 * ase_worldViewDir.z;
				ase_tanViewDir = Unity_SafeNormalize( ase_tanViewDir );
				float2 Offset29_g7040 = ( ( temp_output_61_0_g7040 - 1 ) * ase_tanViewDir.xy * _ParallaxScale ) + uv_ParallaxTexture;
				float2 Offset57_g7040 = ( ( temp_output_61_0_g7040 - 1 ) * ( ase_tanViewDir.xy / ase_tanViewDir.z ) * _ParallaxScale ) + uv_ParallaxTexture;
				float2 temp_output_59_0_g7040 = ( (float)(int)_ParallaxType == 0.0 ? Offset29_g7040 : Offset57_g7040 );
				float4 tex2DNode41_g7040 = SAMPLE_TEXTURE2D( _ParallaxTexture, sampler_ParallaxTexture, temp_output_59_0_g7040 );
				#ifdef PARALLAX_ON
				float3 staticSwitch4920 = ( pow( SAMPLE_TEXTURE2D( _ParallaxMask, sampler_ParallaxMask, uv_ParallaxMask ).r , _ParallaxMaskPower ) * (( tex2DNode41_g7040 * _ParallaxColour * tex2DNode41_g7040.a * _ParallaxColour.a )).rgb );
				#else
				float3 staticSwitch4920 = float3( 0,0,0 );
				#endif
				float localbits18_g7041 = ( 0.0 );
				...
				float temp_output_3_0_g7041 = lerpResult5314;
				half4 screenuv1_g7041 = ( screenPos / screenPos.w );
				half4 localStereoScreenUV1_g7041 = StereoScreenUV1_g7041( screenuv1_g7041 );
				float4 break8_g7041 = localStereoScreenUV1_g7041;
				int x11_g7041 = (int)fmod( break8_g7041.x , 8.0 );
				int y11_g7041 = (int)fmod( break8_g7041.y , 8.0 );
				half localDither8x8Bayer11_g7041 = Dither8x8Bayer( x11_g7041 , y11_g7041 );
				int localRenderSampleCount4_g7041 = RenderSampleCount();
				#ifdef COVERAGE_ON
				float staticSwitch65_g7041 = ( ( temp_output_3_0_g7041 + ( ( 1.0 - localDither8x8Bayer11_g7041 ) / ( localRenderSampleCount4_g7041 / _A2CSampleBias ) ) ) * localRenderSampleCount4_g7041 );
				#else
				float staticSwitch65_g7041 = 0.0;
				#endif
				float covtoggle18_g7041 = ceil( saturate( staticSwitch65_g7041 ) );
				float finalAlpha18_g7041 = staticSwitch65_g7041;
				float preFinalAlpha18_g7041 = temp_output_3_0_g7041;
				{
				// Shift and subtract to get the needed amount of positive bits
				  if (covtoggle18_g7041 == 1)
				{
				cov = (1u << (uint)(finalAlpha18_g7041)) - 1u;
				finalAlpha18_g7041 = 1;
				}
				  if (covtoggle18_g7041 == 0)
				{
				cov = 0xFF;
				finalAlpha18_g7041 = preFinalAlpha18_g7041;
				}
				}
				float smoothstepResult5551 = smoothstep( 0.0 , ( _AlphaCutoff * 3.0 ) , temp_output_333_0);
				int localisCamera1_g7039 = isCamera1_g7039();
				int Cam17_g7039 = localisCamera1_g7039;
				int temp_output_5_0_g7039 = (int)_IsInMirror;
				int temp_output_6_0_g7039 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g7039 == 1.0 ? ( (float)temp_output_5_0_g7039 == 1.0 ? ( Cam17_g7039 + temp_output_5_0_g7039 ) : ( Cam17_g7039 * temp_output_5_0_g7039 ) ) : ( (float)temp_output_6_0_g7039 == 0.0 ? ( Cam17_g7039 * temp_output_6_0_g7039 ) : ( Cam17_g7039 + temp_output_6_0_g7039 ) ) );
				else
				ifLocalVar3478 = 1.0;
				...
				float4 appendResult1923 = (float4(( staticSwitch4916 + ( ( float3( 0.05,0.05,0.05 ) + temp_output_2287_0 ) * SpecularOut983 ) + ( ( temp_output_2287_0 + float3( 0.1,0.1,0.1 ) ) * float3( 2,2,2 ) * SparkleOut971 ) + ( ( temp_output_2287_0 + float3( 0.03,0.03,0.03 ) ) * staticSwitch4920 ) ) , finalAlpha18_g7041));
...
/*ASEBEGIN
Version=18934
113;459;1436;644;4138.594;2553.46;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;5197;-8239.682,321.7379;Inherit;False;NormalTextureSuperSample;-1;;6872;c5e7d95f0a9b898419b29857c25ecde5;0;5;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;50;SAMPLERSTATE;0;False;28;FLOAT;0;False;49;FLOAT;1;False;4;FLOAT3;0;FLOAT;39;FLOAT;40;FLOAT;41
...
Node;AmplifyShaderEditor.FunctionNode;3511;-7384.249,-956.1778;Inherit;False;VR_Center_Eye;-1;;6874;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;1;19;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;4796;-6738.559,-1065.653;Inherit;False;GetBakedLight;-1;;6875;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.FunctionNode;4795;-3261.72,118.3934;Inherit;False;GetBakedLight;-1;;6876;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.FunctionNode;3839;-3929.128,-3043.294;Inherit;False;View Distance;-1;;6877;2a6ef75a50a2bd147a81c448d8de0d4d;2,8,1,17,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5171;-1674.575,27.86575;Inherit;False;Float3 Max;-1;;6879;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5172;-1138.026,258.6496;Inherit;False;Float3 Max;-1;;6884;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5651;-3677.915,-2176.074;Half;False;Property;_FWDSSInvPow;Forward InvPower;99;0;Create;False;0;0;0;False;0;False;0.8;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;5565;-3182.32,-2485.415;Inherit;False;True;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.6666;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.PowerNode;5566;-3186.02,-2347.202;Inherit;False;True;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.75;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5567;-3004.451,-2432.391;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0.25,0.25,0.25;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCGrayscale;5617;-2879.53,-2437.096;Inherit;False;2;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;5639;-3117.313,-2254.794;Inherit;False;3270;AllLight;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;5592;-2701.776,-2473.452;Inherit;False;2;0;FLOAT;0.1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCGrayscale;5643;-2955.797,-2255.455;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5615;-2719.387,-2367.228;Half;False;Property;_FWDSSMulti;Forward Multiply;98;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;5595;-2578.927,-2474.994;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;5647;-2758.423,-2257.538;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5642;-2603.192,-2257.701;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.75;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5616;-2449.44,-2471.603;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0.6666;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;5645;-2301.477,-2468.34;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5597;-2362.199,-2564.605;Half;False;Property;_FWDSS;Forward SubSurface;97;1;[ToggleUI];Create;False;0;0;0;False;1;Space(5);False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;5596;-2145.473,-2522.625;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;5586;-1976.164,-2521.17;Inherit;False;forwardSS;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5199;-2580.782,-1191.95;Inherit;False;TextureSuperSample;-1;;6892;23a6a6e8fbe28134cac41513630794b1;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;48;SAMPLERSTATE;0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;4845;2261.308,-2035.513;Inherit;False;Hue;-1;;6896;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;4846;-425.894,-371.7213;Inherit;False;Hue;-1;;6898;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3520;-7137.525,-2859.36;Inherit;False;VR MatCap;-1;;6920;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3521;-7140.988,-2954.96;Inherit;False;Matcap (legacy);-1;;6922;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;376;258.5829,-1246.025;Float;False;Property;_RimOutlineColour;Rim/Outline Colour;171;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560683,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;4743;275.8679,-738.7574;Inherit;False;Fresnel Edge Pixel Fix;-1;;6924;e37ec5be3c94a1b4e99e2c04f776c418;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3523;1191.654,1597.406;Inherit;False;VR MatCap;-1;;6933;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3524;1184.139,1381.841;Inherit;False;Matcap (legacy);-1;;6931;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;5465;-7420.122,-4494.833;Inherit;False;Aria Sparkles Include;146;;7017;fe78986b6250d1d46955dfaed2c4e629;0;2;97;FLOAT3;0,0,0;False;156;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;4396;1748.248,-291.7196;Inherit;False;Aria Parallax Include;196;;7040;972a5d25f3151a4479be2dcc9b9e75fa;2,56,0,55,0;1;60;INT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3429;2793.888,-104.2387;Inherit;False;VRCMirrorToggle;-1;;7039;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.FunctionNode;4918;3549.489,-503.7678;Inherit;False;Custom A2C;17;;7041;445f8ff28d1a9f44092743e0eb84a83d;0;3;19;FLOAT;1;False;3;FLOAT;1;False;16;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=D50E53407515AFA8EC4C73AD77999E239FE0281A
