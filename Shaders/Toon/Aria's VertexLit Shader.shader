...
Shader ".GenesisAria/Arias VertexLit Shader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 SuperSample2x2SS50_g6881( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
			...
			half4 SuperSample2x2SS50_g6880( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			float3 HueShifter1_g6885( float3 aColor, float aHue )
			{
			...
			half4 SuperSample2x2SS51_g6860( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			float4 VertexLightPosX3_g6861(  )
			{
				return unity_4LightPosX0;
			}
			
			float4 VertexLightPosY2_g6861(  )
			{
				return unity_4LightPosY0;
			}
			
			float4 VertexLightPosZ1_g6861(  )
			{
				return unity_4LightPosZ0;
			}
			
			float4 VertexLightAttenuation86_g6861(  )
			{
				return unity_4LightAtten0;
			}
			
			float4 VertexLightCol114_g6861(  )
			{
				return unity_LightColor[0];
			}
			
			float4 VertexLightCol215_g6861(  )
			{
				return unity_LightColor[1];
			}
			
			float4 VertexLightCol319_g6861(  )
			{
				return unity_LightColor[2];
			}
			
			float4 VertexLightCol421_g6861(  )
			{
			...
			float3 HueShifter1_g6884( float3 aColor, float aHue )
			{
				    float angle = radians(aHue);
				    float3 k = float3(0.57735, 0.57735, 0.57735);
				    float cosAngle = cos(angle);
			...
			half4 StereoScreenUV1_g6966( half4 screenuv )
			{
			...
			fixed4 frag (v2f i , out uint cov : SV_Coverage) : SV_Target
			{
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue50_g6881) = _MainTex;
				float2 temp_output_4_0_g6881 = uv_MainTex;
				half2 uvin50_g6881 = temp_output_4_0_g6881;
				half2 dx50_g6881 = ( ddx( temp_output_4_0_g6881 ) * float2( 0.25,0.25 ) );
				half2 dy50_g6881 = ( ddy( temp_output_4_0_g6881 ) * float2( 0.25,0.25 ) );
				half bias50_g6881 = _TexSSBias;
				SamplerState samplerState50_g6881 = sampler_MainTex;
				half4 localSuperSample2x2SS50_g6881 = SuperSample2x2SS50_g6881( texvalue50_g6881 , uvin50_g6881 , dx50_g6881 , dy50_g6881 , bias50_g6881 , samplerState50_g6881 );
				#ifdef MAINSS_ON
				float4 staticSwitch4923 = localSuperSample2x2SS50_g6881;
				#else
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue50_g6880) = _MainTexFriends;
				float2 temp_output_4_0_g6880 = uv_FriendsOnlyRT;
				half2 uvin50_g6880 = temp_output_4_0_g6880;
				half2 dx50_g6880 = ( ddx( temp_output_4_0_g6880 ) * float2( 0.25,0.25 ) );
				half2 dy50_g6880 = ( ddy( temp_output_4_0_g6880 ) * float2( 0.25,0.25 ) );
				half bias50_g6880 = _FriendTexSSBias;
				SamplerState samplerState50_g6880 = sampler_MainTexFriends;
				half4 localSuperSample2x2SS50_g6880 = SuperSample2x2SS50_g6880( texvalue50_g6880 , uvin50_g6880 , dx50_g6880 , dy50_g6880 , bias50_g6880 , samplerState50_g6880 );
				#ifdef FRIENDSS_ON
				float4 staticSwitch4922 = localSuperSample2x2SS50_g6880;
				#else
				...
				float3 aColor1_g6885 = pow( saferPower4850 , temp_cast_4 );
				float aHue1_g6885 = _Hue;
				float3 localHueShifter1_g6885 = HueShifter1_g6885( aColor1_g6885 , aHue1_g6885 );
				float3 desaturateInitialColor2917 = localHueShifter1_g6885;
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue51_g6860) = _DetailNormalN;
				float2 temp_output_4_0_g6860 = staticSwitch5256;
				half2 uvin51_g6860 = temp_output_4_0_g6860;
				half2 dx51_g6860 = ( ddx( temp_output_4_0_g6860 ) * float2( 0.25,0.25 ) );
				half2 dy51_g6860 = ( ddy( temp_output_4_0_g6860 ) * float2( 0.25,0.25 ) );
				half bias51_g6860 = ( _NormSSBias * saturate( NormalDist3459 ) );
				SamplerState samplerState51_g6860 = sampler_DetailNormalN;
				half4 localSuperSample2x2SS51_g6860 = SuperSample2x2SS51_g6860( texvalue51_g6860 , uvin51_g6860 , dx51_g6860 , dy51_g6860 , bias51_g6860 , samplerState51_g6860 );
				float3 localUnpackNormal47_g6860 = UnpackScaleNormal( localSuperSample2x2SS51_g6860, temp_output_5259_0 );
				#ifdef NORMSS_ON
				float3 staticSwitch4930 = localUnpackNormal47_g6860;
				#else
				...
				float3 localCenterEye1_g6862 = CenterEye1_g6862();
				float3 temp_output_4_0_g6862 = ( localCenterEye1_g6862 - WorldPosition );
				float3 normalizeResult5_g6862 = normalize( temp_output_4_0_g6862 );
				float3 lerpResult2635 = lerp( appendResult248 , normalizeResult5_g6862 , float3( 0.3333,0.3333,0.3333 ));
				half3 Dir_LightDir2215 = ( ( grayscale5451 * ase_lightColor.a ) > 0.0 ? normalizeResult1233 : lerpResult2635 );
				half3 localSHArgbambientDir6_g6863 = SHArgbambientDir();
				float dotResult5 = dot( NormalShade962 , ( Dir_LightDir2215 + localSHArgbambientDir6_g6863 ) );
				float NdotL1296 = dotResult5;
				float4 localVertexLightPosX3_g6861 = VertexLightPosX3_g6861();
				float4 break4_g6861 = localVertexLightPosX3_g6861;
				float4 localVertexLightPosY2_g6861 = VertexLightPosY2_g6861();
				float4 break5_g6861 = localVertexLightPosY2_g6861;
				float4 localVertexLightPosZ1_g6861 = VertexLightPosZ1_g6861();
				float4 break6_g6861 = localVertexLightPosZ1_g6861;
				float3 appendResult7_g6861 = (float3(break4_g6861.x , break5_g6861.x , break6_g6861.x));
				half3 VertLightPos12017 = appendResult7_g6861;
				...
				float3 pos188_g6861 = appendResult7_g6861;
				float3 objToWorld139_g6861 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
				float temp_output_155_0_g6861 = pow( distance( pos188_g6861 , objToWorld139_g6861 ) , 2.0 );
				float4 localVertexLightAttenuation86_g6861 = VertexLightAttenuation86_g6861();
				float4 break87_g6861 = localVertexLightAttenuation86_g6861;
				float attenx96_g6861 = break87_g6861.x;
				float temp_output_60_0_g6861 = saturate( ( 1.0 - ( ( temp_output_155_0_g6861 * attenx96_g6861 ) / 25.0 ) ) );
				float temp_output_3408_23 = min( ( 1.0 + ( ( 1.0 / temp_output_155_0_g6861 ) * attenx96_g6861 ) ) , ( temp_output_60_0_g6861 * temp_output_60_0_g6861 ) );
				float3 appendResult8_g6861 = (float3(break4_g6861.y , break5_g6861.y , break6_g6861.y));
				float3 pos290_g6861 = appendResult8_g6861;
				float3 objToWorld140_g6861 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
				float temp_output_75_0_g6861 = pow( distance( pos290_g6861 , objToWorld140_g6861 ) , 2.0 );
				float atteny97_g6861 = break87_g6861.y;
				float temp_output_107_0_g6861 = saturate( ( 1.0 - ( ( temp_output_75_0_g6861 * atteny97_g6861 ) / 25.0 ) ) );
				float temp_output_3408_29 = min( ( 1.0 + ( ( 1.0 / temp_output_75_0_g6861 ) * atteny97_g6861 ) ) , ( temp_output_107_0_g6861 * temp_output_107_0_g6861 ) );
				float3 appendResult9_g6861 = (float3(break4_g6861.z , break5_g6861.z , break6_g6861.z));
				float3 pos389_g6861 = appendResult9_g6861;
				float3 objToWorld141_g6861 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
				float temp_output_79_0_g6861 = pow( distance( pos389_g6861 , objToWorld141_g6861 ) , 2.0 );
				float attenz98_g6861 = break87_g6861.z;
				float temp_output_125_0_g6861 = saturate( ( 1.0 - ( ( temp_output_79_0_g6861 * attenz98_g6861 ) / 25.0 ) ) );
				float temp_output_3408_30 = min( ( 1.0 + ( ( 1.0 / temp_output_79_0_g6861 ) * attenz98_g6861 ) ) , ( temp_output_125_0_g6861 * temp_output_125_0_g6861 ) );
				float3 appendResult10_g6861 = (float3(break4_g6861.w , break5_g6861.w , break6_g6861.w));
				float3 pos491_g6861 = appendResult10_g6861;
				float3 objToWorld138_g6861 = mul( unity_ObjectToWorld, float4( float3( 0,0,0 ), 1 ) ).xyz;
				float temp_output_83_0_g6861 = pow( distance( pos491_g6861 , objToWorld138_g6861 ) , 2.0 );
				float attenw99_g6861 = break87_g6861.w;
				float temp_output_116_0_g6861 = saturate( ( 1.0 - ( ( temp_output_83_0_g6861 * attenw99_g6861 ) / 25.0 ) ) );
				float temp_output_3408_31 = min( ( 1.0 + ( ( 1.0 / temp_output_83_0_g6861 ) * attenw99_g6861 ) ) , ( temp_output_116_0_g6861 * temp_output_116_0_g6861 ) );
				half VertAtten2014 = ( temp_output_3408_23 + temp_output_3408_29 + temp_output_3408_30 + temp_output_3408_31 );
				float4 localVertexLightCol114_g6861 = VertexLightCol114_g6861();
				float4 temp_output_3408_16 = localVertexLightCol114_g6861;
				float4 localVertexLightCol215_g6861 = VertexLightCol215_g6861();
				float4 temp_output_3408_17 = localVertexLightCol215_g6861;
				float4 localVertexLightCol319_g6861 = VertexLightCol319_g6861();
				float4 temp_output_3408_18 = localVertexLightCol319_g6861;
				float4 localVertexLightCol421_g6861 = VertexLightCol421_g6861();
				float4 temp_output_3408_20 = localVertexLightCol421_g6861;
				...
				float4 transform5_g6864 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float3 localCenterEye1_g6865 = CenterEye1_g6865();
				float temp_output_4_0_g6864 = distance( transform5_g6864 , float4( ( (float)0 == 0.0 ? localCenterEye1_g6865 : _WorldSpaceCameraPos ) , 0.0 ) );
				float temp_output_3839_0 = temp_output_4_0_g6864;
				...
				float3 linearToGamma5436 = LinearToGammaSpace( ase_lightColor.rgb );
				...
				float3 linearToGamma5444 = LinearToGammaSpace( (VertLight1406).xyz );
				float3 localunity_SHArgb3_g6866 = unity_SHArgb3_g6866();
				float3 linearToGamma5438 = LinearToGammaSpace( localunity_SHArgb3_g6866 );
				float3 saferPower4200 = abs( ( ( ( linearToGamma5436 * float3( 1,0.9,1 ) * temp_output_2082_0 ) + ( linearToGamma5444 * float3( 0.5,0.4,0.5 ) * temp_output_2082_0 ) + ( linearToGamma5438 * float3( 1.25,1.2,1.25 ) ) ) * _LightMulti * (_LightColourBias).rgb ) );
				float3 temp_cast_9 = (_MinLight).xxx;
				float3 clampResult3331 = clamp( pow( saferPower4200 , 0.8 ) , temp_cast_9 , float3( 2,2,2 ) );
				float3 break5_g6867 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * 2.0 * max( max( break5_g6867.x , break5_g6867.y ) , max( break5_g6867.y , break5_g6867.z ) ) ) / clampResult3331 ) );
				float3 break5_g6876 = clampResult1914;
				float3 break5_g6875 = clampResult1914;
				float clampResult3551 = clamp( ( ( max( max( break5_g6876.x , break5_g6876.y ) , max( break5_g6876.y , break5_g6876.z ) ) - min( min( break5_g6875.x , break5_g6875.y ) , min( break5_g6875.y , break5_g6875.z ) ) ) * ( 1.0 - _LightSaturationLimiter ) ) , ( 1.0 - _LightSatFinal ) , 1.0 );
				...
				float4 transform5_g6903 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float3 localCenterEye1_g6904 = CenterEye1_g6904();
				float temp_output_4_0_g6903 = distance( transform5_g6903 , float4( ( (float)0 == 0.0 ? localCenterEye1_g6904 : _WorldSpaceCameraPos ) , 0.0 ) );
				float dotResult17_g6902 = dot( ase_worldViewDir , ase_worldNormal );
				float temp_output_23_0_g6902 = ( ( 1.0 - ( temp_output_4_0_g6903 * 0.25 ) ) * 8.0 * dotResult17_g6902 );
				float temp_output_19_0_g6902 = saturate( temp_output_23_0_g6902 );
				float temp_output_3773_0 = ( ( temp_output_19_0_g6902 + 0.25 ) * _Amount );
				...
				#endif
				float3 aColor1_g6884 = (tex2DNode328).rgb;
				float aHue1_g6884 = _EmissionHue;
				float3 localHueShifter1_g6884 = HueShifter1_g6884( aColor1_g6884 , aHue1_g6884 );
				float3 temp_output_4845_0 = localHueShifter1_g6884;
				...
				float3 localCenterEye1_g6906 = CenterEye1_g6906();
				float3 ifLocalVar50_g6905 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar50_g6905 = localCenterEye1_g6906;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar50_g6905 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6905 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6905 - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g6905 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6905 ) , worldToViewDir13_g6905 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye1_g6908 = CenterEye1_g6908();
				float3 ifLocalVar32_g6907 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar32_g6907 = localCenterEye1_g6908;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar32_g6907 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6907 = normalize( ( ifLocalVar32_g6907 - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g6907 = normalize( cross( normalizeResult19_g6907 , _worldUp ) );
				float3 temp_output_21_0_g6907 = NormalMatCap3089;
				float dotResult10_g6907 = dot( normalizeResult8_g6907 , temp_output_21_0_g6907 );
				float dotResult2_g6907 = dot( _worldUp , normalizeResult19_g6907 );
				float3 normalizeResult7_g6907 = normalize( ( _worldUp - ( dotResult2_g6907 * normalizeResult19_g6907 ) ) );
				float dotResult9_g6907 = dot( normalizeResult7_g6907 , temp_output_21_0_g6907 );
				float2 appendResult11_g6907 = (float2(dotResult10_g6907 , dotResult9_g6907));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g6907 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 temp_output_4_0_g6883 = ( localCenterEye1_g6883 - WorldPosition );
				float3 normalizeResult5_g6883 = normalize( temp_output_4_0_g6883 );
				float3 ifLocalVar3493 = 0;
				if( _StereoFixSpec == 1.0 )
				ifLocalVar3493 = normalizeResult5_g6883;
				...
				float3 ifLocalVar50_g6898 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar50_g6898 = localCenterEye1_g6899;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar50_g6898 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6898 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6898 - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g6898 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye1_g6901 = CenterEye1_g6901();
				float3 ifLocalVar32_g6900 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar32_g6900 = localCenterEye1_g6901;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar32_g6900 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6900 = normalize( ( ifLocalVar32_g6900 - WorldPosition ) );
				float3 normalizeResult8_g6900 = normalize( cross( normalizeResult19_g6900 , _worldUp ) );
				float3 temp_output_21_0_g6900 = NormalSpecular965;
				float dotResult10_g6900 = dot( normalizeResult8_g6900 , temp_output_21_0_g6900 );
				float dotResult2_g6900 = dot( _worldUp , normalizeResult19_g6900 );
				float3 normalizeResult7_g6900 = normalize( ( _worldUp - ( dotResult2_g6900 * normalizeResult19_g6900 ) ) );
				float dotResult9_g6900 = dot( normalizeResult7_g6900 , temp_output_21_0_g6900 );
				float2 appendResult11_g6900 = (float2(dotResult10_g6900 , dotResult9_g6900));
				float2 ifLocalVar3491 = 0;
				UNITY_BRANCH 
				if( _Legacy2 == 1.0 )
				ifLocalVar3491 = (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6898 ) , worldToViewDir13_g6898 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 )));
				else if( _Legacy2 < 1.0 )
				ifLocalVar3491 = ( ( appendResult11_g6900 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) );
				...
				float temp_output_61_0_g6964 = ( _ParallaxHeight + 1.0 );
				float3 ase_tanViewDir =  tanToWorld0 * ase_worldViewDir.x + tanToWorld1 * ase_worldViewDir.y  + tanToWorld2 * ase_worldViewDir.z;
				ase_tanViewDir = Unity_SafeNormalize( ase_tanViewDir );
				float2 Offset29_g6964 = ( ( temp_output_61_0_g6964 - 1 ) * ase_tanViewDir.xy * _ParallaxScale ) + uv_ParallaxTexture;
				float2 Offset57_g6964 = ( ( temp_output_61_0_g6964 - 1 ) * ( ase_tanViewDir.xy / ase_tanViewDir.z ) * _ParallaxScale ) + uv_ParallaxTexture;
				float2 temp_output_59_0_g6964 = ( (float)(int)_ParallaxType == 0.0 ? Offset29_g6964 : Offset57_g6964 );
				float4 tex2DNode41_g6964 = SAMPLE_TEXTURE2D( _ParallaxTexture, sampler_ParallaxTexture, temp_output_59_0_g6964 );
				#ifdef PARALLAX_ON
				float3 staticSwitch4920 = ( pow( SAMPLE_TEXTURE2D( _ParallaxMask, sampler_ParallaxMask, uv_ParallaxMask ).r , _ParallaxMaskPower ) * (( tex2DNode41_g6964 * _ParallaxColour * tex2DNode41_g6964.a * _ParallaxColour.a )).rgb );
				#else
				float3 staticSwitch4920 = float3( 0,0,0 );
				#endif
				float localbits18_g6966 = ( 0.0 );
				...
				float temp_output_3_0_g6966 = lerpResult5314;
				half4 screenuv1_g6966 = ( screenPos / screenPos.w );
				half4 localStereoScreenUV1_g6966 = StereoScreenUV1_g6966( screenuv1_g6966 );
				float4 break8_g6966 = localStereoScreenUV1_g6966;
				int x11_g6966 = (int)fmod( break8_g6966.x , 8.0 );
				int y11_g6966 = (int)fmod( break8_g6966.y , 8.0 );
				half localDither8x8Bayer11_g6966 = Dither8x8Bayer( x11_g6966 , y11_g6966 );
				int localRenderSampleCount4_g6966 = RenderSampleCount();
				#ifdef COVERAGE_ON
				float staticSwitch65_g6966 = ( ( temp_output_3_0_g6966 + ( ( 1.0 - localDither8x8Bayer11_g6966 ) / ( localRenderSampleCount4_g6966 / _A2CSampleBias ) ) ) * localRenderSampleCount4_g6966 );
				#else
				float staticSwitch65_g6966 = 0.0;
				#endif
				float covtoggle18_g6966 = ceil( saturate( staticSwitch65_g6966 ) );
				float finalAlpha18_g6966 = staticSwitch65_g6966;
				float preFinalAlpha18_g6966 = temp_output_3_0_g6966;
				{
				// Shift and subtract to get the needed amount of positive bits
				  if (covtoggle18_g6966 == 1)
				{
				cov = (1u << (uint)(finalAlpha18_g6966)) - 1u;
				finalAlpha18_g6966 = 1;
				}
				  if (covtoggle18_g6966 == 0)
				{
				cov = 0xFF;
				finalAlpha18_g6966 = preFinalAlpha18_g6966;
				}
				}
				int localisCamera1_g6965 = isCamera1_g6965();
				int Cam17_g6965 = localisCamera1_g6965;
				int temp_output_5_0_g6965 = (int)_IsInMirror;
				int temp_output_6_0_g6965 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g6965 == 1.0 ? ( (float)temp_output_5_0_g6965 == 1.0 ? ( Cam17_g6965 + temp_output_5_0_g6965 ) : ( Cam17_g6965 * temp_output_5_0_g6965 ) ) : ( (float)temp_output_6_0_g6965 == 0.0 ? ( Cam17_g6965 * temp_output_6_0_g6965 ) : ( Cam17_g6965 + temp_output_6_0_g6965 ) ) );
				else
				ifLocalVar3478 = 1.0;
				...
				float4 appendResult1923 = (float4(( staticSwitch4916 + ( ( float3( 0.05,0.05,0.05 ) + temp_output_2287_0 ) * SpecularOut983 ) + ( ( temp_output_2287_0 + float3( 0.1,0.1,0.1 ) ) * float3( 2,2,2 ) * SparkleOut971 ) + ( ( temp_output_2287_0 + float3( 0.03,0.03,0.03 ) ) * staticSwitch4920 ) ) , finalAlpha18_g6966));
...
/*ASEBEGIN
Version=18934
79;354;1618;827;9287.156;1859.19;7.147472;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3464;-6713.078,-496.6083;Float;False;Property;_NorDist;Normal Distance Modifier;54;0;Create;False;0;0;0;False;1;Space(5);False;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-8565.2,720.9944;Inherit;True;Property;_Normal;Normal (N);53;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;b6a3ebb8f4b838246a2682935ed52019;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;4351;-8530.895,1015.996;Float;False;Property;_NormalScale;Scale Normal;55;0;Create;False;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5197;-8239.682,321.7379;Inherit;False;NormalTextureSuperSample;-1;;6860;c5e7d95f0a9b898419b29857c25ecde5;0;5;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;50;SAMPLERSTATE;0;False;28;FLOAT;0;False;49;FLOAT;1;False;4;FLOAT3;0;FLOAT;39;FLOAT;40;FLOAT;41
Node;AmplifyShaderEditor.FunctionNode;3408;-5452.098,-1113.571;Inherit;False;VertexLightData;-1;;6861;d6cc1c00f5d200e45903717e6fa3d55c;0;0;12;FLOAT3;0;FLOAT3;11;FLOAT3;12;FLOAT3;13;FLOAT4;16;FLOAT4;17;FLOAT4;18;FLOAT4;20;FLOAT;23;FLOAT;29;FLOAT;30;FLOAT;31
...
Node;AmplifyShaderEditor.CommentaryNode;281;-7727.429,-1488.688;Inherit;False;1883.061;637.1891;Uses directional light or uses the static light direction;22;3817;2215;1296;5;1165;1076;1876;2635;1233;248;1247;633;3511;252;251;1246;249;2148;1232;2147;4796;5451;Light Setup;1,0.546,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3597;-8423.356,43.52596;Float;False;Property;_NormalPowerSubSurface;Normal SubSurface;59;0;Create;False;0;0;0;False;0;False;0.5;0.1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3511;-7384.249,-956.1778;Inherit;False;VR_Center_Eye;-1;;6862;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;1;19;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.RangedFloatNode;428;-8165.805,982.3168;Float;False;Property;_NormalPower;Normal Power;56;0;Create;True;0;0;0;False;0;False;1;0.2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4796;-6738.559,-1065.653;Inherit;False;GetBakedLight;-1;;6863;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.CommentaryNode;3819;-3274.496,-263.8208;Inherit;False;2081.032;521.23;;28;1914;3332;3301;1915;3331;1916;4200;2867;1489;4394;2870;3803;1486;4204;4393;1484;2082;3314;1408;2081;5166;5165;5164;4795;5171;5436;5438;5444;Light Colour;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1408;-3266.177,-5.099229;Inherit;False;1406;VertLight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;3839;-3887.979,-2688.387;Inherit;False;View Distance;-1;;6864;2a6ef75a50a2bd147a81c448d8de0d4d;2,8,1,17,0;1;9;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4795;-3248.72,106.3934;Inherit;False;GetBakedLight;-1;;6866;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
Node;AmplifyShaderEditor.WorldSpaceLightPos;2081;-3192.542,-227.5092;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.ComponentMaskNode;3314;-3118.05,-4.699965;Inherit;False;True;True;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LightColorNode;1484;-3251.601,-135.6819;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.OneMinusNode;2082;-2976.481,-200.787;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LinearToGammaNode;5436;-3097.72,-111.4772;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LinearToGammaNode;5444;-2941.591,-1.197089;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LinearToGammaNode;5438;-3032.72,109.5228;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;4929;-3461.396,242.2067;Inherit;False;Property;_UseShading;Use Shading;26;0;Create;True;0;0;0;False;2;Space(5);Header(.  Shadow  .);False;0;0;0;True;SHADING_OFF;ToggleOff;2;Key0;Key1;Create;True;False;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3803;-2720.432,-25.68434;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.4,0.5;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;4696;-2924.893,-2750.153;Half;False;Property;_SSIntensity2;SubSurface Power 2;91;0;Create;False;0;0;0;False;0;False;5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4976;-3378.074,-3252.243;Half;False;Property;_SSStrength;SubSurface Strength;86;0;Create;False;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1486;-2748.086,-155.7688;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,0.9,1;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4204;-2718.468,106.7541;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;1.25,1.2,1.25;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;2870;-2502.831,132.5514;Half;False;Property;_LightMulti;Light Multiplier;19;0;Create;False;1;;0;0;False;1;Header(. Lighting .);False;0.75;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3611;-3153.193,-3159.346;Half;False;Property;_SSIntensity;SubSurface Power;87;0;Create;False;0;0;0;False;0;False;5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1489;-2516.732,3.583717;Inherit;False;3;3;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;4855;-2892.987,-2399.57;Inherit;False;Property;_SSAliasFixes;SS Edge Alias Fix (dist pow limit);98;0;Create;False;0;0;0;False;0;False;-0.2,3.5,0.075;-1.5,2,0.05;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2867;-2244.816,61.37468;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1916;-2220.808,181.3686;Float;False;Property;_MinLight;Min Light;21;0;Create;True;0;0;0;False;0;False;0.025;0.02;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;4200;-2100.958,56.43401;Inherit;False;True;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.8;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ClampOpNode;3331;-1963.433,55.36884;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;2,2,2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;5171;-1817.575,27.86575;Inherit;False;Float3 Max;-1;;6867;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3301;-1596.901,-23.41244;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;2;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4105;-2863.56,649.2585;Float;False;Property;_ShadowSharpness;Shadow Sharpness;30;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3610;-2129.062,-3310.276;Half;False;Property;_SSBrightness;SubSurface Brightness;92;0;Create;False;0;0;0;False;1;Space(5);False;10;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5172;-1138.026,258.6496;Inherit;False;Float3 Max;-1;;6876;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5173;-1136.877,327.1981;Inherit;False;Float3 Min;-1;;6875;61474a8b2b91ea8409c96a71133ac9bc;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;3818;-3091.722,-1669.933;Inherit;False;1976.64;1150.999;;26;1262;2993;19;813;812;18;2984;3338;3345;4167;3343;2982;3430;4078;3431;4850;4851;4922;4923;4936;5183;5185;5186;5187;5315;5416;MainTex;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;1999;2582.737,445.6081;Half;False;Property;_InvertFriendsOnly;Invert Friends Only;199;2;[Header];[ToggleUI];Create;True;1;enable without cam for override;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;3343;-2994.644,-1562.763;Inherit;True;Property;_MainTexFriends;FriendsOnly Texture (RGB,A);201;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleTimeNode;4893;1355.926,-1799.894;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-2955.552,-1129.58;Inherit;True;Property;_MainTex;Texture (RGB,A);5;0;Create;False;1;;0;0;False;1;Header(.  Main  .);False;None;e2e75464380486e41b519bb54e4e1c6f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;4078;-2884.189,-1217.727;Half;False;Property;_FriendTexSSBias;Mip Sample Bias;203;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5198;-2614.285,-822.8226;Inherit;False;TextureSuperSample;-1;;6881;23a6a6e8fbe28134cac41513630794b1;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;48;SAMPLERSTATE;0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;5199;-2580.782,-1191.95;Inherit;False;TextureSuperSample;-1;;6880;23a6a6e8fbe28134cac41513630794b1;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;48;SAMPLERSTATE;0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.StaticSwitch;4922;-2290.96,-1222.589;Inherit;False;Property;_FriendsSuperSample;SuperSample (expensive);202;0;Create;False;0;0;0;False;0;False;0;0;0;True;FRIENDSS_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3179;-6374.675,-2599.325;Half;False;Property;_ProbeSmoothness;Probe Smoothness;133;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;4936;-1867.608,-1043.746;Inherit;False;Property;_FriendsOnlyTexture;Friends Only Texture;200;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;True;FRIENDTEX_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5247;-7126.398,-2140.095;Half;False;Property;_CubeSmoothnessOffset;Cube Smoothness Offset;132;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-951.03,-274.2717;Half;False;Property;_Saturation;Saturation;10;0;Create;True;0;0;0;False;0;False;1;0.5;-2;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4845;2261.308,-2035.513;Inherit;False;Hue;-1;;6884;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3512;-7688.119,-3776.902;Inherit;False;VR_Center_Eye;-1;;6883;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;1;19;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;4846;-425.894,-371.7213;Inherit;False;Hue;-1;;6885;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-233.7685,-1158.188;Float;False;Property;_RimNormPow;Rim Normal Power;172;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1533;-213.9822,-1078.708;Half;False;Property;_RimNormal;Rim Normal;171;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3088;-6983.516,-234.9572;Float;False;Property;_NormalPowerMatCap;Normal MatCap;58;0;Create;False;0;0;0;False;0;False;1;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3520;-7137.525,-2859.36;Inherit;False;VR MatCap;-1;;6900;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3521;-7140.988,-2954.96;Inherit;False;Matcap (legacy);-1;;6898;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;-36.0433,-838.2465;Float;False;Property;_Power;Rim Power;167;0;Create;False;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;369;-29.45917,-912.2149;Float;False;Property;_Scale;Rim Scale;168;0;Create;False;0;0;0;False;0;False;0;50;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-6600.365,-3435.472;Half;False;Property;_SpecularStrength;Specular Strength;101;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2299;264.225,-903.2711;Float;False;Property;_Min;Rim Min;169;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;561;-6125.718,-3336.639;Half;False;Property;_SpecularOpacity;Specular Opacity;99;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;0.5;0.25;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;376;258.5829,-1246.025;Float;False;Property;_RimOutlineColour;Rim/Outline Colour;164;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560742,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2300;291.2249,-822.2711;Float;False;Property;_Max;Rim Max;170;0;Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4743;275.8679,-738.7574;Inherit;False;Fresnel Edge Pixel Fix;-1;;6902;e37ec5be3c94a1b4e99e2c04f776c418;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;384;341.9415,-662.4603;Half;False;Property;_Amount;Rim Opacity;166;0;Create;False;0;0;0;False;0;False;0;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1281;1330.427,-1088.367;Half;False;Property;_RimMode;Rim Mode;165;1;[Enum];Create;True;0;3;Blend_Lerp;0;Multiply;1;AddSubtract;2;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2209;1116.906,1750.81;Float;False;Property;_MatcapSpin;MatcapSpin;180;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1930;915.5886,1496.31;Half;False;Property;_StereoFix;Stereo Converge (flatten);176;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4682;1045.983,-701.6169;Half;False;Property;_MaskFresnel;Emission Alpha Mask;173;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;691;-6148.708,-3072.798;Half;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;109;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3524;1184.139,1381.841;Inherit;False;Matcap (legacy);-1;;6905;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3523;1191.654,1597.406;Inherit;False;VR MatCap;-1;;6907;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2166;1492.586,1303.037;Half;False;Property;_Legacy;Legacy;182;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;824;-5454.984,-3096.248;Half;False;Property;_SpecMatcapOpacity;SpecMatcap Opacity;114;0;Create;False;0;0;0;False;0;False;1;0.333;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;4919;1868.085,-893.8206;Inherit;False;Property;_UseRim;Use Rim;163;0;Create;False;0;0;0;False;2;Space(5);Header(.  Rim Fresnel  .);False;0;0;0;True;RIMLIGHT_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1518;2606.495,1400.255;Half;False;Property;_MatcapSaturation;Matcap Saturation;179;0;Create;True;0;0;0;False;0;False;1;0;-1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2181;952.0762,1125.57;Inherit;True;Property;_Matcap;Matcap (RGB,A);175;0;Create;False;0;0;0;False;0;False;None;f6d2c79bf96c3124f9d3206594756327;False;black;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;2919;2144.814,1376.165;Half;False;Property;_MatCapColor;MatCap Colour;181;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;5405;2506.237,1763.048;Half;False;Property;_MatcapMaskPower;Mask Power;185;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;408;2253.908,1246.997;Float;False;Property;_MatcapIntensity;Matcap Intensity;178;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3264;2667.387,1791.409;Half;False;Property;_MatcapMaskLevel;Mask Level;184;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2732.131,1572.698;Half;False;Property;_MatcapOpacity;Matcap Opacity;177;0;Create;True;0;0;0;False;0;False;5;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1998;2844.131,369.513;Half;False;Property;_FriendsOnly;Friends Only ON/OFF;197;1;[ToggleUI];Create;False;0;0;0;False;2;Space(20);Header(VRC Friends Only);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5465;-7420.122,-4494.833;Inherit;False;Aria Sparkles Include;139;;7017;fe78986b6250d1d46955dfaed2c4e629;0;2;97;FLOAT3;0,0,0;False;156;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4207;1539.46,-295.8469;Half;False;Property;_ParallaxType;Parallax Type;187;1;[Enum];Create;True;0;2;Normal;0;Planar;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3140;2514.843,-144.3769;Half;False;Property;_IsInMirror;In Mirror;205;1;[IntRange];Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3142;2512.518,-62.54065;Half;False;Property;_IsNotMirror;Not Mirror;206;1;[IntRange];Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3429;2793.888,-108.2387;Inherit;False;VRCMirrorToggle;-1;;6965;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
Node;AmplifyShaderEditor.FunctionNode;4396;1748.248,-291.7196;Inherit;False;Aria Parallax Include;189;;6964;972a5d25f3151a4479be2dcc9b9e75fa;2,56,0,55,0;1;60;INT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3159;2905.996,-187.0988;Half;False;Property;_MirrorSystem;Use Mirror System;204;1;[ToggleUI];Create;False;0;0;0;False;2;Space(10);Header(Mirror);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4666;3373.72,-396.6686;Inherit;False;Property;_A2CSampleBias;A2C Sample Bias;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;4920;1978.952,-319.9636;Inherit;False;Property;_UseParallax;Use Parallax;186;0;Create;True;0;0;0;False;2;Space(10);Header(.  Parallax  .);False;0;0;0;True;PARALLAX_ON;Toggle;2;Off;Additive;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;4918;3549.489,-503.7678;Inherit;False;Custom A2C;16;;6966;445f8ff28d1a9f44092743e0eb84a83d;0;3;19;FLOAT;1;False;3;FLOAT;1;False;16;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;4916;2613.815,-845.7996;Inherit;False;Property;_UseMatcap;Use Matcap;174;0;Create;False;0;0;0;False;2;Space(10);Header(.  MatCap  .);False;0;0;1;True;MATCAP_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IntNode;1341;3685.509,-1222.966;Inherit;False;Property;_StencilOp;StencilOp;213;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1344;3361.408,-928.9271;Half;False;Property;_ZTestMode;ZTestMode (LEqual);208;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PiNode;5096;-6533.228,-4317.949;Inherit;False;1;0;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1340;3660.796,-1295.624;Inherit;False;Property;_StencilComp;Stencil Comp;212;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;1342;3681.796,-1150.624;Inherit;False;Property;_StencilFail;StencilFail;214;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;1343;3680.796,-1075.624;Inherit;False;Property;_StencilZFail;StencilZFail;215;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;1432;3630.936,-840.0499;Half;False;Property;_DstBlend;Destination Blend (Zero);217;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1345;3361.479,-1016.991;Half;False;Property;_ZWriteMode;ZWrite (write to depth buffer);207;1;[ToggleUI];Create;False;0;0;0;True;2;Space(10);Header(.  Advanced  .);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1431;3365.751,-835.0287;Half;False;Property;_SrcBlend;Source Blend (One);216;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(Debug);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1337;3361.65,-1295.432;Half;False;Property;_StencilRef;Stencil ID;209;0;Create;False;0;0;0;True;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;5127;-6756.592,-4257.19;Inherit;False;Property;_Vector0;Vector 0;196;0;Create;True;0;0;0;False;0;False;7.08,1.06,1.05,1.92;-1.62,5.8,12.47,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1339;3354.47,-1126.866;Half;False;Property;_WriteMask;WriteMask (non-zero);210;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;5402;-6916.445,-3464.273;Inherit;False;Property;_Vector1;Vector 1;188;0;Create;True;0;0;0;False;0;False;0.3333,10,5;0.42,10,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1338;3355.47,-1209.443;Half;False;Property;_ReadMask;ReadMask (non-zero);211;0;Create;False;0;0;0;True;0;False;255;0;0;0;0;1;FLOAT;0
...
WireConnection;5436;0;1484;1
WireConnection;4691;0;3797;0
WireConnection;4691;1;4692;0
WireConnection;5444;0;3314;0
WireConnection;5438;0;4795;0
...
WireConnection;3803;0;5444;0
WireConnection;3803;2;2082;0
WireConnection;4125;0;4929;0
WireConnection;1486;0;5436;0
WireConnection;1486;2;2082;0
WireConnection;4204;0;5438;0
...
ASEEND*/
//CHKSM=4F94EC629E3699465CBD69CDD42FABC0FB63F197
