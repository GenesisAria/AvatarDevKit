...
Shader ".GenesisAria/Arias VertexLit Shader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 SuperSample2x2SS50_g6883( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
			...
			half4 SuperSample2x2SS50_g6882( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			float3 HueShifter1_g6887( float3 aColor, float aHue )
			{
			...
			half4 SuperSample2x2SS51_g6862( UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue), float2 uvin, float2 dx, float2 dy, float bias, SamplerState samplerState )
			{
				half4 col = 0;
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy + dx + dy), bias);
				col += SAMPLE_TEXTURE2D_BIAS(texvalue, samplerState,float2(uvin.xy - dx + dy), bias);
			...
			float3 HueShifter1_g6886( float3 aColor, float aHue )
			{
				    float angle = radians(aHue);
				    float3 k = float3(0.57735, 0.57735, 0.57735);
				    float cosAngle = cos(angle);
			...
			half4 StereoScreenUV1_g7030( half4 screenuv )
			{
			...
			fixed4 frag (v2f i , out uint cov : SV_Coverage) : SV_Target
			{
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue50_g6883) = _MainTex;
				float2 temp_output_4_0_g6883 = uv_MainTex;
				half2 uvin50_g6883 = temp_output_4_0_g6883;
				half2 dx50_g6883 = ( ddx( temp_output_4_0_g6883 ) * float2( 0.25,0.25 ) );
				half2 dy50_g6883 = ( ddy( temp_output_4_0_g6883 ) * float2( 0.25,0.25 ) );
				half bias50_g6883 = _TexSSBias;
				SamplerState samplerState50_g6883 = sampler_MainTex;
				half4 localSuperSample2x2SS50_g6883 = SuperSample2x2SS50_g6883( texvalue50_g6883 , uvin50_g6883 , dx50_g6883 , dy50_g6883 , bias50_g6883 , samplerState50_g6883 );
				#ifdef MAINSS_ON
				float4 staticSwitch4923 = localSuperSample2x2SS50_g6883;
				#else
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue50_g6882) = _MainTexFriends;
				float2 temp_output_4_0_g6882 = uv_FriendsOnlyRT;
				half2 uvin50_g6882 = temp_output_4_0_g6882;
				half2 dx50_g6882 = ( ddx( temp_output_4_0_g6882 ) * float2( 0.25,0.25 ) );
				half2 dy50_g6882 = ( ddy( temp_output_4_0_g6882 ) * float2( 0.25,0.25 ) );
				half bias50_g6882 = _FriendTexSSBias;
				SamplerState samplerState50_g6882 = sampler_MainTexFriends;
				half4 localSuperSample2x2SS50_g6882 = SuperSample2x2SS50_g6882( texvalue50_g6882 , uvin50_g6882 , dx50_g6882 , dy50_g6882 , bias50_g6882 , samplerState50_g6882 );
				#ifdef FRIENDSS_ON
				float4 staticSwitch4922 = localSuperSample2x2SS50_g6882;
				#else
				...
				float3 aColor1_g6887 = pow( saferPower4850 , temp_cast_4 );
				float aHue1_g6887 = _Hue;
				float3 localHueShifter1_g6887 = HueShifter1_g6887( aColor1_g6887 , aHue1_g6887 );
				float3 desaturateInitialColor2917 = localHueShifter1_g6887;
				...
				UNITY_DECLARE_TEX2D_NOSAMPLER(texvalue51_g6862) = _DetailNormalN;
				float2 temp_output_4_0_g6862 = staticSwitch5256;
				half2 uvin51_g6862 = temp_output_4_0_g6862;
				half2 dx51_g6862 = ( ddx( temp_output_4_0_g6862 ) * float2( 0.25,0.25 ) );
				half2 dy51_g6862 = ( ddy( temp_output_4_0_g6862 ) * float2( 0.25,0.25 ) );
				half bias51_g6862 = ( _NormSSBias * saturate( NormalDist3459 ) );
				SamplerState samplerState51_g6862 = sampler_DetailNormalN;
				half4 localSuperSample2x2SS51_g6862 = SuperSample2x2SS51_g6862( texvalue51_g6862 , uvin51_g6862 , dx51_g6862 , dy51_g6862 , bias51_g6862 , samplerState51_g6862 );
				float3 localUnpackNormal47_g6862 = UnpackScaleNormal( localSuperSample2x2SS51_g6862, temp_output_5259_0 );
				#ifdef NORMSS_ON
				float3 staticSwitch4930 = localUnpackNormal47_g6862;
				#else
				...
				float3 localCenterEye1_g6863 = CenterEye1_g6863();
				float3 temp_output_4_0_g6863 = ( localCenterEye1_g6863 - WorldPosition );
				float3 normalizeResult5_g6863 = normalize( temp_output_4_0_g6863 );
				float3 lerpResult2635 = lerp( appendResult248 , normalizeResult5_g6863 , float3( 0.3333,0.3333,0.3333 ));
				half3 Dir_LightDir2215 = ( ( grayscale5451 * ase_lightColor.a ) > 0.0 ? normalizeResult1233 : lerpResult2635 );
				half3 localSHArgbambientDir6_g6864 = SHArgbambientDir();
				float dotResult5 = dot( NormalShade962 , ( Dir_LightDir2215 + localSHArgbambientDir6_g6864 ) );
				...
				float3 temp_output_1489_0 = ( ( ase_lightColor.rgb * float3( 1,0.9,0.95 ) * temp_output_2082_0 ) + ( (VertLight1406).xyz * float3( 0.5,0.45,0.5 ) * temp_output_2082_0 ) + ( localunity_SHArgb3_g6866 * float3( 1.25,1.2,1.25 ) ) );
				...
				float3 break5_g6869 = clampResult3331;
				float3 clampResult1914 = clamp( clampResult3331 , float3( 0,0,0 ) , ( ( _MaxLight * 2.0 * max( max( break5_g6869.x , break5_g6869.y ) , max( break5_g6869.y , break5_g6869.z ) ) ) / clampResult3331 ) );
				float3 break5_g6876 = clampResult1914;
				float3 break5_g6877 = clampResult1914;
				float clampResult3551 = clamp( ( ( max( max( break5_g6876.x , break5_g6876.y ) , max( break5_g6876.y , break5_g6876.z ) ) - min( min( break5_g6877.x , break5_g6877.y ) , min( break5_g6877.y , break5_g6877.z ) ) ) * ( 1.0 - _LightSaturationLimiter ) ) , ( 1.0 - _LightSatFinal ) , 1.0 );
				...
				float4 transform5_g6907 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
				float3 localCenterEye1_g6908 = CenterEye1_g6908();
				float temp_output_4_0_g6907 = distance( transform5_g6907 , float4( ( (float)0 == 0.0 ? localCenterEye1_g6908 : _WorldSpaceCameraPos ) , 0.0 ) );
				float dotResult17_g6906 = dot( ase_worldViewDir , ase_worldNormal );
				float temp_output_23_0_g6906 = ( ( 1.0 - ( temp_output_4_0_g6907 * 0.25 ) ) * 8.0 * dotResult17_g6906 );
				float temp_output_19_0_g6906 = saturate( temp_output_23_0_g6906 );
				float temp_output_3773_0 = ( ( temp_output_19_0_g6906 + 0.25 ) * _Amount );
				...
				#endif
				float3 aColor1_g6886 = (tex2DNode328).rgb;
				float aHue1_g6886 = _EmissionHue;
				float3 localHueShifter1_g6886 = HueShifter1_g6886( aColor1_g6886 , aHue1_g6886 );
				float3 temp_output_4845_0 = localHueShifter1_g6886;
				...
				float3 localCenterEye1_g6910 = CenterEye1_g6910();
				float3 ifLocalVar50_g6909 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar50_g6909 = localCenterEye1_g6910;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar50_g6909 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6909 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6909 - WorldPosition ), 0 ) ).xyz );
				...
				float3 worldToViewDir13_g6909 = normalize( mul( UNITY_MATRIX_V, float4( NormalMatCap3089, 0 ) ).xyz );
				float mulTime2208 = _Time.y * _MatcapSpin;
				float cos2210 = cos( mulTime2208 );
				float sin2210 = sin( mulTime2208 );
				float2 rotator2210 = mul( (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6909 ) , worldToViewDir13_g6909 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 ))) - float2( 0.5,0.5 ) , float2x2( cos2210 , -sin2210 , sin2210 , cos2210 )) + float2( 0.5,0.5 );
				float3 localCenterEye1_g6912 = CenterEye1_g6912();
				float3 ifLocalVar32_g6911 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFix == 1.0 )
				ifLocalVar32_g6911 = localCenterEye1_g6912;
				else if( (int)_StereoFix < 1.0 )
				ifLocalVar32_g6911 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6911 = normalize( ( ifLocalVar32_g6911 - WorldPosition ) );
				half3 _worldUp = half3(0,1,0);
				float3 normalizeResult8_g6911 = normalize( cross( normalizeResult19_g6911 , _worldUp ) );
				float3 temp_output_21_0_g6911 = NormalMatCap3089;
				float dotResult10_g6911 = dot( normalizeResult8_g6911 , temp_output_21_0_g6911 );
				float dotResult2_g6911 = dot( _worldUp , normalizeResult19_g6911 );
				float3 normalizeResult7_g6911 = normalize( ( _worldUp - ( dotResult2_g6911 * normalizeResult19_g6911 ) ) );
				float dotResult9_g6911 = dot( normalizeResult7_g6911 , temp_output_21_0_g6911 );
				float2 appendResult11_g6911 = (float2(dotResult10_g6911 , dotResult9_g6911));
				float cos2207 = cos( mulTime2208 );
				float sin2207 = sin( mulTime2208 );
				float2 rotator2207 = mul( ( ( appendResult11_g6911 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) ) - float2( 0.5,0.5 ) , float2x2( cos2207 , -sin2207 , sin2207 , cos2207 )) + float2( 0.5,0.5 );
				...
				float3 temp_output_4_0_g6885 = ( localCenterEye1_g6885 - WorldPosition );
				float3 normalizeResult5_g6885 = normalize( temp_output_4_0_g6885 );
				float3 ifLocalVar3493 = 0;
				if( _StereoFixSpec == 1.0 )
				ifLocalVar3493 = normalizeResult5_g6885;
				...
				float3 localCenterEye1_g6903 = CenterEye1_g6903();
				float3 ifLocalVar50_g6902 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar50_g6902 = localCenterEye1_g6903;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar50_g6902 = _WorldSpaceCameraPos;
				float3 worldToViewDir27_g6902 = normalize( mul( UNITY_MATRIX_V, float4( ( ifLocalVar50_g6902 - WorldPosition ), 0 ) ).xyz );
				float3 worldToViewDir13_g6902 = normalize( mul( UNITY_MATRIX_V, float4( NormalSpecular965, 0 ) ).xyz );
				float3 localCenterEye1_g6905 = CenterEye1_g6905();
				float3 ifLocalVar32_g6904 = 0;
				UNITY_BRANCH 
				if( (int)_StereoFixSpecCap == 1.0 )
				ifLocalVar32_g6904 = localCenterEye1_g6905;
				else if( (int)_StereoFixSpecCap < 1.0 )
				ifLocalVar32_g6904 = _WorldSpaceCameraPos;
				float3 normalizeResult19_g6904 = normalize( ( ifLocalVar32_g6904 - WorldPosition ) );
				float3 normalizeResult8_g6904 = normalize( cross( normalizeResult19_g6904 , _worldUp ) );
				float3 temp_output_21_0_g6904 = NormalSpecular965;
				float dotResult10_g6904 = dot( normalizeResult8_g6904 , temp_output_21_0_g6904 );
				float dotResult2_g6904 = dot( _worldUp , normalizeResult19_g6904 );
				float3 normalizeResult7_g6904 = normalize( ( _worldUp - ( dotResult2_g6904 * normalizeResult19_g6904 ) ) );
				float dotResult9_g6904 = dot( normalizeResult7_g6904 , temp_output_21_0_g6904 );
				float2 appendResult11_g6904 = (float2(dotResult10_g6904 , dotResult9_g6904));
				float2 ifLocalVar3491 = 0;
				UNITY_BRANCH 
				if( _Legacy2 == 1.0 )
				ifLocalVar3491 = (float2( 0,0 ) + ((BlendNormals( ( float3( -1,-1,1 ) * worldToViewDir27_g6902 ) , worldToViewDir13_g6902 )).xy - float2( -1,-1 )) * (float2( 1,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( -1,-1 )));
				else if( _Legacy2 < 1.0 )
				ifLocalVar3491 = ( ( appendResult11_g6904 * float2( 0.5,0.5 ) ) + float2( 0.5,0.5 ) );
				...
				float temp_output_61_0_g7028 = ( _ParallaxHeight + 1.0 );
				float3 ase_tanViewDir =  tanToWorld0 * ase_worldViewDir.x + tanToWorld1 * ase_worldViewDir.y  + tanToWorld2 * ase_worldViewDir.z;
				ase_tanViewDir = Unity_SafeNormalize( ase_tanViewDir );
				float2 Offset29_g7028 = ( ( temp_output_61_0_g7028 - 1 ) * ase_tanViewDir.xy * _ParallaxScale ) + uv_ParallaxTexture;
				float2 Offset57_g7028 = ( ( temp_output_61_0_g7028 - 1 ) * ( ase_tanViewDir.xy / ase_tanViewDir.z ) * _ParallaxScale ) + uv_ParallaxTexture;
				float2 temp_output_59_0_g7028 = ( (float)(int)_ParallaxType == 0.0 ? Offset29_g7028 : Offset57_g7028 );
				float4 tex2DNode41_g7028 = SAMPLE_TEXTURE2D( _ParallaxTexture, sampler_ParallaxTexture, temp_output_59_0_g7028 );
				#ifdef PARALLAX_ON
				float3 staticSwitch4920 = ( pow( SAMPLE_TEXTURE2D( _ParallaxMask, sampler_ParallaxMask, uv_ParallaxMask ).r , _ParallaxMaskPower ) * (( tex2DNode41_g7028 * _ParallaxColour * tex2DNode41_g7028.a * _ParallaxColour.a )).rgb );
				#else
				float3 staticSwitch4920 = float3( 0,0,0 );
				#endif
				float localbits18_g7030 = ( 0.0 );
				...
				float temp_output_3_0_g7030 = lerpResult5314;
				half4 screenuv1_g7030 = ( screenPos / screenPos.w );
				half4 localStereoScreenUV1_g7030 = StereoScreenUV1_g7030( screenuv1_g7030 );
				float4 break8_g7030 = localStereoScreenUV1_g7030;
				int x11_g7030 = (int)fmod( break8_g7030.x , 8.0 );
				int y11_g7030 = (int)fmod( break8_g7030.y , 8.0 );
				half localDither8x8Bayer11_g7030 = Dither8x8Bayer( x11_g7030 , y11_g7030 );
				int localRenderSampleCount4_g7030 = RenderSampleCount();
				#ifdef COVERAGE_ON
				float staticSwitch65_g7030 = ( ( temp_output_3_0_g7030 + ( ( 1.0 - localDither8x8Bayer11_g7030 ) / ( localRenderSampleCount4_g7030 / _A2CSampleBias ) ) ) * localRenderSampleCount4_g7030 );
				#else
				float staticSwitch65_g7030 = 0.0;
				#endif
				float covtoggle18_g7030 = ceil( saturate( staticSwitch65_g7030 ) );
				float finalAlpha18_g7030 = staticSwitch65_g7030;
				float preFinalAlpha18_g7030 = temp_output_3_0_g7030;
				{
				// Shift and subtract to get the needed amount of positive bits
				  if (covtoggle18_g7030 == 1)
				{
				cov = (1u << (uint)(finalAlpha18_g7030)) - 1u;
				finalAlpha18_g7030 = 1;
				}
				  if (covtoggle18_g7030 == 0)
				{
				cov = 0xFF;
				finalAlpha18_g7030 = preFinalAlpha18_g7030;
				}
				}
				int localisCamera1_g7029 = isCamera1_g7029();
				int Cam17_g7029 = localisCamera1_g7029;
				int temp_output_5_0_g7029 = (int)_IsInMirror;
				int temp_output_6_0_g7029 = (int)_IsNotMirror;
				float ifLocalVar3478 = 0;
				UNITY_BRANCH 
				if( _MirrorSystem == 1.0 )
				ifLocalVar3478 = (float)( (float)Cam17_g7029 == 1.0 ? ( (float)temp_output_5_0_g7029 == 1.0 ? ( Cam17_g7029 + temp_output_5_0_g7029 ) : ( Cam17_g7029 * temp_output_5_0_g7029 ) ) : ( (float)temp_output_6_0_g7029 == 0.0 ? ( Cam17_g7029 * temp_output_6_0_g7029 ) : ( Cam17_g7029 + temp_output_6_0_g7029 ) ) );
				else
				ifLocalVar3478 = 1.0;
				...
				float4 appendResult1923 = (float4(( staticSwitch4916 + ( ( float3( 0.05,0.05,0.05 ) + temp_output_2287_0 ) * SpecularOut983 ) + ( ( temp_output_2287_0 + float3( 0.1,0.1,0.1 ) ) * float3( 2,2,2 ) * SparkleOut971 ) + ( ( temp_output_2287_0 + float3( 0.03,0.03,0.03 ) ) * staticSwitch4920 ) ) , finalAlpha18_g7030));
...
/*ASEBEGIN
Version=18934
44;743;1618;821;3609.565;260.8514;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3464;-6713.078,-496.6083;Float;False;Property;_NorDist;Normal Distance Modifier;54;0;Create;False;0;0;0;False;1;Space(5);False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4079;-8661.229,206.8748;Half;False;Property;_NormSSBias;Mip Sample Bias;67;0;Create;False;0;0;0;False;0;False;0;-2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2957;-8565.2,720.9944;Inherit;True;Property;_Normal;Normal (N);53;1;[Normal];Create;False;0;0;0;False;2;Space(5);Header(.  Normal  .);False;None;8a7f9c6ad92c8644e89eb2dc45a116ca;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;5257;-8583.968,542.6286;Float;False;Property;_DetailNormalScale;Scale DetailNormal;68;0;Create;False;0;0;0;False;1;Space(5);False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;5252;-8738.531,-3.556289;Inherit;True;Property;_DetailNormalN;Detail Normal (N);65;0;Create;True;0;0;0;False;0;False;None;72f637a47d3a3724ea9a1aa45e01e056;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;4351;-8530.895,1015.996;Float;False;Property;_NormalScale;Scale Normal;55;0;Create;False;0;0;0;False;0;False;1;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5197;-8239.682,321.7379;Inherit;False;NormalTextureSuperSample;-1;;6862;c5e7d95f0a9b898419b29857c25ecde5;0;5;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;50;SAMPLERSTATE;0;False;28;FLOAT;0;False;49;FLOAT;1;False;4;FLOAT3;0;FLOAT;39;FLOAT;40;FLOAT;41
...
Node;AmplifyShaderEditor.TexturePropertyNode;4302;-8878.345,-481.3;Inherit;True;Property;_NormalMask;(R)NormalMask, (A)Shademask;73;2;[Header];[SingleLineTexture];Create;False;1;Normal Mask;0;0;False;0;False;None;a31785d98197db04f948169d025d2d80;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;3597;-8423.356,43.52596;Float;False;Property;_NormalPowerSubSurface;Normal SubSurface;59;0;Create;False;0;0;0;False;0;False;0.5;0.25;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3511;-7384.249,-956.1778;Inherit;False;VR_Center_Eye;-1;;6863;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;1;19;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;4796;-6738.559,-1065.653;Inherit;False;GetBakedLight;-1;;6864;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.FunctionNode;4795;-3261.72,118.3934;Inherit;False;GetBakedLight;-1;;6866;21172024305c3c548bab845762bbc5b2;1,4,0;1;2;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;7
...
Node;AmplifyShaderEditor.ColorNode;4393;-2566.912,-218.4333;Half;False;Property;_LightColourBias;LightColour Bias (keep white);24;0;Create;False;0;0;0;False;0;False;1,1,1,0;1,0.9490196,0.9575164,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2870;-2275.831,186.5514;Half;False;Property;_LightMulti;Light Multiplier;19;0;Create;False;1;;0;0;False;1;Header(. Lighting .);False;0.75;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3611;-3153.193,-3159.346;Half;False;Property;_SSIntensity;SubSurface Power;87;0;Create;False;0;0;0;False;0;False;5;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;4855;-2892.987,-2399.57;Inherit;False;Property;_SSAliasFixes;SS Edge Alias Fix (dist pow limit);98;0;Create;False;0;0;0;False;0;False;-0.2,3.5,0.075;-0.3,3,0.05;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;1916;-2104.808,181.3686;Float;False;Property;_MinLight;Min Light;21;0;Create;True;0;0;0;False;0;False;0.025;0.02;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1915;-1733.359,-49.38095;Half;False;Property;_MaxLight;Max Light (x2);20;0;Create;False;0;0;0;False;0;False;1;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5171;-1674.575,27.86575;Inherit;False;Float3 Max;-1;;6869;004b4afc582650744b6632102dc74ec7;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3681;-2796.941,-3418.857;Inherit;False;Property;_SSTransmission;Transmission;96;0;Create;False;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4373;-3162.896,1138.84;Float;False;Property;_ShadowSharpness2;Shadow Sharpness 2;35;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4105;-2863.56,649.2585;Float;False;Property;_ShadowSharpness;Shadow Sharpness;30;0;Create;True;0;0;0;False;0;False;20;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3610;-2129.062,-3310.276;Half;False;Property;_SSBrightness;SubSurface Brightness;92;0;Create;False;0;0;0;False;1;Space(5);False;10;12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4363;-3166.896,1283.54;Float;False;Property;_ShadowPower2;Shadow Power 2;36;0;Create;True;0;0;0;False;0;False;1;0.2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;5173;-1136.877,327.1981;Inherit;False;Float3 Min;-1;;6877;61474a8b2b91ea8409c96a71133ac9bc;0;1;7;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3120;-1141.251,401.6872;Float;False;Property;_LightSaturationLimiter;Light Saturation Limiter;22;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1008;-2819.737,881.2854;Float;False;Property;_ShadowColour;Shadow Colour;28;0;Create;True;0;0;0;False;1;Space(5);False;0.85,0.85,0.85,1;0.8,0.8,0.8,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;335;-2884.795,334.1153;Float;False;Property;_ShadowDarkness;Shadow Darkness;37;0;Create;True;0;0;0;False;1;Space(5);False;0.15;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5007;-2655.83,504.7425;Half;False;Property;_DarknessSS;Darkness to SS;93;0;Create;False;1;;0;0;False;0;False;0;0.7394911;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4156;-7033.311,-2224.468;Half;False;Property;_RoughnessPower;Roughness Power;125;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2982;-2955.552,-1129.58;Inherit;True;Property;_MainTex;Texture (RGB,A);5;0;Create;False;1;;0;0;False;1;Header(.  Main  .);False;None;cfba2b7342af72648980842ecbdd5f40;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;5198;-2614.285,-822.8226;Inherit;False;TextureSuperSample;-1;;6883;23a6a6e8fbe28134cac41513630794b1;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;48;SAMPLERSTATE;0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.FunctionNode;5199;-2580.782,-1191.95;Inherit;False;TextureSuperSample;-1;;6882;23a6a6e8fbe28134cac41513630794b1;0;4;4;FLOAT2;0,0;False;1;SAMPLER2D;0,0,0,0;False;48;SAMPLERSTATE;0;False;28;FLOAT;0;False;5;FLOAT4;0;FLOAT;39;FLOAT;40;FLOAT;41;FLOAT;42
...
Node;AmplifyShaderEditor.RangedFloatNode;3179;-6374.675,-2599.325;Half;False;Property;_ProbeSmoothness;Probe Smoothness;133;0;Create;True;0;0;0;False;0;False;0.75;0.96;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4845;2261.308,-2035.513;Inherit;False;Hue;-1;;6886;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;3512;-7688.119,-3776.902;Inherit;False;VR_Center_Eye;-1;;6885;c8866f5c3b9339443aaf9087a76ba9d4;2,13,1,14,0;1;19;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT3;2
...
Node;AmplifyShaderEditor.FunctionNode;4846;-425.894,-371.7213;Inherit;False;Hue;-1;;6887;f67b9beab09edcf45b951dcecf2a24fd;0;2;3;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;546;-6922.143,-3742.504;Half;False;Property;_SpecularSize;Specular Size;100;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;5202;-6694.7,-2063.886;Inherit;True;Property;_Cubemap;Cubemap;131;2;[HDR];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;5d229b3b41f374a418981f1986a40f0a;False;black;LockedToCube;Cube;-1;0;2;SAMPLERCUBE;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1534;-233.7685,-1158.188;Float;False;Property;_RimNormPow;Rim Normal Power;172;0;Create;False;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3182;-6592.917,-2671.746;Half;False;Property;_ReflectionOpacity;Reflection Opacity;134;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3088;-6983.516,-234.9572;Float;False;Property;_NormalPowerMatCap;Normal MatCap;58;0;Create;False;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4257;2978.525,-2142.362;Half;False;Property;_ShadedOnly;Shaded Only;50;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3520;-7137.525,-2859.36;Inherit;False;VR MatCap;-1;;6904;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;3521;-7140.988,-2954.96;Inherit;False;Matcap (legacy);-1;;6902;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;2899;-7432.275,-3196.296;Inherit;True;Property;_SpecularMatcap;Specular Matcap (RGB);107;0;Create;False;0;0;0;False;0;False;None;0e2e954f537d62748a185f6b272fbf33;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;555;-6600.365,-3435.472;Half;False;Property;_SpecularStrength;Specular Strength;101;0;Create;True;0;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;5216;-6043.933,-2554.085;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;376;258.5829,-1246.025;Float;False;Property;_RimOutlineColour;Rim/Outline Colour;164;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6544117,0.3560689,0.448663,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;561;-6125.718,-3336.639;Half;False;Property;_SpecularOpacity;Specular Opacity;99;0;Create;True;0;0;0;False;2;Space(5);Header(.  Specular  .);False;0.5;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;326;2589.138,-1562.149;Float;False;Property;_EmissionIntensity;Emission Intensity;47;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1919;-6568.676,-2808.988;Half;False;Property;_SpecMatcapSaturation;SpecMatcap Saturation;111;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;4743;275.8679,-738.7574;Inherit;False;Fresnel Edge Pixel Fix;-1;;6906;e37ec5be3c94a1b4e99e2c04f776c418;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5215;-5983.933,-2733.085;Half;False;Property;_ReflectionType;Reflection Type;130;1;[Enum];Create;True;0;3;Reflection Probe;0;Fallback Cubemap;1;Cubemap Only;2;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;837;-6444.379,-3241.622;Half;False;Property;_SpecMatCapColor;SpecMatCap Colour;112;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,0.68,0.6,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4336;-5802.886,-2738.399;Float;False;Property;_ReflectionIntensity;Reflection Intensity;135;0;Create;True;0;0;0;False;0;False;0.5;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4748;-5685.209,-2822.121;Float;False;Property;_ReflectionSaturation;Reflection Saturation;137;0;Create;True;0;0;0;False;0;False;1;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1930;915.5886,1496.31;Half;False;Property;_StereoFix;Stereo Converge (flatten);176;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;691;-6148.708,-3072.798;Half;False;Property;_SpecMatcapMultiply;SpecMatcap Multiply;109;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4745;-5522.28,-2557.602;Float;False;Property;_ReflectionPower;Reflection Power;136;0;Create;True;0;0;0;False;0;False;1;1.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;5084;-5262.939,-3604.002;Float;False;Property;_SColor;Specular Colour;102;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,0.68,0.6,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;3523;1191.654,1597.406;Inherit;False;VR MatCap;-1;;6911;70ea9bc890dab6b42ba77ce7cb65ac19;0;2;21;FLOAT3;0,0,0;False;27;INT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;3524;1184.139,1381.841;Inherit;False;Matcap (legacy);-1;;6909;0c9402088b71ec54f9209482380424ee;1,37,1;2;9;FLOAT3;0,0,0;False;45;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;5296;-5752.015,-1927.652;Inherit;True;Property;_SpecularMask2;Specular Mask2 (R,A);120;0;Create;False;0;0;0;False;1;Space(10);False;328;None;a31785d98197db04f948169d025d2d80;True;0;False;white;LockedToTexture2D;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2166;1492.586,1303.037;Half;False;Property;_Legacy;Legacy;182;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;5241;-5339.042,-2564.237;Inherit;False;Property;_ReflectionColor;Reflection Colour;129;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;1,0.68,0.6,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1518;2606.495,1400.255;Half;False;Property;_MatcapSaturation;Matcap Saturation;179;0;Create;True;0;0;0;False;0;False;1;0.5;-1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;824;-5454.984,-3096.248;Half;False;Property;_SpecMatcapOpacity;SpecMatcap Opacity;114;0;Create;False;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2181;952.0762,1125.57;Inherit;True;Property;_Matcap;Matcap (RGB,A);175;0;Create;False;0;0;0;False;0;False;None;0e2e954f537d62748a185f6b272fbf33;False;black;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;695;-5748.114,-2125.176;Inherit;True;Property;_SpecularMask;Specular Mask (R,A);116;0;Create;False;0;0;0;False;1;Space(10);False;328;None;5e9781ca621118a4ca0680e26e00be78;True;0;False;white;LockedToTexture2D;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4346;-5635.075,-2197.204;Half;False;Property;_SpecularLevel;Specular Level;118;0;Create;True;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2919;2144.814,1376.165;Half;False;Property;_MatCapColor;MatCap Colour;181;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,0.68,0.6,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;5291;-5294.063,-2151.113;Half;False;Property;_SpecBias;Specular Bias;119;0;Create;False;0;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3264;2667.387,1791.409;Half;False;Property;_MatcapMaskLevel;Mask Level;184;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;408;2253.908,1246.997;Float;False;Property;_MatcapIntensity;Matcap Intensity;178;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4344;-4911.344,-1944.42;Half;False;Property;_SpecMaskPower;SpecMask Power;117;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;406;2732.131,1572.698;Half;False;Property;_MatcapOpacity;Matcap Opacity;177;0;Create;True;0;0;0;False;0;False;5;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3429;2793.888,-108.2387;Inherit;False;VRCMirrorToggle;-1;;7029;906fee1dc8310a745a0658d5f2fa3fb4;0;2;5;INT;1;False;6;INT;1;False;1;INT;7
...
Node;AmplifyShaderEditor.FunctionNode;4396;1748.248,-291.7196;Inherit;False;Aria Parallax Include;189;;7028;972a5d25f3151a4479be2dcc9b9e75fa;2,56,0,55,0;1;60;INT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;4918;3549.489,-503.7678;Inherit;False;Custom A2C;16;;7030;445f8ff28d1a9f44092743e0eb84a83d;0;3;19;FLOAT;1;False;3;FLOAT;1;False;16;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;4916;2613.815,-845.7996;Inherit;False;Property;_UseMatcap;Use Matcap;174;0;Create;False;0;0;0;False;2;Space(10);Header(.  MatCap  .);False;0;0;0;True;MATCAP_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=3459A063EDA4AAAF1E74E2F960AAA19FEE70EAF9
