	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_21_0_g7055 = min( v.vertex.xyz.z , ( _ProjectionParams.y * -1.0 ) );
				float3 appendResult29_g7055 = (float3(( ( _ScaleX + 2.0 ) * v.vertex.xyz.x * temp_output_21_0_g7055 ) , ( ( _ScaleY + 0.5 ) * v.vertex.xyz.y * temp_output_21_0_g7055 ) , ( ( temp_output_21_0_g7055 * 1.01 ) + -_DistanceOffset )));
				float3 viewToObj30_g7055 = mul( unity_WorldToObject, mul( UNITY_MATRIX_I_V , float4( appendResult29_g7055, 1 ) ) ).xyz;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float temp_output_21_0_g7055 = min( i.ase_texcoord1.xyz.z , ( _ProjectionParams.y * -1.0 ) );
				float3 appendResult29_g7055 = (float3(( ( _ScaleX + 2.0 ) * i.ase_texcoord1.xyz.x * temp_output_21_0_g7055 ) , ( ( _ScaleY + 0.5 ) * i.ase_texcoord1.xyz.y * temp_output_21_0_g7055 ) , ( ( temp_output_21_0_g7055 * 1.01 ) + -_DistanceOffset )));
				float3 viewToObj30_g7055 = mul( unity_WorldToObject, mul( UNITY_MATRIX_I_V , float4( appendResult29_g7055, 1 ) ) ).xyz;
				float4 unityObjectToClipPos36_g7055 = UnityObjectToClipPos( viewToObj30_g7055 );
				float4 computeGrabScreenPos37_g7055 = ComputeGrabScreenPos( ( ( unityObjectToClipPos36_g7055 + float4( 0.564,-0.288,0,0 ) ) * float4( 0.879,1.72,1,1 ) ) );
				float2 break9_g7055 = (computeGrabScreenPos37_g7055).xy;
				float temp_output_16_0_g7055 = ( ( ( ( ( _ScreenParams.z / _ScreenParams.w ) * break9_g7055.x ) + -0.5 ) * 2.25 ) + 0.5 );
				float temp_output_12_0_g7055 = ( ( ( break9_g7055.y + -0.5 ) * 1.15 ) + 0.5 );
				float2 appendResult47_g7055 = (float2(temp_output_16_0_g7055 , temp_output_12_0_g7055));
				...
				float4 screenColor699 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_TrippyGrab2,( float3( appendResult47_g7055 ,  0.0 ) * noise793 ).xy);
				float3 temp_output_704_0 = ( ( (screenColor699).rgb * float3( 2,2,2 ) ) + float3( 0.0001,0.0001,0.0001 ) );
				float3 temp_cast_6 = (_HDRClamp).xxx;
				float temp_output_21_0_g7057 = min( i.ase_texcoord1.xyz.z , ( _ProjectionParams.y * -1.0 ) );
				float3 appendResult29_g7057 = (float3(( ( _ScaleX + 2.0 ) * i.ase_texcoord1.xyz.x * temp_output_21_0_g7057 ) , ( ( _ScaleY + 0.5 ) * i.ase_texcoord1.xyz.y * temp_output_21_0_g7057 ) , ( ( temp_output_21_0_g7057 * 1.01 ) + -_DistanceOffset )));
				float3 viewToObj30_g7057 = mul( unity_WorldToObject, mul( UNITY_MATRIX_I_V , float4( appendResult29_g7057, 1 ) ) ).xyz;
				float4 unityObjectToClipPos36_g7057 = UnityObjectToClipPos( viewToObj30_g7057 );
				float4 computeGrabScreenPos37_g7057 = ComputeGrabScreenPos( ( ( unityObjectToClipPos36_g7057 + float4( 0.564,-0.288,0,0 ) ) * float4( 0.879,1.72,1,1 ) ) );
				float2 break9_g7057 = (computeGrabScreenPos37_g7057).xy;
				float temp_output_16_0_g7057 = ( ( ( ( ( _ScreenParams.z / _ScreenParams.w ) * break9_g7057.x ) + -0.5 ) * 2.25 ) + 0.5 );
				float temp_output_12_0_g7057 = ( ( ( break9_g7057.y + -0.5 ) * 1.15 ) + 0.5 );
				float2 appendResult47_g7057 = (float2(temp_output_16_0_g7057 , temp_output_12_0_g7057));
				float saferPower780 = abs( ( ( tex2D( _CameraDepthTexture, ( float3( appendResult47_g7057 ,  0.0 ) * noise793 ).xy ).r + 0.001 ) * _DepthMultiply ) );
				...
				#endif
				float2 break9_g7056 = staticSwitch797;
				float temp_output_16_0_g7056 = ( ( ( ( ( _ScreenParams.z / _ScreenParams.w ) * break9_g7056.x ) + -0.5 ) * 2.25 ) + 0.5 );
				float temp_output_12_0_g7056 = ( ( ( break9_g7056.y + -0.5 ) * 1.15 ) + 0.5 );
				float2 appendResult23_g7056 = (float2(temp_output_16_0_g7056 , ( 1.0 - temp_output_12_0_g7056 )));
				float3 temp_output_859_0 = ( ( pow( saferPower780 , _DepthPower ) + _DepthBias ) * pow( noise793 , temp_cast_9 ) * float3( ( appendResult23_g7056 + float2( -0.5,-0.5 ) ) ,  0.0 ) );
				...
				float3 temp_output_721_0 = ( pow( temp_output_684_0 , 2.0 ) * _Vector0 * max( pow( saferPower710 , temp_cast_20 ) , float3( 0,0,0 ) ) );
				...
				float4 appendResult728 = (float4((lerpResult722).xyz , _Opacity));
				float4 appendResult197 = (float4(appendResult728));
				
				
				finalColor = appendResult197;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;129;710.251,-114.1098;Inherit;False;Property;_DstBlend;Destination Blend (OneMinusSrcAlpha);41;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;447.7028,-115.6798;Inherit;False;Property;_SrcBlend;Source Blend (SrcAlpha);40;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.BlendMode;True;2;Space(10);Header(.  Debug  .);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;134;734.5409,-496.9505;Inherit;False;Property;_StencilComparison;Stencil Comparison;37;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;135;435.3948,-496.7585;Half;False;Property;_StencilRef;Stencil ID;33;0;Create;False;0;0;0;True;2;Space(5);Header(Stencil);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;136;754.542,-276.9501;Inherit;False;Property;_StencilZFail;StencilZFail;39;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;137;755.542,-351.9501;Inherit;False;Property;_StencilFail;StencilFail;38;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;138;429.2149,-410.7691;Half;False;Property;_ReadMask;ReadMask (non-zero);36;0;Create;False;0;0;0;True;0;False;255;255;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;139;759.2539,-424.2921;Inherit;False;Property;_StencilOp;StencilOp;34;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;428.2149,-327.192;Half;False;Property;_WriteMask;WriteMask (non-zero);35;0;Create;False;0;0;0;True;0;False;255;255;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;142;-39.59565,-647.5538;Float;False;Property;_ZWriteMode;ZWrite (write to depth buffer);29;1;[ToggleUI];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;141;-312.978,-614.8859;Inherit;False;Property;_Culling;Culling (off is doublesided);30;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;1;2;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-42.66676,-559.4901;Float;False;Property;_ZTestMode;ZTestMode (LEqual);31;1;[Enum];Create;False;0;7;Less;0;Greater;1;LEqual;2;GEqual;3;Equal;4;NotEqual;5;Always;6;1;UnityEngine.Rendering.CompareFunction;True;1;Space(5);False;8;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;144;51.39487,-452.7377;Half;False;Property;_ColorMask;Alpha Render (Colour Mask);28;2;[Header];[Enum];Create;False;1;default required for transparent camera;2;NoUpdateAlpha;14;Default;15;0;True;0;False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;197;-81.88938,-105.6177;Inherit;False;FLOAT4;4;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;834;-4553.534,-282.0107;Inherit;False;Property;_DepthPower;Depth Power;25;0;Create;True;0;0;0;False;0;False;0.5;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;836;-4196.107,-65.68884;Inherit;False;793;noise;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;800;-2785.856,284.341;Inherit;False;Property;_TexPower;Tex Power;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;798;-5472.204,-678.4891;Inherit;False;Property;_NoiseMultiply;Noise Multiply;21;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;796;-5446.187,-757.1576;Inherit;False;Property;_NoisePower;Noise Power;20;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;685;-2848.477,596.2016;Inherit;False;Property;_DistortPower;Distort Power;22;0;Create;True;0;0;0;False;0;False;0.1;0.015;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;797;-4817.633,-684.6528;Inherit;False;Property;_NoisetoTex;Noise to Tex;19;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1054;-3708.977,1035.206;Inherit;False;Property;_PulseStrength;Pulse Strength;24;0;Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1050;-4273.108,641.9338;Inherit;False;Property;_PulseRate;Pulse Rate;23;0;Create;True;0;0;0;False;0;False;0.25;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;955;-2577.513,292.1981;Inherit;False;Property;_Saturation;Saturation;6;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1042;-2281.985,7.739531;Inherit;False;Property;_Multiply;Multiply;9;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;835;-4766.594,-279.0355;Inherit;False;Property;_DepthMultiply;Depth Multiply;27;0;Create;True;0;0;0;False;0;False;50;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1069;-4362.902,-351.6796;Inherit;False;Property;_DepthBias;Depth Bias;26;0;Create;True;0;0;0;False;0;False;50;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;449.2089,-25.30397;Inherit;False;Property;_BlendOp;BlendOp;42;1;[Enum];Create;True;0;1;Option1;0;1;UnityEngine.Rendering.BlendOp;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;728;-348.0909,50.40269;Inherit;False;COLOR;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;851;-693.9019,146.725;Inherit;False;Property;_Opacity;Opacity;32;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;764;-5053.93,-523.3171;Inherit;True;Global;_CameraDepthTexture;_CameraDepthTexture;43;0;Create;True;0;0;0;False;0;False;-1;None;;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;1097;-4481.234,-635.7476;Inherit;False;Screenspace Include;0;;7056;8326627392ade6a49869c3928468b5af;2,44,0,46,0;1;32;FLOAT2;0,0;False;2;FLOAT2;31;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1098;-5819.875,-576.9503;Inherit;False;Screenspace Include;0;;7057;8326627392ade6a49869c3928468b5af;2,44,1,46,1;1;32;FLOAT2;0,0;False;2;FLOAT2;31;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;1113;-1545.338,375.1432;Inherit;False;Property;_Vector0;Vector 0;45;0;Create;True;0;0;0;False;0;False;0,0,0;10,10,10;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;721;-1435.141,130.7309;Inherit;True;3;3;0;FLOAT3;1,1,1;False;1;FLOAT3;15,15,15;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1124;-5023.354,775.6589;Inherit;False;Property;_PulseOrigin;Pulse Origin;46;0;Create;True;0;0;0;False;0;False;0.5;0.253;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;1109;-2077.338,1.143219;Inherit;False;Property;_DarknessTweak;Darkness Tweak;44;0;Create;True;0;0;0;False;0;False;5,2,2,2;0.5,3,3,3;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;1096;-2235.773,-355.3741;Inherit;False;Screenspace Include;0;;7055;8326627392ade6a49869c3928468b5af;2,44,1,46,1;1;32;FLOAT2;0,0;False;2;FLOAT2;31;FLOAT3;0
...
WireConnection;530;0;197;0
WireConnection;530;1;1096;0
...
WireConnection;778;0;1098;31
WireConnection;778;1;882;0
WireConnection;896;0;1096;31
...
WireConnection;728;3;851;0
WireConnection;764;1;778;0
WireConnection;1097;32;797;0
...
ASEEND*/
//CHKSM=A17235F65A08737707502C1B219756483D08D51C