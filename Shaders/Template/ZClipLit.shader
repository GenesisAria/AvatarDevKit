Shader /*ase_name*/ "Hidden/Templates/ZClipLit" /*end*/
{
	Properties
	{
		/*ase_props*/
		...
		*/
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				o.Albedo = /*ase_frag_out:Colour;Float3;0;-1;_Albedo*/fixed3( 0.5, 0.5, 0.5 )/*end*/;
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v /*ase_vert_input*/ ) {
				...
				/*ase_vert_code:v=appdata;o=v2f*/
					...
					float3 defaultVertexValue = float3(0, 0, 0);
				#endif
				float3 vertexValue = /*ase_vert_out:Vertex Offset Shadow;Float3;3;-1;_Vertex*/defaultVertexValue/*end*/;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
					v.vertex.xyz = vertexValue;
				#else
					v.vertex.xyz += vertexValue;
				...
				) : SV_Target
			{
				...
				o.Normal = fixed3( 0, 0, 1 );
				o.Occlusion = 1;
				o.Alpha = /*ase_frag_out:Alpha Shadow;Float;0;-1;_Alpha*/1/*end*/;
				float AlphaClipThresholdShadow = /*ase_frag_out:Alpha Clip Threshold;Float;2;-1;_AlphaClipShadow*/0.5/*end*/;
